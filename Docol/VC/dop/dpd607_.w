...
{dop/dpd611.i} //temp-tables contendo execucao oráamentaria
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'ProgPesquisa = dozoom\z01dpd607.w,
                     ...
                     Implantar = no':U ,
             OUTPUT h_q01dpd607 ).
       RUN set-position IN h_q01dpd607 ( 1.17 , 55.43 ) NO-ERROR.
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-navega ,
             bt-detalhes:HANDLE IN FRAME f-cad , 'AFTER':U ).
...
------------------------------------------------------------------------------*/
  ENABLE rt-button bt-encerra bt-cancela bt-detalhes 
