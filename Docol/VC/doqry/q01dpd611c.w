...
{include/i-prgvrs.i Q01DPD611C 1.00.00.000}
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH amkt-solic-vl-bonific-tit-acr NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH amkt-solic-vl-bonific-tit-acr NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main amkt-solic-vl-bonific-tit-acr
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main amkt-solic-vl-bonific-tit-acr
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "emsdocol.amkt-solic-vl-bonific-tit-acr"
     _Options          = "NO-LOCK"
