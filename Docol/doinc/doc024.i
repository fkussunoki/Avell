...
DEF TEMP-TABLE dc-desp-ccusto NO-UNDO
    ...
    FIELD val-previsto               AS DEC    FORMAT "->>>,>>>,>>9.99" LABEL "Valor Previsto"         COLUMN-LABEL "Valor Previsto"
...
DEF TEMP-TABLE tt-detalhe NO-UNDO
    ...
    FIELD val-previsto        LIKE dc-desp-ccusto.val-previsto
...
DEF TEMP-TABLE tt-res-origem NO-UNDO
    FIELD cod_cta_ctbl        LIKE dc-desp-ccusto.cod_cta_ctbl
    FIELD cod_modul_dtsul     LIKE dc-desp-ccusto.cod_modul_dtsul
    FIELD val-movto           LIKE dc-desp-ccusto.val-movto
    FIELD val-previsto        LIKE dc-desp-ccusto.val-previsto
    FIELD descricao           AS CHAR
    INDEX cta-orig IS PRIMARY UNIQUE cod_cta_ctbl cod_modul_dtsul.
