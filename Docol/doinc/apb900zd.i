/*Conter  as informa‡äes referentes a abatimentos de Antecipa‡äes*/
...
/*Conter  as informa‡äes referentes a abatimentos de Previsäes  ou Provisäes*/
...
/*Conter  as informa‡äes referentes a apropria‡äes cont beis dos t¡tulos*/
...
/*Conter  as informa‡äes das apropria‡äes cont beis referentes a notas de cr‚dito e notas de d‚bito*/
...
/*Conter  as informa‡äes referentes aos Impostos vinculados aos t¡tulos importados*/
...
/*Conter  as informa‡äes dos itens dos lote de implanta‡Æo a serem criados no Datasul-EMS5. Esta temp-table nÆo deve ser criada, ela deve ser apenas definida no programa. A nova temp-table a ser criada est  especificada mais abaixo, no item Temp-Table 10*/
...
/*Conter  as informa‡äes dos lotes de implanta‡Æo, necess rios para a vincula‡Æo dos itens*/
...
/*Conter  as informa‡äes referentes …s Notas de D‚bito e Notas de Cr‚dito.*/
...
/*Conter  as informa‡äes referentes aos erros encontrados durante as valida‡äes para a cria‡Æo dos t¡tulos.*/
...
/*Conter  as informa‡äes dos itens dos lote de implanta‡Æo a serem criados no Datasul-EMS5.*/
