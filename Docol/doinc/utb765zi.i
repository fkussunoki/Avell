...
def temp-table tt_fornec_financ_integr_d no-undo
    ...
    field tta_num_rendto_tribut            as integer format ">>9" initial 0 label "Rendto Tributÿvel" column-label "Rendto Tributÿvel"
...
def temp-table tt_pessoa_jurid_integr_g no-undo
    field tta_num_pessoa_jurid             as integer format ">>>,>>>,>>9" initial 0 label "Pessoa Jur­dica" column-label "Pessoa Jur­dica"
    field tta_nom_pessoa                   as character format "x(40)" label "Nome" column-label "Nome"
    field tta_cod_id_feder                 as character format "x(20)" initial ? label "ID Federal" column-label "ID Federal"
...
def temp-table tt_porte_pj_integr no-undo
    ...
    field tta_val_patrim_liq               as decimal format ">>,>>>,>>>,>>9.99" decimals 2 initial 0 label "PatrimËnio L­quido" column-label "PatrimËnio L­quido"
    ...
    field tta_val_vendas_func              as decimal format ">>,>>>,>>>,>>9.99" decimals 2 initial 0 label "Vendas Funcionÿrio" column-label "Vendas Funcionÿrio"
    field tta_qtd_funcionario              as decimal format ">>>,>>9" initial 0 label "Qtd Funcionÿrios" column-label "Qtd Funcionÿrios"
