/*TEMP-TABLE 1: Conter  as informa‡äes de abatimento de Antecipa‡äes.*/
...
/*Temp-table 2: Conter  as informa‡äes dos abatimentos de Previsäes ou Provisäes.*/
...
/*Temp-table 4: Conter  as informa‡äes das apropria‡äes referentes a notas de cr‚dito e notas de d‚bito.*/
...
def new shared temp-table tt_integr_apb_impto_impl_pend no-undo 
    ...
    field tta_val_deduc_inss               as decimal format ">,>>>,>>>,>>9.99" decimals 2 initial 0 label "Dedu»’o Inss" column-label "Dedu‡Æo Inss" 
    field tta_val_deduc_depend             as decimal format ">,>>>,>>>,>>9.99" decimals 2 initial 0 label "Dedu»’o Dependentes" column-label "Dedu‡Æo Dependentes" 
    field tta_val_deduc_pensao             as decimal format ">,>>>,>>>,>>9.99" decimals 2 initial 0 label "Deducao Pens’o" column-label "Deducao PensÆo" 
    field tta_val_outras_deduc_impto       as decimal format ">,>>>,>>>,>>9.99" decimals 2 initial 0 label "Outras Dedu»„es" column-label "Outras Dedu‡Æes" 
    ...
    field tta_val_deduc_faixa_impto        as decimal format ">,>>>,>>>,>>9.99" decimals 2 initial 0 label "Valor Dedu‡Æo" column-label "Valor Dedu‡Æo" 
...
/*Temp-table 8: Conter  as informa‡äes das Notas de D‚bito e Notas de Cr‚dito.*/
...
def new shared temp-table tt_log_erros_atualiz no-undo 
    ...
    field ttv_des_msg_erro                 as character format "x200)" label "Mensagem Erro" column-label "Inconsistˆncia"  /*60*/
