...
def var c-empresa-ems2       as char                       no-undo.
...
FOR EACH estabelecimento NO-LOCK
    WHERE estabelecimento.cod_empresa = tt-param.ep-codigo-usuario:
    ...
    assign c-empresa-ems2 = trad_org_ext.cod_unid_organ_ext. 
    ...
    CREATE tt-estab. 
    ASSIGN tt-estab.cod-estabel   = estabelecimento.cod_estab     
           tt-estab.cod-emp-ems2  = c-empresa-ems2
           tt-estab.cod-emp-ems5  = estabelecimento.cod_empresa 
