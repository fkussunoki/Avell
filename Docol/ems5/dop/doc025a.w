...
*******************************************************************************/
{include/i-prgvrs.i DOC025A 1.00.00.000}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i DOC025A DOC}
&ENDIF
...
DEFINE FRAME f-cad
     bt-ok AT ROW 4.17 COL 3.14 HELP
          "Salva e sai"
     bt-save AT ROW 4.17 COL 14.14 HELP
          "Salva e cria novo registro"
     bt-cancela AT ROW 4.17 COL 25.14 HELP
          "Cancela"
     bt-ajuda AT ROW 4.17 COL 78.72
     rt-button AT ROW 4 COL 2
...
DO:
{include/salvapai.i h_v-1doc025}
 END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-1doc025 ).
       RUN set-position IN h_v-1doc025 ( 1.13 , 1.72 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_q-1doc025 ).
       RUN set-position IN h_q-1doc025 ( 1.25 , 80.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.75 , 8.00 ) */

       /* Links to SmartViewer h_v-1doc025. */
       RUN add-link IN adm-broker-hdl ( h_q-1doc025 , 'Record':U , h_v-1doc025 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TableIO':U , h_v-1doc025 ).
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "DOC025A" "1.00.00.000"}
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_q-1doc025 (INPUT v-row-table). 
