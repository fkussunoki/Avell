...
define input param p-narrativa   as char    no-undo.
...
define output param table for tt-erro.
    ...
    /*************************** Buffer Definition End **************************/
        ...
        IF AVAIL bem_pat THEN DO:
            ...
            assign bem_pat.des_narrat_bem_pat = p-narrativa
                   bem_pat.des_bem_pat = p-descricao
            ...
            or bem_pat.num_seq_bem_pat <> p-nova-seq then do:    
                ...
                then do:
                        ...
                        then do:
                            ...
                            ASSIGN bem_pat.num_bem_pat     = p-novo-num
                            bem_pat.num_seq_bem_pat = p-nova-seq.
...
.   
        ...
        ELSE DO:
        CREATE tt-erro.
        assign tt-erro.ttv-mensagem  = 999
            tt-erro.ttv-descricao = "Bem nao encontrado".
            return 'nok'.
        END.
