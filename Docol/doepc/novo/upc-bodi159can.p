...
*** UPC criada com intuito de estornar a execu‡ao orcamentaria de expositores
*** no momento do cancelamento pelo PD4000
*****************************************************************/
...
IF p-ind-event = 'AfterCancelationOrder' THEN DO:
    ...
    FOR FIRST tt-epc NO-LOCK
        ...
        FIND FIRST ped-venda NO-LOCK
            ...
            AND   ped-venda.tp-pedido = "71" NO-ERROR.
