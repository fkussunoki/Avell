...
DEFINE VARIABLE c-cofins AS DECIMAL FORMAT "->>,>>9.99":U INITIAL 7.65 
...
DEFINE VARIABLE c-pis AS DECIMAL FORMAT "->>,>>9.99":U INITIAL 1.65 
     LABEL "Aliquota PIS" 
     VIEW-AS FILL-IN 
     SIZE 8.86 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     ...
     c-pis AT ROW 9.88 COL 22 COLON-ALIGNED WIDGET-ID 2
     c-cofins AT ROW 9.88 COL 51.72 COLON-ALIGNED WIDGET-ID 4
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-lista-cod-estab c-lista-cod-esp c-lista-cdn-repres i-ini-cliente 
          ...
          dt-fim-periodo c-ini-referencia c-fim-referencia c-pis c-cofins 
  ...
  ENABLE IMAGE-10 IMAGE-11 IMAGE-12 IMAGE-13 IMAGE-14 IMAGE-5 IMAGE-6 IMAGE-9 
         ...
         dt-ini-periodo dt-fim-periodo c-ini-referencia c-fim-referencia c-pis 
         c-cofins 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
