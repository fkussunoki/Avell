...
{include/i-prgvrs.i B05DPD607 1.00.00.000}
...
DEFINE VARIABLE c-situacao AS CHARACTER FORMAT "X(10)" COLUMN-LABEL "Situa‡Æo" NO-UNDO.
...
&Scoped-define INTERNAL-TABLES amkt-aprov-pend amkt-solic-pagto

/* Definitions for BROWSE br-table                                      */
&Scoped-define FIELDS-IN-QUERY-br-table amkt-solic-pagto.sequencia amkt-aprov-pend.cod-papel amkt-aprov-pend.dt-pendencia amkt-aprov-pend.cod-usuario amkt-aprov-pend.valor-limite amkt-solic-pagto.valor fn-situacao(amkt-aprov-pend.situacao) @ c-situacao amkt-aprov-pend.dt-situacao amkt-aprov-pend.cod-usuario-situacao amkt-aprov-pend.altern-situacao amkt-aprov-pend.observacao   
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-table   
&Scoped-define SELF-NAME br-table
&Scoped-define QUERY-STRING-br-table FOR EACH amkt-aprov-pend NO-LOCK WHERE                                  amkt-aprov-pend.cd-solicitacao = amkt-solicitacao.numero AND                                  amkt-aprov-pend.tipo           = 3, ~
       /* Pagamento */                             LAST amkt-solic-pagto NO-LOCK WHERE                                  amkt-solic-pagto.numero      = amkt-aprov-pend.cd-solicitacao AND                                  amkt-solic-pagto.data-envio <= amkt-aprov-pend.dt-pendencia                                  BY amkt-aprov-pend.dt-situacao
&Scoped-define OPEN-QUERY-br-table OPEN QUERY {&SELF-NAME} FOR EACH amkt-aprov-pend NO-LOCK WHERE                                  amkt-aprov-pend.cd-solicitacao = amkt-solicitacao.numero AND                                  amkt-aprov-pend.tipo           = 3, ~
       /* Pagamento */                             LAST amkt-solic-pagto NO-LOCK WHERE                                  amkt-solic-pagto.numero      = amkt-aprov-pend.cd-solicitacao AND                                  amkt-solic-pagto.data-envio <= amkt-aprov-pend.dt-pendencia                                  BY amkt-aprov-pend.dt-situacao.
&Scoped-define TABLES-IN-QUERY-br-table amkt-aprov-pend amkt-solic-pagto
&Scoped-define FIRST-TABLE-IN-QUERY-br-table amkt-aprov-pend
&Scoped-define SECOND-TABLE-IN-QUERY-br-table amkt-solic-pagto
...
OPEN QUERY {&SELF-NAME} FOR EACH amkt-aprov-pend NO-LOCK WHERE
                                 ...
                                 amkt-aprov-pend.tipo           = 3, /* Pagamento */
                            LAST amkt-solic-pagto NO-LOCK WHERE
                                 amkt-solic-pagto.numero      = amkt-aprov-pend.cd-solicitacao AND
                                 amkt-solic-pagto.data-envio <= amkt-aprov-pend.dt-pendencia
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "amkt-solic-pagto"}
