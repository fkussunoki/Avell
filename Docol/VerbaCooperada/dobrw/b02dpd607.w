...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-table B-table-Win _STRUCTURED
  QUERY br-table NO-LOCK DISPLAY
      amkt-solicitacao.numero COLUMN-LABEL "Solicita‡Æo" FORMAT ">>>,>>>,>>9":U
            WIDTH 8
...
DEFINE FRAME F-Main
     bt-confirma AT ROW 1 COL 76
          ...
          "N£mero do Solicita‡Æo Inicial"
     fi-numero-fim AT ROW 1.17 COL 42.43 COLON-ALIGNED HELP
          "N£mero da Solicita‡Æo Final" NO-LABEL
...
"numero" "Solicita‡Æo" ? "integer" ? ? ? ? ? ? no ? no no "8" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
