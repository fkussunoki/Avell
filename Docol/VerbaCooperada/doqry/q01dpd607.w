...
*******************************************************************************/
{include/i-prgvrs.i Q01DPD607 12.00.00.001}
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH amkt-solicitacao NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH amkt-solicitacao NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main amkt-solicitacao
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main amkt-solicitacao
...
<FOREIGN-KEYS>
cd-forma-pagto||y|emsdocol.amkt-solicitacao.cd-forma-pagto
cod-emitente||y|emsdocol.amkt-solicitacao.cod-emitente
cd-justificativa||y|emsdocol.amkt-solicitacao.cd-justificativa
cd-publico-alvo||y|emsdocol.amkt-solicitacao.cd-publico-alvo
numero||y|emsdocol.amkt-solicitacao.numero
cd-tipo-acao||y|emsdocol.amkt-solicitacao.cd-tipo-acao
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "cd-forma-pagto,cod-emitente,cd-justificativa,cd-publico-alvo,numero,cd-tipo-acao"':U).
