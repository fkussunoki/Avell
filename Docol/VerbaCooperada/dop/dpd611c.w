...
{include/i-prgvrs.i DPD611C 1.00.00.000}
...
DEFINE VARIABLE h_q01dpd611c AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v01dpd611c AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
     bt-ok AT ROW 5.17 COL 2 HELP
          "Salva e sai"
     bt-save AT ROW 5.17 COL 12.43 HELP
          "Salva e cria novo"
     bt-cancela AT ROW 5.17 COL 23 HELP
          "Cancela"
...
DO:
{include/salvafil.i h_v01dpd611c}
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'dovwr/v01dpd611c.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v01dpd611c ).
       RUN set-position IN h_v01dpd611c ( 1.00 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 4.00 , 78.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'doqry/q01dpd611c.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_q01dpd611c ).
       RUN set-position IN h_q01dpd611c ( 4.75 , 51.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartViewer h_v01dpd611c. */
       RUN add-link IN adm-broker-hdl ( h_q01dpd611c , 'Record':U , h_v01dpd611c ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TableIO':U , h_v01dpd611c ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v01dpd611c ,
...
{utp/ut9000.i "DPD611C" "1.00.00.000"}

RUN dispatch IN THIS-PROCEDURE ( INPUT 'initialize':U ) .

run pi-atualiza-parent in h_v01dpd611c (input v-row-parent).
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_q01dpd611c (input v-row-table).
