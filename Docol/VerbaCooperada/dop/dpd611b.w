...
{include/i-prgvrs.i DPD611B 1.00.00.000}
...
DEFINE VARIABLE h_q01dpd611b AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v01dpd611b AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
     bt-ok AT ROW 7.17 COL 2 HELP
          "Salva e sai"
     bt-save AT ROW 7.17 COL 12.43 HELP
          "Salva e cria novo"
     bt-cancela AT ROW 7.17 COL 23 HELP
          "Cancela"
     bt-ajuda AT ROW 7.17 COL 70.14 NO-TAB-STOP 
...
DO:
{include/salvafil.i h_v01dpd611b}
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'dovwr/v01dpd611b.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v01dpd611b ).
       RUN set-position IN h_v01dpd611b ( 1.00 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.00 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'doqry/q01dpd611b.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_q01dpd611b ).
       RUN set-position IN h_q01dpd611b ( 6.75 , 42.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartViewer h_v01dpd611b. */
       RUN add-link IN adm-broker-hdl ( h_q01dpd611b , 'Record':U , h_v01dpd611b ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TableIO':U , h_v01dpd611b ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v01dpd611b ,
...
{utp/ut9000.i "DPD611B" "1.00.00.000"}

RUN dispatch IN THIS-PROCEDURE ( INPUT 'initialize':U ) .

run pi-atualiza-parent in h_v01dpd611b (input v-row-parent).
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_q01dpd611b (input v-row-table).
