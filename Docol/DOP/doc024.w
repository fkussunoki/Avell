...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Consulta Despesas Realizadas - DOC024 - Empresa: " + v_cod_empres_usuar
         HEIGHT             = 24.42
         WIDTH              = 116.57
         MAX-HEIGHT         = 28.75
         MAX-WIDTH          = 130.72
...
ON END-ERROR OF C-Win /* Consulta Despesas Realizadas - DOC024 */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Consulta Despesas Realizadas - DOC024 */
DO:
