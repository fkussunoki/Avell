...
DEFINE BUTTON bt-executar 
     IMAGE-UP FILE "esp/image/im-rnl.bmp":U
     LABEL "Executar" 
     SIZE 5 BY 1.13.

DEFINE BUTTON BUTTON-11 
     IMAGE-UP FILE "esp/image/im-fil.bmp":U
     LABEL "Button 11" 
     SIZE 4 BY 1.13.

DEFINE BUTTON BUTTON-12 
     IMAGE-UP FILE "esp/image/im-ran_a.bmp":U
     LABEL "Button 12" 
     SIZE 5 BY 1.13.

DEFINE BUTTON BUTTON-13 
     IMAGE-UP FILE "esp/image/im-ran_m.bmp":U
     LABEL "Button 13" 
     SIZE 5 BY 1.13.
...
procedure pi-executar:
  ...
  for each tt-digita where tt-digita.marca = "*" 
    ...
    if first-of(tt-digita.cod-estabel) then do:
      ...
      MESSAGE v_cod_estab VIEW-AS ALERT-BOX.
    ...
    assign tt-digita.numero-ordem = p-req
      ...
      find first natureza-despesa no-lock where natureza-despesa.nat-despesa = ITEM.nat-despesa no-error.
          ...
          run pi_verifica_utilizacao_ccusto in h_api_ccusto (input  estabelec.ep-codigo,          /* EMPRESA EMS 2 */
                                                            ...
                                                            input  "",                 /* PLANO CONTAS */
                                                            input  natureza-despesa.ct-codigo,     /* CONTA */
      ...
      assign it-requisicao.cod-estabel  = tt-digita.cod-estabel
             ...
             it-requisicao.ct-codigo      = natureza-despesa.ct-codigo
