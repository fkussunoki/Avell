...
"Library para window cadastro pai-filho com atualiza‡Æo apenas dos filhos"
*/
&ANALYZE-RESUME
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CUSTOM _DEFINITIONS Method-Library 
/*--------------------------------------------------------------------------
    Library     : w-paifil.i
    Purpose     : Permitir customiza‡Æo para as window de cadastro pai-filho
                  com atualiza‡Æo somente dos filhos

    Syntax      : {include/w-paifil.i}

    Description : Library utilizada para customiza‡Æo da window de cadastro
                  pai-filho com atualiza‡Æo somente dos filhos
...
&IF DEFINED(EXCLUDE-pi-desabil) = 0 &THEN

&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pi-desabil Method-Library 
PROCEDURE pi-desabil :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
&IF DEFINED(EXCLUDE-pi-habil) = 0 &THEN

&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pi-habil Method-Library 
PROCEDURE pi-habil :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
