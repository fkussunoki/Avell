...
"Library para window cadastro pai-filho com atualiza‡Æo dos filhos e do pai"
*/
&ANALYZE-RESUME
...
&IF DEFINED(EXCLUDE-pi-desab) = 0 &THEN

&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pi-desab Method-Library 
PROCEDURE pi-desab :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
