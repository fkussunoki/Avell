    ...
    &IF "{&PDF-RP}" <> "YES" &THEN /*tech868*/
        ...
        &IF defined(def_pdf_controller) = 0 &THEN         
            ...
            IF i-num-ped-exec-rpw <> 0 THEN DO:
               /*controle de execu‡Æo £nica somente para RPW*/
            ...
            END.
            ELSE DO:
                /*para a execu‡Æo normal j  existe um controle que encerra a execu‡Æo persistente do programa*/
                RUN btb/btb920aa.p PERSISTENT SET h_pdf_controller.
            END.
