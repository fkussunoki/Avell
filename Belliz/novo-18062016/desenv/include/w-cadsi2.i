...
APPLY "ENTRY" TO CURRENT-WINDOW.
  ...
  RUN get-button-enable IN h_p-cadsi2 (OUTPUT p-button-enable).
  assign menu-item mi-alterar:sensitive in menu m-cadastro = (entry(1,p-button-enable)= string(yes))
         menu-item mi-desfazer:sensitive in menu m-cadastro = (entry(2,p-button-enable)= string(yes))
         menu-item mi-cancelar:sensitive in menu m-cadastro = (entry(3,p-button-enable)= string(yes))
         menu-item mi-salvar:sensitive in menu m-cadastro = (entry(4,p-button-enable)= string(yes)).
