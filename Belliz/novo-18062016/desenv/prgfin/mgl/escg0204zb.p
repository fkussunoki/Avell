...
def var c-versao-rcode as char initial "[[[5.12.16.100[[[":U no-undo. /* Controle de Versao R-CODE - Nao retirar do Fonte */
...
DO:
    ...
    then do:
       ...
       then do:
           if  search("prgfin/mgl/escg0204zd.r") = ? and search("prgfin/mgl/escg0204zd.p") = ? then do:
               if  v_cod_dwb_user begins 'es_' then
                   return "Programa execut†vel n∆o foi encontrado:" /*l_programa_nao_encontrado*/  + "prgfin/mgl/escg0204zd.p".
               else do:
                   message getStrTrans("Programa execut†vel n∆o foi encontrado:", "MGL") /*l_programa_nao_encontrado*/  "prgfin/mgl/escg0204zd.p"
                          view-as alert-box error buttons ok.
                   return.
               end.
           end.
           else
               run prgfin/mgl/escg0204zd.p /*prg_fnc_conjto_prefer_demonst_505*/.
       end /* if */.
       else do:
           if  search("prgfin/mgl/escg0204ze.r") = ? and search("prgfin/mgl/escg0204ze.p") = ? then do:
               if  v_cod_dwb_user begins 'es_' then
                   return "Programa execut†vel n∆o foi encontrado:" /*l_programa_nao_encontrado*/  + "prgfin/mgl/escg0204ze.p".
               else do:
                   message getStrTrans("Programa execut†vel n∆o foi encontrado:", "MGL") /*l_programa_nao_encontrado*/  "prgfin/mgl/escg0204ze.p"
                          view-as alert-box error buttons ok.
                   return.
               end.
           end.
           else
               run prgfin/mgl/escg0204ze.p /*prg_fnc_conjto_prefer_demonst_505_cons*/.
       end /* else */.
...
DO:
    ...
    if  search("prgfin/mgl/escg0204zf.r") = ? and search("prgfin/mgl/escg0204zf.p") = ? then do:
        if  v_cod_dwb_user begins 'es_' then
            return "Programa execut†vel n∆o foi encontrado:" /*l_programa_nao_encontrado*/  + "prgfin/mgl/escg0204zf.p".
        else do:
            message getStrTrans("Programa execut†vel n∆o foi encontrado:", "MGL") /*l_programa_nao_encontrado*/  "prgfin/mgl/escg0204zf.p"
                   view-as alert-box error buttons ok.
            return.
        end.
    end.
    else
        run prgfin/mgl/escg0204zf.p /*prg_fnc_compos_demonst_subst_505*/.
...
DO:
    ...
    assign v_nom_prog_ext = "prgfin/mgl/escg0204zb.p":U
...
then do:
    run pi_version_extract ('fnc_prefer_demonst_ctbl':U, 'prgfin/mgl/escg0204zb.p':U, '5.12.16.100':U, 'pro':U).
end /* if */.
