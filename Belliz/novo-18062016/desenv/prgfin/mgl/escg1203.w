...
*******************************************************************************/
{include/i-prgvrs.i ESCG1203 5.12.16.100}
...
DO:
  ...
  RUN prgfin/mgl/escg1203aa.w (INPUT v-row-1).
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'prgfin/mgl/escgvwr/v02escg1201.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'prgfin/mgl/escgbrw/b01escg1203.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'prgfin/mgl/escgqry/Q01escg1201.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESCG1203" "5.12.16.100"}
