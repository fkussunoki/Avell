...
bt-config-impr c-arquivo seq-orcto seq-orcto-2 bt-modelo-rtf r-office ~
text-rtf text-modelo-rtf 
&Scoped-Define DISPLAYED-OBJECTS rs-destino c-arquivo l-habilitaRtf ~
seq-orcto seq-orcto-2 c-modelo-rtf c-versao r-office text-rtf ~
text-modelo-rtf 
...
DEFINE FRAME f-pg-sel
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         SIZE 76.57 BY 10.79 WIDGET-ID 100.
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY rs-destino c-arquivo l-habilitaRtf seq-orcto seq-orcto-2 c-modelo-rtf 
          c-versao r-office text-rtf text-modelo-rtf 
      WITH FRAME f-pg-imp IN WINDOW w-relat.
  ENABLE rect-rtf RECT-7 RECT-9 bt-arquivo bt-config-impr c-arquivo seq-orcto 
         seq-orcto-2 bt-modelo-rtf r-office text-rtf text-modelo-rtf 
      WITH FRAME f-pg-imp IN WINDOW w-relat.
