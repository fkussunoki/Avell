...
PROCEDURE pi_razao_contabil_demonst: 
    ...
    then do:
        ...
        if  search("prgfin/fgl/esfgl03a.p") = ? and search("prgfin/fgl/esfgl03a.p") = ? then do:
            if  v_cod_dwb_user begins 'es_' then
                return "Programa execut†vel n∆o foi encontrado:" /*l_programa_nao_encontrado*/  + "prgfin/fgl/esfgl03a.p".
            else do:
                message getStrTrans("Programa execut†vel n∆o foi encontrado:", "MGL") /*l_programa_nao_encontrado*/  "prgfin/fgl/esfgl03a.p"
                       view-as alert-box error buttons ok.
                return.
            end.
        end.
        else
            run prgfin/fgl/esfgl03a.p /*prg_bas_cta_ctbl_razao*/.
    END.
    else do:
        ...
        if  search("prgfin/fgl/esfgl03a.p") = ? and search("prgfin/fgl/esfgl03a.p") = ? then do:
            ...
            run prgfin/fgl/esfgl03a.p /*prg_bas_ccusto_razao*/.
    END.
