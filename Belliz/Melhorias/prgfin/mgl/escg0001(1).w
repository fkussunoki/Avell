...
DO:
    ...
    IF c-empresa:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "MAE" THEN DO:
        ...
        ASSIGN c-ccusto-ini:SCREEN-VALUE IN FRAME {&FRAME-NAME} = c-ccusto-ini:SCREEN-VALUE IN FRAME {&FRAME-NAME} + "m"
               c-ccusto-fim:SCREEN-VALUE IN FRAME {&FRAME-NAME} = c-ccusto-fim:SCREEN-VALUE IN FRAME {&FRAME-NAME} + "m".
    END.
END.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE c-empresa c-cenario-ctbl seq-orcto-3 seq-orcto c-cta-ini c-cta-fim 
         c-ccusto-ini c-ccusto-fim c-dt-ini c-dt-fim c-arquivo-entrada 
         bt-arquivo-entrada IMAGE-5 IMAGE-6 IMAGE-7 IMAGE-8 IMAGE-9 IMAGE-10 
         RECT-8 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
