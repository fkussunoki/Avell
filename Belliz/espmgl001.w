...
bt-config-impr c-arquivo seq-orcto-2 seq-orcto bt-modelo-rtf r-office ~
text-rtf text-modelo-rtf 
&Scoped-Define DISPLAYED-OBJECTS rs-destino c-arquivo l-habilitaRtf ~
seq-orcto-2 seq-orcto c-modelo-rtf c-versao r-office text-rtf ~
text-modelo-rtf 
...
DEFINE VARIABLE seq-orcto-2 AS INTEGER FORMAT "->,>>>,>>9":U INITIAL 0 
     LABEL "Sequencia Oráamento" 
     VIEW-AS FILL-IN 
     SIZE 16 BY .88 NO-UNDO.
...
DEFINE VARIABLE c-cta-fim AS CHARACTER FORMAT "X(6)":U 
     VIEW-AS FILL-IN 
     SIZE 14 BY .88 NO-UNDO.
...
DEFINE FRAME f-relat
     bt-executar AT ROW 17.75 COL 3 HELP
          "Dispara a execuá∆o do relat¢rio"
     bt-cancelar AT ROW 17.75 COL 14 HELP
          "Fechar"
     bt-ajuda AT ROW 17.75 COL 70 HELP
          "Ajuda"
...
DEFINE FRAME f-pg-imp
     ...
     seq-orcto-2 AT ROW 4.88 COL 30.43 COLON-ALIGNED WIDGET-ID 20
     seq-orcto AT ROW 4.88 COL 30.43 COLON-ALIGNED WIDGET-ID 18
...
DEFINE FRAME f-pg-sel
     ...
     seq-orcto AT ROW 4.88 COL 30.43 COLON-ALIGNED WIDGET-ID 42
          LABEL "Sequencia Oráamento" FORMAT "->,>>>,>>9":U
          VIEW-AS FILL-IN 
          SIZE 16 BY .88
     c-unid-orctaria AT ROW 6 COL 30.43 COLON-ALIGNED WIDGET-ID 48
     c-versao AT ROW 7.21 COL 30.57 COLON-ALIGNED WIDGET-ID 36
          LABEL "Versao" FORMAT "X(256)":U
          VIEW-AS FILL-IN 
          SIZE 15.57 BY .88
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         SIZE 76.86 BY 14.21 WIDGET-ID 100.
...
/* SETTINGS FOR EDITOR c-modelo-rtf IN FRAME f-pg-imp
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN c-versao IN FRAME f-pg-imp
   NO-ENABLE                                                            */
...
ON F5 OF seq-orcto IN FRAME f-pg-imp /* Sequencia Oráamento */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL seq-orcto w-relat
ON LEFT-MOUSE-DBLCLICK OF seq-orcto IN FRAME f-pg-imp /* Sequencia Oráamento */
DO:
  APPLY 'f5' TO SELF.
END.
...
&Scoped-define FRAME-NAME f-pg-imp
&Scoped-define SELF-NAME seq-orcto-2
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL seq-orcto-2 w-relat
ON F5 OF seq-orcto-2 IN FRAME f-pg-imp /* Sequencia Oráamento */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL seq-orcto-2 w-relat
ON LEFT-MOUSE-DBLCLICK OF seq-orcto-2 IN FRAME f-pg-imp /* Sequencia Oráamento */
DO:
  APPLY 'f5' TO SELF.
END.
...
{utp/ut9000.i "BDGA3000" "1.00.00.003"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-empresa c-cenario-orc c-cenario-ctbl seq-orcto-3 seq-orcto 
          c-unid-orctaria c-versao c-cta-fim c-cta-ini c-ccusto-fim c-ccusto-ini 
          c-dt-fim c-dt-ini 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-5 IMAGE-6 IMAGE-7 IMAGE-8 IMAGE-9 IMAGE-10 c-empresa 
         c-cenario-ctbl seq-orcto-3 seq-orcto c-cta-fim c-cta-ini c-ccusto-fim 
         c-ccusto-ini c-dt-fim c-dt-ini 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  {&OPEN-BROWSERS-IN-QUERY-f-pg-sel}
  DISPLAY rs-destino c-arquivo l-habilitaRtf seq-orcto-2 seq-orcto c-modelo-rtf 
          c-versao r-office text-rtf text-modelo-rtf 
      WITH FRAME f-pg-imp IN WINDOW w-relat.
  ENABLE rect-rtf RECT-7 RECT-9 bt-arquivo bt-config-impr c-arquivo seq-orcto-2 
         seq-orcto bt-modelo-rtf r-office text-rtf text-modelo-rtf 
      WITH FRAME f-pg-imp IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           /*Fim alteracao 14/02/2005*/
            ...
            tt-param.ttv-cenar-orctario    = INPUT FRAME f-pg-sel c-ccusto-ini  
    ...
    SESSION:SET-WAIT-STATE("general":U).
      ...
      {include/i-rprun.i esp/espmgl001rp.p}
