...
**
** Programa..............: api_demonst_ctbl_fin_1
** Descricao.............: API Demonstrativo de v°deo 1
** Versao................:  1.00.00.014
** Procedimento..........: con_demonst_ctbl_video
** Nome Externo..........: prgfin/mgl/MGLA204zj.py
** Data Geracao..........: 14/11/2013 - 14:18:39
** Criado por............: fut35118
** Criado em.............: 04/12/2006 10:20:32
** Alterado por..........: fut41162_3
** Alterado em...........: 18/09/2009 10:11:55
...
{include/i-license-manager.i api_demonst_ctbl_fin_1 MGL}
&ENDIF
...
{include/i-ctrlrp5.i api_demonst_ctbl_fin_1}
...
then do:
    run pi_version_extract ('api_demonst_ctbl_fin_1':U, 'prgfin/mgl/MGLA204zj.py':U, '1.00.00.014':U, 'pro':U).
end /* if */.
...
find prog_dtsul
    where prog_dtsul.cod_prog_dtsul = "api_demonst_ctbl_fin_1":U
    no-lock no-error.
...
/*****************************************************************************
** Procedure Interna.....: pi_retorno_api_demonst_ctbl_video
** Descricao.............: pi_retorno_api_demonst_ctbl_video
** Criado por............: fut12139
** Criado em.............: 28/03/2005 17:17:43
** Alterado por..........: fut31947
** Alterado em...........: 27/06/2007 15:01:33
*****************************************************************************/
PROCEDURE pi_retorno_api_demonst_ctbl_video:
    ...
    FOR EACH tt_demonst_ctbl_video NO-LOCK
        ...
        CREATE tt_retorno_demonst_lin.
        ASSIGN tt_retorno_demonst_lin.tta_cod_demonst_ctbl          = tt_prefer_demonst_ctbl_1.tta_cod_demonst_ctbl
               tt_retorno_demonst_lin.tta_cod_padr_col_demonst_ctbl = tt_prefer_demonst_ctbl_1.tta_cod_padr_col_demonst_ctbl
               tt_retorno_demonst_lin.ttv_num_seq_lin               = v_num_linha
               tt_retorno_demonst_lin.ttv_des_val_col               = v_des_val_col.

        /* Zera conte£do da vari†vel para pr¢xima impress∆o e atualiza contador linha */
        ASSIGN v_des_val_col = ""
               v_num_linha   = v_num_linha + 1.
    END.
END PROCEDURE. /* pi_retorno_api_demonst_ctbl_video */
/*****************************************************************************
...
/*****************************************************************************
** Procedure Interna.....: pi_main_api_demonst_ctbl_fin
** Descricao.............: pi_main_api_demonst_ctbl_fin
** Criado por............: fut35118
** Criado em.............: 04/12/2006 11:09:49
** Alterado por..........: fut35118
** Alterado em...........: 20/12/2006 10:59:42
*****************************************************************************/
PROCEDURE pi_main_api_demonst_ctbl_fin:
    ...
    if  NO = &IF DEFINED (BF_FIN_DEMONST_EM_LOTE) &THEN YES
                    &ELSE GetDefinedFunction('SPP_DEMONST_EM_LOTE':U) &ENDIF
    then do:
        ...
        if  NOT CAN-FIND(tt_erros_api_demonst_lote NO-LOCK
                   WHERE tt_erros_api_demonst_lote.tta_cod_demonst_ctbl          = tt_prefer_demonst_ctbl_1.tta_cod_demonst_ctbl
                     AND tt_erros_api_demonst_lote.tta_cod_padr_col_demonst_ctbl = tt_prefer_demonst_ctbl_1.tta_cod_padr_col_demonst_ctbl
                     AND tt_erros_api_demonst_lote.ttv_num_erro                  = 7927 )
        then do:

            CREATE tt_erros_api_demonst_lote.
            ASSIGN tt_erros_api_demonst_lote.tta_cod_demonst_ctbl          = tt_prefer_demonst_ctbl_1.tta_cod_demonst_ctbl
                   tt_erros_api_demonst_lote.tta_cod_padr_col_demonst_ctbl = tt_prefer_demonst_ctbl_1.tta_cod_padr_col_demonst_ctbl
                   tt_erros_api_demonst_lote.ttv_num_erro                  = 7927
                   v_des_param = substitute ("&1~~&2~~&3~~&4~~&5~~&6~~&7~~&8~~&9", 'api_demonst_ctbl_fin_1',"","","") + "~~~~~~~~~~~~~~~~".

            run pi_messages (input "msg",
                             input 7927,
                             input substitute ("&1~~&2~~&3~~&4~~&5~~&6~~&7~~&8~~&9")).
            assign tt_erros_api_demonst_lote.ttv_des_msg_erro = return-value /*msg_7927*/.
            ASSIGN tt_erros_api_demonst_lote.ttv_des_msg_erro = SUBSTITUTE(tt_erros_api_demonst_lote.ttv_des_msg_erro, ENTRY(1,v_des_param,"~~"),
                                                                                                                       ENTRY(2,v_des_param,"~~"),
                                                                                                                       ENTRY(3,v_des_param,"~~"),
                                                                                                                       ENTRY(4,v_des_param,"~~"),
            ...
            run pi_messages (input "help",
                             input 7927,
                             input substitute ("&1~~&2~~&3~~&4~~&5~~&6~~&7~~&8~~&9")).
            assign tt_erros_api_demonst_lote.ttv_des_msg_ajuda = return-value /*msg_7927*/.
            ASSIGN tt_erros_api_demonst_lote.ttv_des_msg_ajuda = SUBSTITUTE(tt_erros_api_demonst_lote.ttv_des_msg_ajuda, ENTRY(1,v_des_param,"~~"),
                                                                                                                         ENTRY(2,v_des_param,"~~"),
                                                                                                                         ENTRY(3,v_des_param,"~~"),
                                                                                                                         ENTRY(4,v_des_param,"~~"),
    ...
    if can-find(prog_dtsul
           where prog_dtsul.cod_prog_dtsul = 'api_demonst_ctbl_fin_1' 
             and prog_dtsul.log_gera_log_exec = yes) then do transaction:
        create log_exec_prog_dtsul.
        assign log_exec_prog_dtsul.cod_prog_dtsul           = 'api_demonst_ctbl_fin_1'
    ...
    FOR EACH tt_prefer_demonst_ctbl_1:
        ...
        if  search("prgfin/mgl/MGLA204za.r") = ? and search("prgfin/mgl/MGLA204za.py") = ? then do:
            if  v_cod_dwb_user begins 'es_' then
                return "Programa execut†vel n∆o foi encontrado:" /*l_programa_nao_encontrado*/  + "prgfin/mgl/MGLA204za.py".
            else do:
                message "Programa execut†vel n∆o foi encontrado:" /*l_programa_nao_encontrado*/  "prgfin/mgl/MGLA204za.py"
                       view-as alert-box error buttons ok.
                return.
            end.
        end.
        else
            run prgfin/mgl/MGLA204za.py (Input 1,
        ...
        /* ***[ Formata Retorno API ]****/
        run pi_retorno_api_demonst_ctbl_video /*pi_retorno_api_demonst_ctbl_video*/.
    ...
    return.
END PROCEDURE. /* pi_main_api_demonst_ctbl_fin */
