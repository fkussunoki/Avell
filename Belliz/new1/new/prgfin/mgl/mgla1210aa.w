...
&Scoped-Define ENABLED-OBJECTS rt-button c_cod_palavras bt-ok bt-cancela ~
bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS c_cod_palavras 
...
DEFINE VARIABLE c_cod_palavras AS CHARACTER FORMAT "x(100)":U 
     LABEL "Palavras" 
     VIEW-AS FILL-IN 
     SIZE 37.29 BY .92 NO-UNDO.
...
DEFINE FRAME d-vapara
     c_cod_palavras AT ROW 2.08 COL 20.14 COLON-ALIGNED WIDGET-ID 2
...
ON GO OF FRAME d-vapara /* V  Para Pacotes / Rubricas */
DO:
FIND ext_palavras_excecao NO-LOCK
    WHERE ext_palavras_excecao.cod_palavras EQ INPUT FRAME {&FRAME-NAME} c_cod_palavras NO-ERROR.

IF NOT AVAILABLE ext_palavras_excecao THEN DO:
    {utp/ut-table.i emscad ext_palavras_excecao 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(ext_palavras_excecao).
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL d-vapara d-vapara
ON WINDOW-CLOSE OF FRAME d-vapara /* V  Para Pacotes / Rubricas */
DO:  
...
------------------------------------------------------------------------------*/
  DISPLAY c_cod_palavras 
      WITH FRAME d-vapara.
  ENABLE rt-button c_cod_palavras bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "MGLA1210aa" "1.00.00.001"}
