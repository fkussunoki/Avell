...
&Scoped-define INTERNAL-TABLES periodo_orcto

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH periodo_orcto NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH periodo_orcto NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main periodo_orcto
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main periodo_orcto
