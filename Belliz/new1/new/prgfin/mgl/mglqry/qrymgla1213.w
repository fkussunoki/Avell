...
&Scoped-define QUERY-STRING-Query-Main FOR EACH niv_usuar NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH niv_usuar NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main niv_usuar
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main niv_usuar
