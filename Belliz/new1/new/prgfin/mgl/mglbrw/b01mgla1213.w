...
&Scoped-define INTERNAL-TABLES niv_usuar

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br-table                                      */
&Scoped-define FIELDS-IN-QUERY-br-table niv_usuar.cod_niv_usuar ~
niv_usuar.des_niv_usuar 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-table 
&Scoped-define QUERY-STRING-br-table FOR EACH niv_usuar WHERE ~{&KEY-PHRASE} ~
      AND niv_usuar.cod_niv_usuar >= c-inicial ~
 AND niv_usuar.cod_niv_usuar <= c-final NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-br-table OPEN QUERY br-table FOR EACH niv_usuar WHERE ~{&KEY-PHRASE} ~
      AND niv_usuar.cod_niv_usuar >= c-inicial ~
 AND niv_usuar.cod_niv_usuar <= c-final NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-br-table niv_usuar
&Scoped-define FIRST-TABLE-IN-QUERY-br-table niv_usuar
...
<FOREIGN-KEYS>
cod_niv_usuar||y|emscad.niv_usuar.cod_niv_usuar
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-table B-table-Win _STRUCTURED
  QUERY br-table NO-LOCK DISPLAY
      niv_usuar.cod_niv_usuar FORMAT "x(15)":U
      niv_usuar.des_niv_usuar FORMAT "x(30)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br-table
     _TblList          = "emscad.niv_usuar"
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "emscad.niv_usuar.cod_niv_usuar >= c-inicial
 AND emscad.niv_usuar.cod_niv_usuar <= c-final"
     _FldNameList[1]   = emscad.niv_usuar.cod_niv_usuar
     _FldNameList[2]   = emscad.niv_usuar.des_niv_usuar
