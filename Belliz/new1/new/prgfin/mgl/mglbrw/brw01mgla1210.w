...
&Scoped-define INTERNAL-TABLES ext_palavras_excecao

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br-table                                      */
&Scoped-define FIELDS-IN-QUERY-br-table ext_palavras_excecao.cod_palavras 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-table 
&Scoped-define QUERY-STRING-br-table FOR EACH ext_palavras_excecao WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-br-table OPEN QUERY br-table FOR EACH ext_palavras_excecao WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-br-table ext_palavras_excecao
&Scoped-define FIRST-TABLE-IN-QUERY-br-table ext_palavras_excecao
...
DEFINE QUERY br-table FOR 
      ext_palavras_excecao SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-table B-table-Win _STRUCTURED
  QUERY br-table NO-LOCK DISPLAY
      ext_palavras_excecao.cod_palavras COLUMN-LABEL "Palavras" FORMAT "x(100)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br-table
     _TblList          = "emscad.ext_palavras_excecao"
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   > emscad.ext_palavras_excecao.cod_palavras
"cod_palavras" "Palavras" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
DEFINE INPUT PARAMETER P-CAMPO AS CHARACTER NO-UNDO.
    ...
    if  avail ext_palavras_excecao then do:
        case p-campo:
            when "cod_palavra" then
                assign p-valor = string(ext_palavras_excecao.cod_palavra).
        end.
    end.
    return p-valor.
END PROCEDURE.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "ext_palavras_excecao"}
