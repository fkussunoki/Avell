...
*******************************************************************************/
{include/i-prgvrs.i espacr 1.00.00.003}
...
def var v_num_seq_orcto_ctbl
    as integer
    format ">>>>>>>>9":U
    label "Seq Orcto Contˇbil"
    column-label "Seq Orcto Contˇbil"
    no-undo.
...
bt-config-impr c-arquivo bt-modelo-rtf r-office text-rtf text-modelo-rtf 
...
DEFINE VARIABLE c-dest-orcto AS CHARACTER FORMAT "X(256)":U 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE c-destino-ctbl AS CHARACTER FORMAT "X(256)":U 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE c-destino-seq AS INTEGER FORMAT "->,>>>,>>9":U INITIAL 0 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE c-destino-ver AS CHARACTER FORMAT "X(256)":U INITIAL "0" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE c-orig-ctbl AS CHARACTER FORMAT "X(256)":U 
     LABEL "Cenario Ctbl" 
     VIEW-AS FILL-IN 
     SIZE 14 BY .88 NO-UNDO.

DEFINE VARIABLE c-orig-orcto AS CHARACTER FORMAT "X(256)":U 
     LABEL "Cenario Orcto" 
     VIEW-AS FILL-IN 
     SIZE 14 BY .88 NO-UNDO.

DEFINE VARIABLE c-orig-seq AS INTEGER FORMAT "->,>>>,>>9":U INITIAL 0 
     LABEL "Seq. Orcto" 
     VIEW-AS FILL-IN 
     SIZE 14 BY .88 NO-UNDO.

DEFINE VARIABLE c-orig-vers AS CHARACTER FORMAT "X(256)":U 
     LABEL "Versao Orcto" 
     VIEW-AS FILL-IN 
     SIZE 14 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     c-dest-orcto AT ROW 2.83 COL 50.14 COLON-ALIGNED NO-LABEL
     c-orig-orcto AT ROW 2.92 COL 16.72 COLON-ALIGNED WIDGET-ID 38
     c-orig-ctbl AT ROW 4.54 COL 16.57 COLON-ALIGNED WIDGET-ID 44
     c-destino-ctbl AT ROW 4.58 COL 50.14 COLON-ALIGNED NO-LABEL WIDGET-ID 4
     c-orig-seq AT ROW 6.17 COL 16.43 COLON-ALIGNED WIDGET-ID 46
     c-destino-seq AT ROW 6.21 COL 50 COLON-ALIGNED NO-LABEL WIDGET-ID 18
     c-destino-ver AT ROW 7.58 COL 50 COLON-ALIGNED NO-LABEL WIDGET-ID 28
     c-orig-vers AT ROW 7.67 COL 16.72 COLON-ALIGNED WIDGET-ID 48
     "Destino:" VIEW-AS TEXT
          SIZE 8 BY .67 AT ROW 1.25 COL 54.43 WIDGET-ID 74
     "Origem:" VIEW-AS TEXT
          SIZE 8 BY .67 AT ROW 1.21 COL 19 WIDGET-ID 70
     IMAGE-1 AT ROW 2.92 COL 33.29 WIDGET-ID 50
     IMAGE-2 AT ROW 2.92 COL 48.72 WIDGET-ID 52
     IMAGE-3 AT ROW 4.67 COL 33.29 WIDGET-ID 54
     IMAGE-4 AT ROW 4.67 COL 48.72 WIDGET-ID 56
     IMAGE-5 AT ROW 6.21 COL 33.14 WIDGET-ID 58
     IMAGE-6 AT ROW 6.21 COL 48.57 WIDGET-ID 60
     IMAGE-7 AT ROW 7.63 COL 33 WIDGET-ID 62
     IMAGE-8 AT ROW 7.63 COL 48.43 WIDGET-ID 64
     RECT-11 AT ROW 1.5 COL 2.14 WIDGET-ID 68
     RECT-12 AT ROW 1.5 COL 41.29 WIDGET-ID 72
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
...
/* SETTINGS FOR FRAME f-pg-sel
                                                                        */
/* SETTINGS FOR FILL-IN c-destino-seq IN FRAME f-pg-sel
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN c-destino-ver IN FRAME f-pg-sel
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN c-orig-ctbl IN FRAME f-pg-sel
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN c-orig-orcto IN FRAME f-pg-sel
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN c-orig-seq IN FRAME f-pg-sel
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN c-orig-vers IN FRAME f-pg-sel
   NO-ENABLE                                                            */
...
&Scoped-define SELF-NAME c-dest-orcto
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL c-dest-orcto w-relat
ON F5 OF c-dest-orcto IN FRAME f-pg-sel
DO:
...
assign c-dest-orcto:screen-value  in frame f-pg-sel = string(vers_orcto_ctbl_bgc.cod_cenar_orctario)
      c-destino-seq:screen-value  in frame f-pg-sel = string(vers_orcto_ctbl_bgc.num_seq_orcto_ctbl)
      c-destino-ver:SCREEN-VALUE IN FRAME f-pg-sel = string(vers_orcto_ctbl_bgc.cod_vers_orcto_ctbl).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL c-dest-orcto w-relat
ON MOUSE-SELECT-DBLCLICK OF c-dest-orcto IN FRAME f-pg-sel
DO:
  APPLY 'f5'.
END.
...
&Scoped-define SELF-NAME c-destino-ctbl
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL c-destino-ctbl w-relat
ON F5 OF c-destino-ctbl IN FRAME f-pg-sel
DO:
    run prgint/utb/utb076ka.p.
        find cenar_ctbl where recid(cenar_ctbl) = v_rec_cenar_ctbl no-lock no-error.
         assign c-destino-ctbl:screen-value in frame f-pg-sel =
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL c-destino-ctbl w-relat
ON LEFT-MOUSE-DBLCLICK OF c-destino-ctbl IN FRAME f-pg-sel
DO:
  APPLY 'f5' TO SELF.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL c-destino-ctbl w-relat
ON MOUSE-SELECT-DBLCLICK OF c-destino-ctbl IN FRAME f-pg-sel
DO:
  APPLY 'f5'.
END.
...
&Scoped-define SELF-NAME c-destino-seq
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL c-destino-seq w-relat
ON LEFT-MOUSE-DBLCLICK OF c-destino-seq IN FRAME f-pg-sel
DO:
  APPLY 'f5' TO SELF.
END.
...
&Scoped-define SELF-NAME c-destino-ver
&Scoped-define FRAME-NAME f-relat
...
{utp/ut9000.i "MGLA3000" "1.00.00.000"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    FIND LAST conjto_prefer_demonst NO-LOCK WHERE conjto_prefer_demonst.cod_vers_orcto_ctbl <> ""
                                            AND   conjto_prefer_demonst.cod_usuario = "sonia" NO-ERROR.

    IF AVAIL conjto_prefer_demonst THEN DO:
        
    
    ASSIGN c-orig-orcto:SCREEN-VALUE IN FRAME f-pg-sel = conjto_prefer_demonst.cod_cenar_orctario
           c-orig-ctbl:SCREEN-VALUE IN FRAME f-pg-sel = conjto_prefer_demonst.cod_cenar_ctbl
           c-orig-seq:SCREEN-VALUE IN FRAME f-pg-sel = string(conjto_prefer_demonst.num_seq_orcto_ctbl)
           c-orig-vers:SCREEN-VALUE IN FRAME f-pg-sel = conjto_prefer_demonst.cod_vers_orcto_ctbl.
END.           
    c-dest-orcto:load-mouse-pointer ("image/lupa.cur") in frame f-pg-sel.
    c-destino-ctbl:load-mouse-pointer ("image/lupa.cur") in frame f-pg-sel.
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-dest-orcto c-orig-orcto c-orig-ctbl c-destino-ctbl c-orig-seq 
          c-destino-seq c-destino-ver c-orig-vers 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 IMAGE-5 IMAGE-6 IMAGE-7 IMAGE-8 
         RECT-11 RECT-12 c-dest-orcto c-destino-ctbl 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  {&OPEN-BROWSERS-IN-QUERY-f-pg-sel}
  DISPLAY rs-destino c-arquivo l-habilitaRtf c-modelo-rtf r-office text-rtf 
          text-modelo-rtf 
      WITH FRAME f-pg-imp IN WINDOW w-relat.
  ENABLE rect-rtf RECT-7 RECT-9 bt-arquivo bt-config-impr c-arquivo 
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           /*Fim alteracao 14/02/2005*/
            tt-param.cenario-orc-origem     = INPUT FRAME f-pg-sel c-orig-orcto
            tt-param.cenario-ctbl-origem    = INPUT FRAME f-pg-sel c-orig-ctbl
            tt-param.seq-orcto-origem       = INPUT FRAME f-pg-sel c-orig-seq
            tt-param.versao-orcto-origem    = INPUT FRAME f-pg-sel c-orig-vers
            tt-param.cenario-orc-destino    = INPUT FRAME f-pg-sel c-dest-orcto
            tt-param.cenario-ctbl-destino   = INPUT FRAME f-pg-sel c-destino-ctbl
            tt-param.seq-orcto-destino      = INPUT FRAME f-pg-sel c-destino-seq
            tt-param.versao-orcto-destino   = INPUT FRAME f-pg-sel c-destino-ver.
    ...
    {include/i-rprun.i prgfin\MGL\MGLA3000aa.p}
