 ...
 ELSE 
   ...
   ASSIGN v_cp = v_cp3 - v_cp2.
    ...
    RUN prgfin/mgl/mgla12010.w (INPUT conjto_prefer_demonst.cod_demonst_ctbl,
                                ...
                                INPUT IF TRIM(tt_demonst_ctbl_fin.ttv_cod_campo_3) BEGINS "(" THEN ENTRY(1, entry(2, TRIM(ttv_cod_campo_3), "(" ) , ")") ELSE TRIM(ttv_cod_campo_3) ,
                                INPUT IF TRIM(tt_demonst_ctbl_fin.ttv_cod_campo_2) BEGINS "(" THEN ENTRY(1, entry(2, TRIM(ttv_cod_campo_2), "(" ) , ")") ELSE TRIM(ttv_cod_campo_2)).
