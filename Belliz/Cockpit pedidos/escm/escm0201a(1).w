...
c-matriz-ini c-matriz-fim c-estab-ini c-estab-fim bt-cancela bt-ok 
...
DEFINE VARIABLE l-abertos AS LOGICAL INITIAL no 
     LABEL "Abertos" 
     VIEW-AS TOGGLE-BOX
...
DEFINE VARIABLE l-atendido-parcial AS LOGICAL INITIAL no 
...
DEFINE VARIABLE l-nao-aprovado AS LOGICAL INITIAL no 
     LABEL "Nao Aprovado" 
     VIEW-AS TOGGLE-BOX
     SIZE 39.29 BY .83 NO-UNDO.

DEFINE VARIABLE l-nao-avaliado AS LOGICAL INITIAL no 
     LABEL "Nao avaliado" 
     VIEW-AS TOGGLE-BOX
...
DEFINE FRAME f-cad
     ...
     bt-cancela AT ROW 24.71 COL 19.43 WIDGET-ID 112
...
------------------------------------------------------------------------------*/
  ...
  ENABLE rt-button RECT-22 RECT-23 RECT-25 IMAGE-1 IMAGE-2 IMAGE-49 IMAGE-50 
         ...
         c-estab-ini c-estab-fim bt-cancela bt-ok 
      WITH FRAME f-cad IN WINDOW w-livre.
