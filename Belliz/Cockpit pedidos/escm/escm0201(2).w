...
&Scoped-define QUERY-STRING-br-pedidos FOR EACH tt-ped-venda USE-INDEX order_customer  NO-LOCK          INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-br-pedidos OPEN query {&SELF-NAME} FOR EACH tt-ped-venda USE-INDEX order_customer  NO-LOCK          INDEXED-REPOSITION.
...
fi-nr-pedcli BUTTON-5 BUTTON-6 f-situacao fi-email-repres fi-vl-tot-abe ~
fi-vl-tot-liq fi-vl-tot-ped 
&Scoped-Define DISPLAYED-OBJECTS fi-tempo-proc fi-nr-pedcli f-pedido ~
f-estab f-situacao fi-email-repres fi-telefone-repres fi-vl-tot-abe ~
fi-vl-tot-liq fi-vl-tot-ped 
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS MULTIPLE SIZE 137.72 BY 14.17
         FONT 1
...
------------------------------------------------------------------------------*/
  DISPLAY fi-tempo-proc fi-nr-pedcli f-pedido f-estab f-situacao fi-email-repres 
          fi-telefone-repres fi-vl-tot-abe fi-vl-tot-liq fi-vl-tot-ped 
      WITH FRAME fpg0 IN WINDOW wWindow.
  ENABLE rt-button BUTTON-4 bt-carrega BUTTON-8 fi-nr-pedcli BUTTON-5 BUTTON-6 
         f-situacao fi-email-repres fi-vl-tot-abe fi-vl-tot-liq fi-vl-tot-ped 
      WITH FRAME fpg0 IN WINDOW wWindow.
