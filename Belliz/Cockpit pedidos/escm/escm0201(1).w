...
&Scoped-Define ENABLED-OBJECTS rt-button BUTTON-4 bt-carrega fi-nr-pedcli ~
BUTTON-5 BUTTON-6 fi-email-repres fi-vl-tot-abe fi-vl-tot-liq fi-vl-tot-ped 
&Scoped-Define DISPLAYED-OBJECTS fi-tempo-proc fi-nr-pedcli fi-email-repres ~
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 137.72 BY 14.17
         FONT 1
         TITLE "Pedido de Venda - Quantidade 0" FIT-LAST-COLUMN.
...
ON RETURN OF fi-nr-pedcli IN FRAME fpg0 /* Pedido Cliente */
DO:
...
------------------------------------------------------------------------------*/
  DISPLAY fi-tempo-proc fi-nr-pedcli fi-email-repres fi-telefone-repres 
          fi-vl-tot-abe fi-vl-tot-liq fi-vl-tot-ped 
      WITH FRAME fpg0 IN WINDOW wWindow.
  ENABLE rt-button BUTTON-4 bt-carrega fi-nr-pedcli BUTTON-5 BUTTON-6 
         fi-email-repres fi-vl-tot-abe fi-vl-tot-liq fi-vl-tot-ped 
      WITH FRAME fpg0 IN WINDOW wWindow.
