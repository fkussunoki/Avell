...
&Scoped-Define DISPLAYED-OBJECTS cb-situacao c-demonst c-coluna ~
d-data-criacao d-dt-altera c-periodo c-rubrica c-entidade c-exercicio ~
desvio c-usuario EDITOR-1 desvio-2 
...
DEFINE FRAME F-Main
     ...
     c-entidade AT ROW 5.33 COL 77.29 COLON-ALIGNED WIDGET-ID 12
     ...
     desvio-2 AT ROW 6.5 COL 77.29 COLON-ALIGNED WIDGET-ID 34
...
------------------------------------------------------------------------------*/
  DISPLAY cb-situacao c-demonst c-coluna d-data-criacao d-dt-altera c-periodo 
          c-rubrica c-entidade c-exercicio desvio c-usuario EDITOR-1 desvio-2 
...
IF AVAIL ext_justificativa THEN DO:
    ...
    ASSIGN c-demonst:SCREEN-VALUE IN FRAME f-main = ext_justificativa.Cod_demonst
           ...
           desvio:SCREEN-VALUE IN FRAME f-main         = string(ext_justificativa.orcado)
           c-usuario:SCREEN-VALUE IN FRAME f-main      = p-usuario
           desvio-2:SCREEN-VALUE IN FRAME f-main       = string(ext_justificativa.realizado)
