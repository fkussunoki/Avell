...
*******************************************************************************/
{include/i-prgvrs.i ESCG1214ab 5.12.16.100}
...
DEFINE VARIABLE h_b01mgla1214 AS HANDLE NO-UNDO.
...
ON END-ERROR OF w-pesquisa /* Pesquisa de Situacao */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-pesquisa w-pesquisa
ON WINDOW-CLOSE OF w-pesquisa /* Pesquisa de Situacao */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'prgfin/mgl/escgbrw/b01escg1214.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b01mgla1214 ).
       RUN set-position IN h_b01mgla1214 ( 3.33 , 5.57 ) NO-ERROR.
       /* Size in UIB:  ( 10.17 , 80.14 ) */

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b01mgla1214 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESCG1214ab" "5.12.16.100"}
