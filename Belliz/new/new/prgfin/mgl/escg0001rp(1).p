DEF TEMP-TABLE blz-sdo_ctbl LIKE sdo_ctb.
DEF VAR h-prog AS HANDLE.


/*include de controle de versÆo*/
{include/i-prgvrs.i ESCG0001 5.12.16.100}
...
DEF VAR chPicture       AS COMPONENT-HANDLE         NO-UNDO.
DEF VAR chRange         AS COMPONENT-HANDLE         NO-UNDO.
...
/* inicio da planilha  - criacao e conteudo de abas */
...
PROCEDURE pi-define-hcm:
    ...
    FOR EACH compos_demonst_ctbl NO-LOCK WHERE compos_demonst_ctbl.cod_demonst_ctbl = "1216"
        ...
        ELSE ASSIGN tt-compos.cod_cta_ctbl = v-codigo.
...
PROCEDURE pi-cria-temp-tables:
    ...
    FOR EACH sdo_ctbl NO-LOCK WHERE  sdo_ctbl.cod_empresa                                              = tt-param.ttv-empresa
                               ...
                               :
         FIND FIRST tt-compos WHERE tt-compos.cod_cta_ctbl = sdo_ctbl.cod_cta_ctbl NO-ERROR.
        ...
        ASSIGN blz-sdo_ctbl.cod_empresa = sdo_ctbl.cod_empresa
               ...
               blz-sdo_ctbl.cod_ccusto         = IF AVAIL tt-compos THEN "1216" ELSE sdo_ctbl.cod_ccusto
...
PROCEDURE pi-parte-fixa:
    RUN pi-inicializar IN h-prog("Montando parte fixa.....").


    ASSIGN chWSheet:Range(c-alfabet[01] + "1" + ":" + c-alfabet[03] + "1"):mergecells = YES.
    ASSIGN chWSheet:Range(c-alfabet[01]+  "1"):VALUE = "Acompanhamento de Despesas Realizados".
    ASSIGN chWSheet:Range(c-alfabet[01] + "1" + ":" + c-alfabet[03] + "1"):borders({&xlEdgeLeftTopBottomRight}):Weight = {&xlMedium}.
    ASSIGN chWSheet:Range(c-alfabet[01] + "1"):FONT:Bold = TRUE.



    ASSIGN chWSheet:Range(c-alfabet[01] + "2" + ":" + c-alfabet[02] + "2"):mergecells = YES.
    ASSIGN chWSheet:Range(c-alfabet[01] + "2"):VALUE = "Area".
    ASSIGN chWSheet:Range(c-alfabet[01] + "2" + ":" + c-alfabet[02] + "2"):borders({&xlEdgeLeftTopBottomRight}):Weight = {&xlMedium}.
    ASSIGN chWSheet:Range(c-alfabet[03] + "2" + ":" + c-alfabet[03] + "2"):mergecells = YES.
    ASSIGN chWSheet:Range(c-alfabet[03] + "2"):VALUE = "".
    ASSIGN chWSheet:Range(c-alfabet[03] + "2" + ":" + c-alfabet[03] + "2"):borders({&xlEdgeLeftTopBottomRight}):Weight = {&xlMedium}.




    ASSIGN chWSheet:Range(c-alfabet[01] + "3" + ":" + c-alfabet[02] + "3"):mergecells = YES.
    ASSIGN chWSheet:Range(c-alfabet[01] + "3"):VALUE = "Responsavel".
    ASSIGN chWSheet:Range(c-alfabet[01] + "3" + ":" + c-alfabet[02] + "3"):borders({&xlEdgeLeftTopBottomRight}):Weight = {&xlMedium}.
    ASSIGN chWSheet:Range(c-alfabet[03] + "3" + ":" + c-alfabet[03] + "3"):mergecells = YES.
    ASSIGN chWSheet:Range(c-alfabet[03] + "3"):VALUE = "".
    ASSIGN chWSheet:Range(c-alfabet[03] + "3" + ":" + c-alfabet[03] + "3"):borders({&xlEdgeLeftTopBottomRight}):Weight = {&xlMedium}.



    ASSIGN chWSheet:Range(c-alfabet[01] + "5" + ":" + c-alfabet[03] + "5"):mergecells = YES.
    ASSIGN chWSheet:Range(c-alfabet[01]+  "5"):VALUE = "Planilha de Despesas".
    ASSIGN chWSheet:Range(c-alfabet[01] + "5" + ":" + c-alfabet[03] + "5"):borders({&xlEdgeLeftTopBottomRight}):Weight = {&xlMedium}.
    ASSIGN chWSheet:Range(c-alfabet[01] + "5"):FONT:Bold = TRUE.

    ASSIGN chWSheet:Range(c-alfabet[01] + "6"):VALUE = "CC".
    ASSIGN chWSheet:Range(c-alfabet[01] + "6"):borders({&xlEdgeLeftTopBottomRight}):Weight = {&xlMedium}.
    ASSIGN chWSheet:range(c-alfabet[01] + "6"):FONT:bold = TRUE.


    ASSIGN chWSheet:Range(c-alfabet[02] + "6"):VALUE = "Conta Contabil".
    ASSIGN chWSheet:Range(c-alfabet[02] + "6"):borders({&xlEdgeLeftTopBottomRight}):Weight = {&xlMedium}.
    ASSIGN chWSheet:range(c-alfabet[02] + "6"):FONT:bold = TRUE.


    ASSIGN chWSheet:Range(c-alfabet[03] + "6"):VALUE = "Discriminacao".
    ASSIGN chWSheet:Range(c-alfabet[03] + "6"):borders({&xlEdgeLeftTopBottomRight}):Weight = {&xlMedium}.
    ASSIGN chWSheet:range(c-alfabet[03] + "6"):FONT:bold = TRUE.
...
/* ======================================================================================================== */
/* ======================================================================================================== */
RUN pi-inicializar IN h-prog("Montando cabecalho dinamico.......").
...
RUN pi-acompanhar IN h-prog(INPUT "Mes" + v-mes).
       ASSIGN chWSheet:Range(c-alfabet[col-ini] + "5" + ":" + c-alfabet[col-ini + 4] + "5"):mergecells = YES.
       ASSIGN chWSheet:Range(c-alfabet[col-ini] + "5" + ":" + c-alfabet[col-ini + 4] + "5"):borders({&xlEdgeLeftTopBottomRight}):Weight = {&xlMedium}.
       ASSIGN chWSheet:Range(c-alfabet[col-ini] + "5" + ":" + c-alfabet[col-ini + 4] + "5"):FONT:bold = TRUE.
       ASSIGN chWSheet:Range(c-alfabet[col-ini] + "5"):VALUE = v-mes.

       ASSIGN chWSheet:Range(c-alfabet[col-ini] + "6"):VALUE = "Orcado".
       ASSIGN chWSheet:Range(c-alfabet[col-ini] + "6"):borders({&xlEdgeLeftTopBottomRight}):Weight = {&xlMedium}.
       ASSIGN chWSheet:range(c-alfabet[col-ini] + "6"):FONT:bold = TRUE.

       ASSIGN col-ini = col-ini + 1.

       ASSIGN chWSheet:Range(c-alfabet[col-ini] + "6"):VALUE = "Realizado".
       ASSIGN chWSheet:Range(c-alfabet[col-ini] + "6"):borders({&xlEdgeLeftTopBottomRight}):Weight = {&xlMedium}.
       ASSIGN chWSheet:range(c-alfabet[col-ini] + "6"):FONT:bold = TRUE.

       ASSIGN col-ini = col-ini + 1.

       ASSIGN chWSheet:Range(c-alfabet[col-ini] + "6"):VALUE = "Var.(R$)".
       ASSIGN chWSheet:Range(c-alfabet[col-ini] + "6"):borders({&xlEdgeLeftTopBottomRight}):Weight = {&xlMedium}.
       ASSIGN chWSheet:range(c-alfabet[col-ini] + "6"):FONT:bold = TRUE.

       ASSIGN col-ini = col-ini + 1.

       ASSIGN chWSheet:Range(c-alfabet[col-ini] + "6"):VALUE = "Status".
       ASSIGN chWSheet:Range(c-alfabet[col-ini] + "6"):borders({&xlEdgeLeftTopBottomRight}):Weight = {&xlMedium}.
       ASSIGN chWSheet:range(c-alfabet[col-ini] + "6"):FONT:bold = TRUE.

       ASSIGN col-ini = col-ini + 1.

       ASSIGN chWSheet:Range(c-alfabet[col-ini] + "6"):VALUE = "Justificativas".
       ASSIGN chWSheet:Range(c-alfabet[col-ini] + "6"):borders({&xlEdgeLeftTopBottomRight}):Weight = {&xlMedium}.
       ASSIGN chWSheet:range(c-alfabet[col-ini] + "6"):FONT:bold = TRUE.
...
PROCEDURE pi-ytd:
RUN pi-inicializar IN h-prog (INPUT "Gerando YTD Cabecalho......").
...
/* ======================================================================================================== */
/* ======================================================================================================== */
   ASSIGN chWSheet:Range(c-alfabet[col-ini] + "5" + ":" + c-alfabet[col-ini + 3] + "5"):mergecells = YES.
   ASSIGN chWSheet:Range(c-alfabet[col-ini] + "5" + ":" + c-alfabet[col-ini + 3] + "5"):borders({&xlEdgeLeftTopBottomRight}):Weight = {&xlMedium}.
   ASSIGN chWSheet:Range(c-alfabet[col-ini] + "5" + ":" + c-alfabet[col-ini + 3] + "5"):FONT:bold = TRUE.
   ASSIGN chWSheet:Range(c-alfabet[col-ini] + "5"):VALUE = "YTD".
...
RUN pi-inicializar IN h-prog (INPUT "Gerando dados fixos......").
   FIND FIRST TT-PARAM NO-ERROR.
   ...
   FOR EACH blz-sdo_ctbl NO-LOCK WHERE blz-sdo_ctbl.cod_empresa                                           = tt-param.ttv-empresa
                             ...
                             BREAK BY blz-sdo_ctbl.cod_empresa + blz-sdo_ctbl.cod_cta_ctbl + blz-sdo_ctbl.cod_ccusto:
...
/*                                           AND   sdo_orcto_ctbl_bgc.cod_ccusto                          <= tt-param.ttv-cc-fim                         */
       ...
       IF LAST-OF(blz-sdo_ctbl.cod_empresa + blz-sdo_ctbl.cod_cta_ctbl + blz-sdo_ctbl.cod_ccusto) THEN DO:
      ...
      FIND FIRST cta_ctbl NO-LOCK WHERE cta_ctbl.cod_plano_cta_ctbl = plano_cta_ctbl.cod_plano_cta_ctbl
                                  AND   cta_ctbl.cod_cta_ctbl       =  blz-sdo_ctbl.cod_cta_ctbl  NO-ERROR.
...
/*                                       AND   ext_justificativa.cod_empresa = ""                                  */
       ...
       ASSIGN chWSheet:Range(c-alfabet[01] + string(i-linha)):VALUE = blz-sdo_ctbl.cod_ccusto.
       ASSIGN chWSheet:Range(c-alfabet[01] + string(i-linha)):borders({&xlEdgeLeftTopBottomRight}):Weight = {&xlMedium}.

       ASSIGN chWSheet:Range(c-alfabet[02] + string(i-linha)):VALUE = blz-sdo_ctbl.cod_cta_ctbl.
       ASSIGN chWSheet:Range(c-alfabet[02] + string(i-linha)):borders({&xlEdgeLeftTopBottomRight}):Weight = {&xlMedium}.

       ASSIGN chWSheet:Range(c-alfabet[03] + string(i-linha)):VALUE = cta_ctbl.des_tit_ctbl.
       ASSIGN chWSheet:Range(c-alfabet[03] + string(i-linha)):borders({&xlEdgeLeftTopBottomRight}):Weight = {&xlMedium}.
...
RUN pi-inicializar IN h-prog(INPUT "Verificando Justificativas.......").
   ...
   FOR EACH blz-sdo_ctbl NO-LOCK WHERE blz-sdo_ctbl.cod_empresa                                           = tt-param.ttv-empresa
                            ...
                            BREAK BY blz-sdo_ctbl.dat_sdo_ctb
                                  BY blz-sdo_ctbl.cod_empresa + blz-sdo_ctbl.cod_cta_ctbl + blz-sdo_ctbl.cod_ccusto + string(blz-sdo_ctbl.dat_sdo_ctbl):
       
       
       ACCUMULATE (blz-sdo_ctbl.val_sdo_ctbl_db - blz-sdo_ctbl.val_sdo_ctbl_cr) (SUB-TOTAL BY blz-sdo_ctbl.cod_empresa + blz-sdo_ctbl.cod_cta_ctbl + blz-sdo_ctbl.cod_ccusto + string(blz-sdo_ctbl.dat_sdo_ctbl)).
                                    ...
                                    IF last-of(blz-sdo_ctbl.cod_empresa + blz-sdo_ctbl.cod_cta_ctbl + blz-sdo_ctbl.cod_ccusto + string(blz-sdo_ctbl.dat_sdo_ctbl)) THEN DO:
                                        ...
                                        FIND FIRST sdo_orcto_ctbl_bgc NO-LOCK WHERE sdo_orcto_ctbl_bgc.cod_cenar_orctario                = tt-param.ttv-cenar-orctario
                                                                              ...
                                                                              AND   sdo_orcto_ctbl_bgc.cod_cta_ctbl                        = blz-sdo_ctbl.cod_cta_ctbl
...
/*                                 IF LAST-OF(blz-sdo_ctbl.cod_empresa + blz-sdo_ctbl.cod_cta_ctbl + blz-sdo_ctbl.cod_ccusto + string(blz-sdo_ctbl.dat_sdo_ctbl)) THEN DO:  */
                                    ...
                                    ASSIGN v-vlr-realizado = ACCUM SUB-TOTAL BY blz-sdo_ctbl.cod_empresa + blz-sdo_ctbl.cod_cta_ctbl + blz-sdo_ctbl.cod_ccusto + string(blz-sdo_ctbl.dat_sdo_ctbl) (blz-sdo_ctbl.val_sdo_ctbl_db - blz-sdo_ctbl.val_sdo_ctbl_cr).
                                


       FIND FIRST ext_justificativa NO-LOCK WHERE ext_justificativa.Cta_ctbl = blz-sdo_ctbl.cod_cta_ctbl 
                                          ...
                                          AND   ext_justificativa.Cod_demonst   = IF tt-param.ttv-empresa = "BLZ" THEN TRIM(blz-sdo_ctbl.cod_ccusto) ELSE TRIM(blz-sdo_ctbl.cod_ccusto) + "m" 
                                          NO-ERROR.
       ...
       IF AVAIL ext_justificativa THEN DO:
          ...
          ASSIGN chWSheet:Range(c-alfabet[col-ini] + string(i-linha)):VALUE = v-vlr-orcado.
          ASSIGN chWSheet:Range(c-alfabet[col-ini] + string(i-linha)):borders({&xlEdgeLeftTopBottomRight}):Weight = {&xlMedium}.
       ASSIGN col-ini = col-ini + 1.
          ASSIGN chWSheet:Range(c-alfabet[col-ini] + string(i-linha)):VALUE = v-vlr-realizado.
          ASSIGN chWSheet:Range(c-alfabet[col-ini] + string(i-linha)):borders({&xlEdgeLeftTopBottomRight}):Weight = {&xlMedium}.
       ASSIGN col-ini = col-ini + 1.

          ASSIGN chWSheet:Range(c-alfabet[col-ini] + string(i-linha)):VALUE = v-vlr-realizado - v-vlr-orcado.
          ASSIGN chWSheet:Range(c-alfabet[col-ini] + string(i-linha)):borders({&xlEdgeLeftTopBottomRight}):Weight = {&xlMedium}.
       ASSIGN col-ini = col-ini + 1.

          ASSIGN chWSheet:Range(c-alfabet[col-ini] + string(i-linha)):VALUE = ext_justificativa.situacao.
          ASSIGN chWSheet:Range(c-alfabet[col-ini] + string(i-linha)):borders({&xlEdgeLeftTopBottomRight}):Weight = {&xlMedium}.
       ASSIGN col-ini = col-ini + 1.

       ASSIGN chWSheet:Range(c-alfabet[col-ini] + string(i-linha)):VALUE = ext_justificativa.justificativa.
       ASSIGN chWSheet:Range(c-alfabet[col-ini] + string(i-linha)):borders({&xlEdgeLeftTopBottomRight}):Weight = {&xlMedium}.
       ASSIGN col-ini = col-ini + 1.
...
/*       END.                                   */
       ...
       ASSIGN col-ini = col-ini + 1.
          ...
          ASSIGN chWSheet:Range(c-alfabet[col-ini] + string(i-linha)):VALUE = "".
          ASSIGN chWSheet:Range(c-alfabet[col-ini] + string(i-linha)):borders({&xlEdgeLeftTopBottomRight}):Weight = {&xlMedium}.
       ASSIGN col-ini = col-ini + 1.
...
/*        IF LAST-OF(string(sdo_orcto_ctbl_bgc.num_period_ctbl) + sdo_orcto_ctbl_bgc.cod_exerc_ctbl) THEN DO: */
/*                                           */
/*            ASSIGN COL-ini = COL-ini + 1.  */
/*            ASSIGN i-linha =  7.           */
/*        END.                               */
...
/* ======================================================================================================== */
/* ======================================================================================================== */
 RUN pi-inicializar IN h-prog(INPUT " YTD .......").      
       FIND FIRST tt-param NO-ERROR.
...
/*                                                NO-ERROR.                                                                                                       */
       ...
       FOR EACH blz-sdo_ctbl NO-LOCK WHERE blz-sdo_ctbl.cod_empresa                                           = tt-param.ttv-empresa
                                 ...
                                 AND   blz-sdo_ctbl.cod_cenar_ctbl                                           = "fiscal" BREAK BY blz-sdo_ctbl.cod_empresa + blz-sdo_ctbl.cod_cta_ctbl + blz-sdo_ctbl.cod_ccusto:
           ...
           FIND FIRST sdo_orcto_ctbl_bgc NO-LOCK WHERE sdo_orcto_ctbl_bgc.cod_cenar_orctario                = tt-param.ttv-cenar-orctario
                                     ...
                                     ACCUMULATE blz-sdo_ctbl.val_sdo_ctbl_fim (SUB-TOTAL BY blz-sdo_ctbl.cod_empresa + blz-sdo_ctbl.cod_cta_ctbl + blz-sdo_ctbl.cod_ccusto).
                                     ...
                                     IF LAST-OF(blz-sdo_ctbl.cod_empresa + blz-sdo_ctbl.cod_cta_ctbl + blz-sdo_ctbl.cod_ccusto) THEN DO:
                                         ...
                                         ASSIGN  v-vlr-realizado-acum = ACCUM SUB-TOTAL BY blz-sdo_ctbl.cod_empresa + blz-sdo_ctbl.cod_cta_ctbl + blz-sdo_ctbl.cod_ccusto blz-sdo_ctbl.val_sdo_ctbl_fim.

                                         ASSIGN chWSheet:Range(c-alfabet[col-ini] + string(i-linha)):VALUE =  IF AVAIL sdo_orcto_ctbl_bgc THEN  sdo_orcto_ctbl_bgc.val_orcado_sdo ELSE 0.
                                         ASSIGN chWSheet:Range(c-alfabet[col-ini] + string(i-linha)):borders({&xlEdgeLeftTopBottomRight}):Weight = {&xlMedium}.


                                         ASSIGN col-ini = col-ini + 1.
                                         ASSIGN chWSheet:Range(c-alfabet[col-ini] + string(i-linha)):VALUE = v-vlr-realizado-acum.
                                         ASSIGN chWSheet:Range(c-alfabet[col-ini] + string(i-linha)):borders({&xlEdgeLeftTopBottomRight}):Weight = {&xlMedium}.


                                         ASSIGN col-ini = col-ini + 1.

                                         ASSIGN chWSheet:Range(c-alfabet[col-ini] + string(i-linha)):VALUE = (v-vlr-realizado-acum) - (IF AVAIL sdo_orcto_ctbl_bgc THEN  sdo_orcto_ctbl_bgc.val_orcado_sdo ELSE 0).
                                         ASSIGN chWSheet:Range(c-alfabet[col-ini] + string(i-linha)):borders({&xlEdgeLeftTopBottomRight}):Weight = {&xlMedium}.
