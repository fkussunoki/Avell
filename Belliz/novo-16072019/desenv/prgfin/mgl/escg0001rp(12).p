...
PROCEDURE pi-verifica-permissao:
   ...
   FOR EACH demonst_ctbl NO-LOCK WHERE demonst_ctbl.cod_demonst_ctbl >= c-custo-ini
       ...
       FOR EACH usuar_grp_usuar NO-LOCK WHERE usuar_grp_usuar.cod_usuario = v_cod_usuar_corren:
           ...
           IF NOT AVAIL segur_demonst_ctbl THEN
               NExt.
           ELSE DO:
               CREATE tt-permissao.
               ASSIGN tt-permissao.ttv-cod_demonst_ctbl = segur_demonst_ctbl.cod_demonst_ctbl
                      ...
                      tt-permissao.ttv-grp-usuar         = usuar_grp_usuar.cod_grp_usuar.
           END.
