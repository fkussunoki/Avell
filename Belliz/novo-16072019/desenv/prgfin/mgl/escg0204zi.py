...
then do:
    run pi_version_extract ('api_demonst_ctbl_fin':U, 'prgfin/mgl/escg0204zi.py':U, '5.12.16.100':U, 'pro':U).
end /* if */.
...
if  search("prgfin/mgl/escg0204zj.r") = ? and search("prgfin/mgl/escg0204zj.py") = ? then do:
    if  v_cod_dwb_user begins 'es_' then
        return "Programa execut†vel n∆o foi encontrado:" /*l_programa_nao_encontrado*/  + "prgfin/mgl/escg0204zj.py".
    else do:
        message "Programa execut†vel n∆o foi encontrado:" /*l_programa_nao_encontrado*/  "prgfin/mgl/escg0204zj.py"
               view-as alert-box error buttons ok.
        return.
    end.
end.
else
    run prgfin/mgl/escg0204zj.py persistent set v_hdl_demonst_ctbl_1 /*prg_api_demonst_ctbl_fin_1*/.
