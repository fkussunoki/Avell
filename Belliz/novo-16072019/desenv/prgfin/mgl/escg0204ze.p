...
DO:
    ...
    assign v_nom_prog_ext = "prgfin/mgl/escg0204ze.p":U
...
then do:
    run pi_version_extract ('fnc_conjto_prefer_demonst_505_cons':U, 'prgfin/mgl/escg0204ze.p':U, '5.12.16.100':U, 'pro':U).
end /* if */.
