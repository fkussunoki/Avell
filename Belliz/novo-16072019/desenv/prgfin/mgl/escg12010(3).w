...
*******************************************************************************/
{include/i-prgvrs.i ESCG12010 5.12.16.100}
...
DEFINE INPUT PARAM p-realizado       AS DEC FORMAT "->>>,>>>,>>>,>>>.99".
DEFINE INPUT param p-orcado          AS DEC FORMAT "->>>,>>>,>>>,>>>.99".

DEFINE TEMP-TABLE TT-RECEITAS
    FIELD NOMES AS CHAR.
DEF VAR v-vlr-minimo AS DEC FORMAT "->>>,>>>,>>>,>>>,>>>.99".
DEF VAR v-vlr-minimo_neg AS DEC FORMAT "->>>,>>>,>>>,>>>,>>>.99".
...
&Scoped-Define ENABLED-OBJECTS cb-situacao bt-ok bt-cancelar-2 bt-cancelar ~
bt-ajuda RECT-1 RECT-14 RECT-15 RECT-16 
&Scoped-Define DISPLAYED-OBJECTS v-var-perc v-var-reais cb-situacao ~
c-demonst c-coluna d-data-criacao d-dt-altera c-periodo c-rubrica ~
...
DEFINE VARIABLE cb-situacao AS CHARACTER FORMAT "X(256)":U 
     LABEL "Situacao" 
     VIEW-AS COMBO-BOX INNER-LINES 5
     LIST-ITEMS "<Selecione>" 
     DROP-DOWN-LIST
     SIZE 16 BY 1 NO-UNDO.

DEFINE VARIABLE EDITOR-1 AS CHARACTER 
     VIEW-AS EDITOR NO-WORD-WRAP MAX-CHARS 2000 SCROLLBAR-HORIZONTAL SCROLLBAR-VERTICAL
     SIZE 96.29 BY 8.25 NO-UNDO.
...
DEFINE VARIABLE v-var-perc AS DECIMAL FORMAT "->>,>>>,>>>,>>9.99":U INITIAL 0 
     LABEL "Variacao %" 
     VIEW-AS FILL-IN 
     SIZE 14 BY .88
     FGCOLOR 12 FONT 2 NO-UNDO.

DEFINE VARIABLE v-var-reais AS DECIMAL FORMAT "->>,>>>,>>>,>>9.99":U INITIAL 0 
     LABEL "Variacao R$" 
     VIEW-AS FILL-IN 
     SIZE 14 BY .88
     FGCOLOR 12 FONT 2 NO-UNDO.
...
DEFINE FRAME F-Main
     v-var-perc AT ROW 7.75 COL 78.14 COLON-ALIGNED WIDGET-ID 46
     v-var-reais AT ROW 7.75 COL 51.86 COLON-ALIGNED WIDGET-ID 44
     cb-situacao AT ROW 9.04 COL 51.57 COLON-ALIGNED WIDGET-ID 38
     c-demonst AT ROW 1.25 COL 15 COLON-ALIGNED WIDGET-ID 10
     c-coluna AT ROW 1.21 COL 52 COLON-ALIGNED WIDGET-ID 20
     d-data-criacao AT ROW 3.33 COL 15 COLON-ALIGNED WIDGET-ID 18
     d-dt-altera AT ROW 3.33 COL 44.29 WIDGET-ID 4
     c-periodo AT ROW 4.75 COL 15.14 COLON-ALIGNED WIDGET-ID 16
     c-rubrica AT ROW 5.25 COL 51.86 COLON-ALIGNED WIDGET-ID 14
     c-entidade AT ROW 5.33 COL 77.86 COLON-ALIGNED WIDGET-ID 12
     c-exercicio AT ROW 6.25 COL 15.29 COLON-ALIGNED WIDGET-ID 6
     desvio AT ROW 6.54 COL 51.57 COLON-ALIGNED WIDGET-ID 8
     c-usuario AT ROW 7.92 COL 15.29 COLON-ALIGNED WIDGET-ID 22
     EDITOR-1 AT ROW 12.5 COL 4.14 NO-LABEL WIDGET-ID 2
     ...
     desvio-2 AT ROW 6.5 COL 77.86 COLON-ALIGNED WIDGET-ID 34
     "Justificativa" VIEW-AS TEXT
          SIZE 19.14 BY .67 AT ROW 11.04 COL 2.72 WIDGET-ID 40
     "Dados" VIEW-AS TEXT
          SIZE 12.57 BY .67 AT ROW 2.42 COL 2.72 WIDGET-ID 42
     RECT-1 AT ROW 21.17 COL 1.29
     RECT-14 AT ROW 1 COL 1 WIDGET-ID 24
     RECT-15 AT ROW 2.67 COL 1.29 WIDGET-ID 26
     RECT-16 AT ROW 11.33 COL 1.29 WIDGET-ID 28
...
/* SETTINGS FOR EDITOR EDITOR-1 IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN v-var-perc IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN v-var-reais IN FRAME F-Main
   NO-ENABLE                                                            */
...
DO:
    ...
    FIND FIRST demonst_ctbl NO-LOCK WHERE demonst_ctbl.cod_demonst_ctbl = p-demonst NO-ERROR.

    FIND FIRST ext_justificativa     WHERE ext_justificativa.Cta_ctbl =entry(1,p-rubrica, "|")
                                     AND   ext_justificativa.Ccusto = p-entidade
                                     AND   ext_justificativa.Periodo  = p-periodo       
                                     AND   ext_justificativa.Ano      = p-exercicio
                                     AND   ext_justificativa.Cod_demonst = demonst_ctbl.des_tit_ctbl            
...
IF NOT AVAIL ext_justificativa THEN DO:
    ...
    ASSIGN ext_justificativa.Cod_demonst =  INPUT frame f-main c-demonst 
          ...
          ext_justificativa.Cta_ctbl       = input frame f-main c-rubrica         
          ext_justificativa.Ccusto      = input frame f-main c-entidade        
          ext_justificativa.orcado    = input frame f-main desvio
          ext_justificativa.realizado  = INPUT FRAME f-main desvio-2
          ext_justificativa.cod_usuario   = input frame f-main c-usuario         
          ext_justificativa.justificativa    = input frame f-main editor-1
          ext_justificativa.situacao      = cb-situacao:SCREEN-VALUE IN FRAME {&FRAME-NAME}
...
------------------------------------------------------------------------------*/
  DISPLAY v-var-perc v-var-reais cb-situacao c-demonst c-coluna d-data-criacao 
          d-dt-altera c-periodo c-rubrica c-entidade c-exercicio desvio 
          c-usuario EDITOR-1 desvio-2 
      WITH FRAME F-Main IN WINDOW w-window.
  ENABLE cb-situacao bt-ok bt-cancelar-2 bt-cancelar bt-ajuda RECT-1 RECT-14 
         RECT-15 RECT-16 
      WITH FRAME F-Main IN WINDOW w-window.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESCG12010" "5.12.16.100"}
      FOR EACH ext_situacao_orcto NO-LOCK:

       cb-situacao:ADD-LAST(ext_situacao_orcto.descricao) IN FRAME f-main.

       END.

       cb-situacao:SCREEN-VALUE = cb-situacao:ENTRY(1).
 ...
 FIND FIRST demonst_ctbl NO-LOCK WHERE demonst_ctbl.cod_demonst_ctbl = p-demonst NO-ERROR.
  ...
  FIND FIRST ext_justificativa NO-LOCK WHERE ext_justificativa.Cta_ctbl = entry(1, p-rubrica, "|")
                                       AND   ext_justificativa.Ccusto = p-demonst
                                       AND   ext_justificativa.Periodo  = p-periodo       
                                       AND   ext_justificativa.Ano      = p-exercicio
                                       AND   ext_justificativa.Cod_demonst = demonst_ctbl.des_tit_ctbl            
                                       AND   ext_justificativa.Cod_padr_col = p-coluna                
  ...
  IF NOT AVAIL ext_justificativa THEN DO:
     ...
     .
      ...
      ASSIGN c-demonst:SCREEN-VALUE IN FRAME f-main = demonst_ctbl.des_tit_ctbl
             ...
             c-rubrica:SCREEN-VALUE IN FRAME f-main      = entry(1, p-rubrica, "|") 
             c-entidade:SCREEN-VALUE IN FRAME f-main     = p-demonst
             desvio:SCREEN-VALUE IN FRAME f-main         = string(p-orcado)
             desvio-2:SCREEN-VALUE IN FRAME f-main       = string(p-realizado)
             v-var-reais:SCREEN-VALUE IN FRAME f-main    = STRING(p-orcado - p-realizado)
             v-var-perc:SCREEN-VALUE IN FRAME f-main     = STRING((p-orcado - p-realizado) / abs(p-orcado))
             c-usuario:SCREEN-VALUE IN FRAME f-main      = p-usuario
             cb-situacao:SCREEN-VALUE IN FRAME f-main    = "<selecione>".
...
IF AVAIL ext_justificativa THEN DO:
    ...
    ASSIGN c-demonst:SCREEN-VALUE IN FRAME f-main = ext_justificativa.Cod_demonst
           ...
           c-rubrica:SCREEN-VALUE IN FRAME f-main      = ext_justificativa.Cta_ctbl
           c-entidade:SCREEN-VALUE IN FRAME f-main     = ext_justificativa.Ccusto
           desvio:SCREEN-VALUE IN FRAME f-main         = string(p-orcado)
           c-usuario:SCREEN-VALUE IN FRAME f-main      = p-usuario
           desvio-2:SCREEN-VALUE IN FRAME f-main       = string(p-realizado)
           v-var-reais:SCREEN-VALUE IN FRAME f-main    = STRING(p-orcado - p-realizado)
           v-var-perc:SCREEN-VALUE IN FRAME f-main     = STRING(((p-orcado - p-realizado) / abs(p-orcado) * 100))
           EDITOR-1:SCREEN-VALUE IN FRAME F-MAIN       = ext_justificativa.justificativa
           cb-situacao:SCREEN-VALUE IN FRAME f-main    = ext_justificativa.situacao.
...
/*        THEN DO:                                              */
      IF  ((p-realizado - p-orcado) <= v-vlr-minimo 
      AND    (p-realizado - p-orcado) >= v-vlr-minimo_neg) THEN DO:
