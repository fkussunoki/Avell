...
*******************************************************************************/
{include/i-prgvrs.i escg1201 5.12.16.100}
...
DEFINE VARIABLE h_vwrmgla1201 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 92 BY 15.33 WIDGET-ID 100.
...
ON END-ERROR OF w-cadsim /* Manuten‡Æo Limites */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadsim w-cadsim
ON WINDOW-CLOSE OF w-cadsim /* Manuten‡Æo Limites */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'prgfin/mgl/escgvwr/v01escg1201.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_vwrmgla1201 ).
       RUN set-position IN h_vwrmgla1201 ( 3.00 , 2.43 ) NO-ERROR.
       ...
       RUN set-position IN h_qrymgla1201 ( 1.50 , 56.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'State':U , h_p-exihel ).

       /* Links to SmartViewer h_vwrmgla1201. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_vwrmgla1201 ).
       RUN add-link IN adm-broker-hdl ( h_qrymgla1201 , 'Record':U , h_vwrmgla1201 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadsim , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_vwrmgla1201 ,
             h_p-exihel , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "escg1201" "5.12.16.100"}
