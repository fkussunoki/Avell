...
def var c-versao-prg as char initial " 5.12.16.106":U no-undo.
def var c-versao-rcode as char initial "[[[5.12.16.106[[[":U no-undo. /* Controle de Versao R-CODE - Nao retirar do Fonte */
...
DO:
    ...
    assign v_nom_prog     = substring(current-window:title, 1, max(1, length(current-window:title) - 10))
           ...
           v_cod_release  = trim(" 5.12.16.106":U).
