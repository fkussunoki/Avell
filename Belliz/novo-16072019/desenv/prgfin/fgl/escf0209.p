...
** Nome Externo..........: prgfin/fgl/ESCF0209.p
...
&endif
    ...
    assign bt_exi:private-data                       in frame f_bas_10_ccusto_razao = "HLP=000004665":U
           ...
           ccusto.cod_ccusto:private-data            in frame f_bas_10_ccusto_razao = "HLP=000006624":U
           ccusto.des_tit_ctbl:private-data          in frame f_bas_10_ccusto_razao = "HLP=000025191":U
...
DO:
    ...
    assign v_cod_format_1 = input frame f_bas_10_ccusto_razao ccusto.cod_ccusto no-error.
...
DO:
    ...
    assign v_nom_prog     = substring(current-window:title, 1, max(1, length(current-window:title) - 10))
                          + chr(10)
                          + "bas_ccusto_razao":U
           v_nom_prog_ext = "prgfin/fgl/ESCF0209.p":U
...
then do:
    run pi_version_extract ('bas_ccusto_razao':U, 'prgfin/fgl/ESCF0209.p':U, '1.00.00.001':U, 'pro':U).
end /* if */.
    ...
    then do:
        ...
        then do:
            ...
            then do:
                ...
                and Verifica_Program_Name('ESCF0209':U,10)) then  
                    run pi_criar_ccusto_usuar (Input v_cod_usuar_corren) /*pi_criar_ccusto_usuar*/.
            end /* if */.
        end /* if */.
...
PROCEDURE pi_criar_item_lancto_ctbl_ccusto:
    ...
    for
        ...
        for
            ...
            and   item_lancto_ctbl.cod_plano_ccusto = ccusto.cod_plano_ccusto
...
PROCEDURE pi_busca_ccusto_mgl204:
    ...
    if Verifica_Program_Name('mgl204aa':U,30) then
        find ccusto no-lock where recid(ccusto) = v_rec_ccusto_aux no-error.
