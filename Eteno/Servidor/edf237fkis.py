...
PROCEDURE pi_retorna_cod_barra_leitora:
    ...
    &else
        find emsbas.histor_exec_especial no-lock
        ...
        */
        ...
        then do:        
            ...
            assign v_cod_det = caps('A' + '0' + string(v_cod_ocor_bcia,'99') + string(v_cod_campo_ctro,'999') + string(int(v_cod_sist_nac_bcio_fav),'999') +
                                   ...
                                   fill('0',23) + fill(' ',40) + fill(' ',2) +  '00005CC' + fill(' ',14)).
        ...
        then do:
            ...
            if avail ocor_bcia_bco then do:
                ...
                FIND FIRST emsbas.empresa WHERE emsbas.empresa.cod_empresa = v_cod_empres_usuar NO-ERROR.

                FIND FIRST emsbas.estabelecimento WHERE emsbas.estabelecimento.cod_empresa = emsbas.empresa.cod_empresa NO-ERROR.
            ...
            assign v_cod_det = caps('J' + string(v_ind_tip_instruc,'x(1)') + string(v_cod_ocor_bcia,'x(2)') + string(v_cod_barra,'x(44)') +
                                    ...
                                    '237' + string(v_num_bloco,'9999') + '3' + string(v_num_reg_bloco,'99999') + 'J' + ' ' + string(v_cod_ocor_bcia,'x(2)') + '52' + string('2') +
                                     string(dec(emsbas.estabelecimento.cod_id_feder),'99999999999999') + string(emsbas.estabelecimento.nom_pessoa, 'x(40)') + string(v_num_tip_id_feder,'9') +  string(dec(v_cod_id_feder_favorec),'99999999999999') +
                                     string(v_nom_favorec,'x(40)') + fill(" ", 111) + CHR(10).
