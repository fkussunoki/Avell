...
DEFINE VARIABLE docto-fim AS CHARACTER FORMAT "X(16)":U INITIAL "zzzzzzzz" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE docto-ini AS CHARACTER FORMAT "X(16)":U 
     LABEL "Documento" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.
...
DEFINE VARIABLE esp-docto-fim AS CHARACTER FORMAT "X(3)":U INITIAL "zzz" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE esp-docto-ini AS CHARACTER FORMAT "X(3)":U 
     LABEL "Especie Docto" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE estab-fim AS CHARACTER FORMAT "X(3)":U INITIAL "zzzzzzzz" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE estab-ini AS CHARACTER FORMAT "X(3)":U 
     LABEL "Estabelecimento" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE nom-abrev-fim AS CHARACTER FORMAT "X(30)":U INITIAL "zzzzzzzz" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE nom-abrev-ini AS CHARACTER FORMAT "X(30)":U 
     LABEL "Nome Abreviado" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE ser-docto-fim AS CHARACTER FORMAT "X(3)":U INITIAL "zzz" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE ser-docto-ini AS CHARACTER FORMAT "X(3)":U 
     LABEL "Serie" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     estab-ini AT ROW 2.17 COL 18.14 COLON-ALIGNED
     estab-fim AT ROW 2.17 COL 51.57 COLON-ALIGNED NO-LABEL
     dt-ini AT ROW 3.67 COL 18.14 COLON-ALIGNED WIDGET-ID 4
     dt-fim AT ROW 3.67 COL 51.86 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     esp-docto-ini AT ROW 5.08 COL 18.14 COLON-ALIGNED WIDGET-ID 46
     esp-docto-fim AT ROW 5.08 COL 51.29 COLON-ALIGNED NO-LABEL WIDGET-ID 44
     ser-docto-ini AT ROW 6.42 COL 18.14 COLON-ALIGNED WIDGET-ID 70
     ser-docto-fim AT ROW 6.42 COL 51.57 COLON-ALIGNED NO-LABEL WIDGET-ID 68
     docto-ini AT ROW 7.83 COL 18.14 COLON-ALIGNED WIDGET-ID 54
     docto-fim AT ROW 7.83 COL 51.57 COLON-ALIGNED NO-LABEL WIDGET-ID 52
     nom-abrev-ini AT ROW 9.42 COL 18.14 COLON-ALIGNED WIDGET-ID 62
     nom-abrev-fim AT ROW 9.42 COL 51.43 COLON-ALIGNED NO-LABEL WIDGET-ID 60
     IMAGE-1 AT ROW 2.25 COL 35.86
     IMAGE-2 AT ROW 2.17 COL 50.72
     IMAGE-3 AT ROW 3.58 COL 50.43 WIDGET-ID 6
     IMAGE-5 AT ROW 3.63 COL 35.86 WIDGET-ID 16
     IMAGE-6 AT ROW 5.08 COL 35.86 WIDGET-ID 48
     IMAGE-7 AT ROW 5.08 COL 50.43 WIDGET-ID 50
     IMAGE-8 AT ROW 7.92 COL 35.86 WIDGET-ID 56
     IMAGE-9 AT ROW 7.83 COL 50.72 WIDGET-ID 58
     IMAGE-10 AT ROW 9.5 COL 35.86 WIDGET-ID 64
     IMAGE-11 AT ROW 9.42 COL 50.57 WIDGET-ID 66
     IMAGE-12 AT ROW 6.58 COL 35.86 WIDGET-ID 72
     IMAGE-13 AT ROW 6.42 COL 50.72 WIDGET-ID 74
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
{utp/ut9000.i "ESPACR001" "1.00.00.001"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY estab-ini estab-fim dt-ini dt-fim esp-docto-ini esp-docto-fim 
          ser-docto-ini ser-docto-fim docto-ini docto-fim nom-abrev-ini 
          nom-abrev-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-5 IMAGE-6 IMAGE-7 IMAGE-8 IMAGE-9 
         IMAGE-10 IMAGE-11 IMAGE-12 IMAGE-13 estab-ini estab-fim dt-ini dt-fim 
         esp-docto-ini esp-docto-fim ser-docto-ini ser-docto-fim docto-ini 
         docto-fim nom-abrev-ini nom-abrev-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.dt-ini       = date(dt-ini:SCREEN-VALUE IN FRAME f-pg-sel)
           tt-param.dt-fim       = date(dt-fim:SCREEN-VALUE IN FRAME f-pg-sel)
           tt-param.estab-ini     = estab-ini:SCREEN-VALUE IN FRAME f-pg-sel
           tt-param.estab-fim     = estab-fim:SCREEN-VALUE IN FRAME f-pg-sel
           tt-param.esp-docto-ini  = esp-docto-ini:SCREEN-VALUE IN FRAME f-pg-sel
           tt-param.esp-docto-fim  = esp-docto-fim:SCREEN-VALUE IN FRAME f-pg-sel
           tt-param.docto-ini      = docto-ini:SCREEN-VALUE IN FRAME f-pg-sel
           tt-param.docto-fim       = docto-fim:SCREEN-VALUE IN FRAME f-pg-sel
           tt-param.nome-abrev-ini = nom-abrev-ini:SCREEN-VALUE IN FRAME f-pg-sel
           tt-param.nome-abrev-fim = nom-abrev-fim:SCREEN-VALUE IN FRAME f-pg-sel 
           tt-param.ser-docto-ini  = ser-docto-ini:SCREEN-VALUE IN FRAME f-pg-sel
           tt-param.ser-docto-fim  = ser-docto-fim:SCREEN-VALUE IN FRAME f-pg-sel
.           
    ...
    {include/i-rprun.i prgfin/acr/espacr001rp.p}
