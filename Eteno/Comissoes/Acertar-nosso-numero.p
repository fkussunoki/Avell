...
FOR EACH movto_ocor_bcia NO-LOCK WHERE movto_ocor_bcia.dat_movto_ocor_bcia = 05/12/2020
                                 AND   movto_ocor_bcia.ind_tip_ocor_bcia  = "Altera‡Æo de outros dados"
                                 :


    FIND FIRST tit_acr WHERE tit_acr.cod_estab =       movto_ocor_bcia.cod_estab
                       AND   tit_acr.num_id_tit_acr   = movto_ocor_bcia.num_id_tit_acr NO-ERROR.
    ...
    ASSIGN tt_alter_tit_acr_base_5.tta_cod_estab                              = tit_acr.cod_estab
           ...
           tt_alter_tit_acr_base_5.tta_dat_transacao                          = 05/12/2020   
           ...
           tt_alter_tit_acr_base_5.tta_cod_tit_acr_bco                        = movto_ocor_bcia.cod_tit_acr_bco
...
/*     END.                                                                                                                 */
    ...
    OUTPUT TO c:\desenv\alteracao.txt.

    FOR EACH  tt_alter_tit_acr_base_5:

        EXPORT tt_alter_tit_acr_base_5 EXCEPT ttv_wgh_lista.
    END.
