...
DO:
    ...
    run utp/ut-dir.p (input "Diretorio Oráamento Excel",
                     output pasta-entrada,
                     output l-entrada).

    ASSIGN c-dir-entrada:SCREEN-VALUE IN FRAME f-pg-sel = pasta-entrada.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-10 bt-dir-entrada c-dir-entrada 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           /*Fim alteracao 14/02/2005*/
            tt-param.diretorio-entrada  = INPUT FRAME f-pg-sel c-dir-entrada.
    ...
    {include/i-rprun.i esp\escc999rp.p}
