...
/*                                                                                                           */
    ...
    FIND FIRST ped-venda NO-LOCK WHERE ped-venda.nome-abrev  = it-nota-fisc.nome-ab-cli
        ...
        ASSIGN tt-faturamento.ttv-cod-estabel               = it-nota-fisc.cod-estabel
               ...
               tt-faturamento.ttv-concatena                 = IF AVAIL ped-venda THEN ped-venda.cod-estabel ELSE it-nota-fisc.cod-estabel /* + string(item.fm-codigo) */ + it-nota-fisc.cod-estabel.
