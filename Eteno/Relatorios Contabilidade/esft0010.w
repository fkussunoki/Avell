...
*******************************************************************************/
{include/i-prgvrs.i ESFT0010 1.00.00.000 } /*** 010033 ***/
...
ON END-ERROR OF c-win /* Faturamento por CFOP */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL c-win c-win
ON WINDOW-CLOSE OF c-win /* Faturamento por CFOP */
DO:
...
{utp/ut9000.i "ESFT0010" "1.00.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY dt-fim dt-ini 
      WITH FRAME f-pg-sel IN WINDOW c-win.
  ENABLE IMAGE-27 IMAGE-28 dt-fim dt-ini 
      WITH FRAME f-pg-sel IN WINDOW c-win.
...
/*                                                                                                                                */
    ...
    if  session:set-wait-state("general") then.
     ...
     {include/i-rprun.i esp/esft0010rp.p}
