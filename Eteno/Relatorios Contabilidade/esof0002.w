...
DEFINE FRAME f-pg-sel
     ...
     dt-emiss-ini AT ROW 3.54 COL 18.57 COLON-ALIGNED WIDGET-ID 40
     dt-emiss-fim AT ROW 3.54 COL 52 COLON-ALIGNED NO-LABEL WIDGET-ID 38
     rs-tipo AT ROW 7.83 COL 27.86 NO-LABEL WIDGET-ID 42
     IMAGE-1 AT ROW 2.17 COL 35.29
     IMAGE-2 AT ROW 2.17 COL 50.72
     IMAGE-10 AT ROW 3.46 COL 50.57 WIDGET-ID 34
     IMAGE-11 AT ROW 3.5 COL 35.72 WIDGET-ID 36
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY cod-estab-ini cod-estab-fim dt-emiss-ini dt-emiss-fim rs-tipo 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-10 IMAGE-11 cod-estab-ini cod-estab-fim 
         dt-emiss-ini dt-emiss-fim rs-tipo 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esp/esof0001rp.p}
