...
*******************************************************************************/
{include/i-prgvrs.i espfas 1.00.00.003}
...
DEFINE VARIABLE cb-box AS CHARACTER FORMAT "X(256)":U INITIAL "corrente" 
     LABEL "Tipo" 
     VIEW-AS COMBO-BOX INNER-LINES 5
     LIST-ITEMS "Faturamento","Compras","Resumo","Listagem por Natureza" 
     DROP-DOWN-LIST
...
DEFINE VARIABLE c-estab-fim AS CHARACTER FORMAT "X(5)":U INITIAL "zzzzzzzzzzzzz" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     c-estab-ini AT ROW 2.17 COL 18.43 COLON-ALIGNED
     c-estab-fim AT ROW 2.17 COL 51.57 COLON-ALIGNED NO-LABEL
     c-dt-ini AT ROW 3.58 COL 18.14 COLON-ALIGNED WIDGET-ID 28
     c-dt-fim AT ROW 3.58 COL 51.72 COLON-ALIGNED NO-LABEL WIDGET-ID 26
     cb-box AT ROW 5.46 COL 51.14 COLON-ALIGNED WIDGET-ID 38
     IMAGE-1 AT ROW 2.17 COL 35.29
     IMAGE-2 AT ROW 2.17 COL 50.72
     IMAGE-8 AT ROW 3.5 COL 50.43 WIDGET-ID 30
     IMAGE-9 AT ROW 3.54 COL 35.43 WIDGET-ID 32
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-estab-ini c-estab-fim c-dt-ini c-dt-fim cb-box 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-8 IMAGE-9 c-estab-ini c-estab-fim c-dt-ini 
         c-dt-fim cb-box 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.ttv-estab-ini     = INPUT FRAME f-pg-sel c-estab-ini
           tt-param.ttv-estab-fim     = INPUT FRAME f-pg-sel c-estab-fim
           tt-param.ttv-dt-ini        = INPUT FRAME f-pg-sel c-dt-ini
           tt-param.ttv-dt-fim        = INPUT FRAME f-pg-sel c-dt-fim
           tt-param.ttv-tipo          = INPUT FRAME f-pg-sel cb-box.
