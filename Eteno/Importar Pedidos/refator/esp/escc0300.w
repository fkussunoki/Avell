...
c-planilha bt-dir-entrada BUTTON-12 BUTTON-13 BROWSE-2 
&Scoped-Define DISPLAYED-OBJECTS c-planilha FILL-IN-4 FILL-IN-5 FILL-IN-6 
...
DEFINE FRAME f-cad
     ...
     BUTTON-12 AT ROW 2.75 COL 3 WIDGET-ID 64
     BUTTON-13 AT ROW 2.75 COL 8.29 WIDGET-ID 66
     ...
     "Legenda" VIEW-AS TEXT
          SIZE 10.29 BY .67 AT ROW 18.67 COL 3.29 WIDGET-ID 42
...
/* SETTINGS FOR FRAME f-cad
   FRAME-NAME L-To-R                                                    */
/* BROWSE-TAB BROWSE-2 BUTTON-13 f-cad */
...
DO:
IF tt-planilha.ttv-it-codigo = "Nao encontrado" THEN DO:
    ASSIGN 
...
END.
IF tt-planilha.ttv-nr-pedido = "" THEN DO:
    ASSIGN 
...
DO:
   EMPTY TEMP-TABLE tt-planilha.
       ASSIGN bt-importar:SENSITIVE IN FRAME {&FRAME-NAME} = NO
              bt-importar:label in frame {&frame-name} = "Aguarde..."
              bt-executar:sensitive in frame {&frame-name} = no.
...
{office/office.i Excel chExcel}
   ...
   Repeat:
       ...
       assign tt-planilha.ttv-tp-venda            = chWorkSheet:cells(i-linha, 1):Text
              ...
              tt-planilha.ttv-icms                = dec(chWorkSheet:cells(i-linha, 21):text).
   ...
   RUN pi-finalizar IN h-prog. 
        ...
        ASSIGN bt-importar:SENSITIVE IN FRAME {&FRAME-NAME} = YES
               bt-importar:label in frame {&frame-name} = "Importar Planilha"
               bt-executar:sensitive in frame {&frame-name} = yes.
