...
DEFINE VARIABLE c-cod-estab AS CHARACTER FORMAT "X(3)":U INITIAL "MTZ" 
     LABEL "Estabelecimento" 
     VIEW-AS FILL-IN 
     SIZE 15.57 BY .88 NO-UNDO.

DEFINE VARIABLE c-dir-entrada AS CHARACTER FORMAT "X(256)":U 
     LABEL "Pasta Pedidos" 
     VIEW-AS FILL-IN 
     SIZE 34.86 BY .88 NO-UNDO.

DEFINE VARIABLE i-coluna AS INTEGER FORMAT "->,>>>,>>9":U INITIAL 8 
     LABEL "Coluna Inicial" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE i-linha AS INTEGER FORMAT "->,>>>,>>9":U INITIAL 10 
     LABEL "Linha Inicial" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     c-cod-estab AT ROW 1.42 COL 20.29 COLON-ALIGNED WIDGET-ID 34
     i-linha AT ROW 2.58 COL 20.72 COLON-ALIGNED
     i-coluna AT ROW 3.75 COL 20.86 COLON-ALIGNED WIDGET-ID 4
     bt-dir-entrada AT ROW 8.29 COL 58.29 HELP
          "Escolha do nome do arquivo" WIDGET-ID 24
     c-dir-entrada AT ROW 8.33 COL 21.29 COLON-ALIGNED WIDGET-ID 20
     RECT-10 AT ROW 7.08 COL 1.57 WIDGET-ID 32
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL bt-dir-entrada w-relat
ON CHOOSE OF bt-dir-entrada IN FRAME f-pg-sel
DO:
 
    def var c-arquivo-conv  as char no-undo.
    DEF VAR l-ok            AS LOGICAL NO-UNDO.

    assign c-arquivo-conv = replace(input frame f-pg-sel c-dir-entrada, "/", "~\").
    ...
    SYSTEM-DIALOG GET-FILE c-arquivo-conv
       ...
       UPDATE l-ok.
    if  l-ok = yes then do:
        assign c-dir-entrada = replace(c-arquivo-conv, "~\", "/").
        display c-dir-entrada with frame f-pg-sel.
    end.
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-cod-estab i-linha i-coluna c-dir-entrada 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE RECT-10 c-cod-estab i-linha i-coluna bt-dir-entrada c-dir-entrada 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.linha-inicial     = INPUT FRAME f-pg-sel i-linha
           tt-param.coluna-inicial    = INPUT FRAME f-pg-sel i-coluna
           tt-param.dir-arquivo       = INPUT FRAME f-pg-sel c-dir-entrada
           tt-param.cod-estab         = INPUT FRAME f-pg-sel c-cod-estab.
    ...
    {include/i-rprun.i esp\escc0300rp.p}
