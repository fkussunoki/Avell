...
*******************************************************************************/
{include/i-prgvrs.i ESCD1510 1.00.00.000 } /*** 010033 ***/



&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i ESCd1510 CDP}
&ENDIF
...
DEFINE VAR c-natureza AS char NO-UNDO.
...
DEFINE VARIABLE c-natur AS CHARACTER FORMAT "X(256)":U 
     LABEL "Natureza" 
     VIEW-AS FILL-IN 
     SIZE 46 BY .88
     FONT 10 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     BUTTON-1 AT ROW 5.75 COL 65.72 WIDGET-ID 28
     c-natur AT ROW 5.88 COL 17.57 COLON-ALIGNED WIDGET-ID 26
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
         SIZE 76.5 BY 10.5.
...
/* SETTINGS FOR FRAME f-pg-sel
                                                                        */
/* SETTINGS FOR FILL-IN c-natur IN FRAME f-pg-sel
   NO-ENABLE                                                            */
...
ON END-ERROR OF c-win /* Simples Nacional */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL c-win c-win
ON WINDOW-CLOSE OF c-win /* Simples Nacional */
DO:
...
DO:
  ...
  ASSIGN c-natur:SCREEN-VALUE IN FRAME {&FRAME-NAME} = v_cod_natur.
END.
...
{utp/ut9000.i "ESCD1510" "1.00.00.000"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    {include/i-rpmbl.i im-pg-sel}
        ...
        ASSIGN c-natur:SCREEN-VALUE IN FRAME f-pg-sel = "510BRT,510BDT,510BDO,510BTO,6101TO,610BTO".
        v_cod_natur = "510BRT,510BDT,510BDO,510BTO,6101TO,610BTO".
...
/*                                                                                                                                */
    ...
    assign tt-param.usuario     = v_cod_usuar_corren
           ...
           tt-param.natur-oper  = INPUT FRAME f-pg-sel c-natur.
    ...
    if  session:set-wait-state("general") then.
     ...
     {include/i-rprun.i esp/escd1510rp.p}
