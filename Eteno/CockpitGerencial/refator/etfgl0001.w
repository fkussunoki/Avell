...
&Scoped-define QUERY-STRING-BROWSE-2 FOR EACH ext_roteiro_fechamento USE-INDEX sequencia     WHERE ext_roteiro_fechamento.periodo = INPUT FRAME {&FRAME-NAME} c-periodo     AND   ext_roteiro_fechamento.setor = INPUT FRAME {&FRAME-NAME} c-setor
&Scoped-define OPEN-QUERY-BROWSE-2 OPEN QUERY {&SELF-NAME} FOR EACH ext_roteiro_fechamento USE-INDEX sequencia     WHERE ext_roteiro_fechamento.periodo = INPUT FRAME {&FRAME-NAME} c-periodo     AND   ext_roteiro_fechamento.setor = INPUT FRAME {&FRAME-NAME} c-setor.
...
&Scoped-Define ENABLED-OBJECTS rt-button BUTTON-9 BUTTON-10 BUTTON-12 ~
BUTTON-13 BUTTON-16 BUTTON-15 c-setor c-periodo BROWSE-2 
&Scoped-Define DISPLAYED-OBJECTS c-setor c-periodo 
...
DEFINE BUTTON BUTTON-16 
     ...
     LABEL "Button 16" 
     SIZE 5.72 BY 1.13 TOOLTIP "Novo Setor".
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-2 w-livre _FREEFORM
  QUERY BROWSE-2 NO-LOCK DISPLAY
      ext_roteiro_fechamento.setor FORMAT "x(20)":U COLUMN-LABEL 'SETOR'
      ...
      ext_roteiro_fechamento.semana-1 COLUMN-LABEL "SMN-1" FORMAT "yes/no":U
          ...
          ext_roteiro_fechamento.usuario-1 FORMAT "x(8)":U COLUMN-LABEL 'USER'
          ...
          ext_roteiro_fechamento.semana-2 COLUMN-LABEL "SMN-2" FORMAT "yes/no":U
                WIDTH 6.29 VIEW-AS TOGGLE-BOX
              ext_roteiro_fechamento.usuario-2 FORMAT "x(8)":U COLUMN-LABEL 'USER'
          ...
          ext_roteiro_fechamento.semana-3 COLUMN-LABEL "SMN-3" FORMAT "yes/no":U
                WIDTH 6.29 VIEW-AS TOGGLE-BOX
              ext_roteiro_fechamento.usuario-3 FORMAT "x(8)":U COLUMN-LABEL 'USER'
          ...
          ext_roteiro_fechamento.semana-4 COLUMN-LABEL "SMN-4" FORMAT "yes/no":U
                WIDTH 6.29 VIEW-AS TOGGLE-BOX
              ext_roteiro_fechamento.usuario-4 FORMAT "x(8)":U COLUMN-LABEL 'USER'
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 177.72 BY 24.38
...
DEFINE FRAME f-cad
     BUTTON-9 AT ROW 1.17 COL 71.57 WIDGET-ID 8
     BUTTON-10 AT ROW 1.17 COL 77.86 WIDGET-ID 16
     BUTTON-12 AT ROW 1.17 COL 83.86 WIDGET-ID 14
     BUTTON-13 AT ROW 1.17 COL 90.14 WIDGET-ID 18
     BUTTON-16 AT ROW 1.21 COL 2 WIDGET-ID 22
     ...
     BROWSE-2 AT ROW 2.96 COL 3.57 WIDGET-ID 200
     rt-button AT ROW 1 COL 1
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 182.01 BY 29.63 WIDGET-ID 100.
...
/* SETTINGS FOR FRAME f-cad
   FRAME-NAME L-To-R                                                    */
/* BROWSE-TAB BROWSE-2 c-periodo f-cad */
...
ON CHOOSE OF BUTTON-16 IN FRAME f-cad /* Button 16 */
DO:
  RUN esp\etfgl0000e.w.
  run pi-preencher-combo.
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-exihel ).
       RUN set-position IN h_p-exihel ( 1.13 , 166.29 ) NO-ERROR.
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             BUTTON-9:HANDLE IN FRAME f-cad , 'BEFORE':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  DISPLAY c-setor c-periodo 
      WITH FRAME f-cad IN WINDOW w-livre.
  ENABLE rt-button BUTTON-9 BUTTON-10 BUTTON-12 BUTTON-13 BUTTON-16 BUTTON-15 
         c-setor c-periodo BROWSE-2 
      WITH FRAME f-cad IN WINDOW w-livre.
...
procedure pi-preencher-combo:

  FOR EACH ext_setor_fechamento break by ext_setor_fechamento.cod_setor:


    if c-setor:lookup(ext_setor_fechamento.cod_setor) in frame {&frame-name} = 0 then  
       

      c-setor:ADD-LAST(ext_setor_fechamento.cod_setor, ext_setor_fechamento.cod_setor) in frame {&frame-name}.
  END.
