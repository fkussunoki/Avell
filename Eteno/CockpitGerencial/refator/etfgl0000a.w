  ...
  IF NOT AVAIL ext_roteiro_fechamento THEN DO:
      ...
      IF l-logico THEN DO:
                ...
                ASSIGN c-programa:SCREEN-VALUE IN FRAME {&FRAME-NAME} = ""
                       ...
                       c-setor:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "".
      END.
...
------------------------------------------------------------------------------*/
  DISPLAY c-programa c-nom-programa c-rotina c-periodo c-setor 
...
------------------------------------------------------------------------------*/
  ...
  FOR EACH ext_setor_fechamento NO-LOCK:
