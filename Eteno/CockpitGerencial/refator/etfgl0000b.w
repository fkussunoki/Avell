...
DEFINE VARIABLE c-periodo AS CHARACTER FORMAT "X(256)":U 
     ...
     LIST-ITEMS "Mensal","Semanal", "Trimestral"
     DROP-DOWN-LIST
...
------------------------------------------------------------------------------*/
  DISPLAY c-programa c-rotina c-periodo c-setor 
      WITH FRAME f-cad IN WINDOW w-livre.
  ENABLE rt-button RECT-5 BUTTON-11 c-rotina c-periodo c-setor 
      WITH FRAME f-cad IN WINDOW w-livre.
...
------------------------------------------------------------------------------*/
  ...
  FOR EACH ext_setor_fechamento:
      c-setor:ADD-LAST(ext_setor_fechamento.cod_setor, ext_setor_fechamento.cod_setor).
  END.
