...
DEFINE INPUT param p-fechamento AS ROWID.
...
&Scoped-Define ENABLED-OBJECTS rt-button RECT-5 BUTTON-11 c-rotina ~
c-periodo c-setor c-modulo 
&Scoped-Define DISPLAYED-OBJECTS c-programa c-rotina c-periodo c-setor ~
c-modulo 
...
DEFINE FRAME f-cad
     ...
     c-setor AT ROW 8.29 COL 15.29 COLON-ALIGNED WIDGET-ID 28
     c-modulo AT ROW 8.29 COL 40.29 COLON-ALIGNED WIDGET-ID 30
...
/* SETTINGS FOR FRAME f-cad
   L-To-R                                                               */
/* SETTINGS FOR FILL-IN c-programa IN FRAME f-cad
   NO-ENABLE                                                            */
...
DO:
  ...
  ASSIGN ext_roteiro_fechamento.rotina = INPUT FRAME {&FRAME-NAME} c-rotina
...
------------------------------------------------------------------------------*/
  DISPLAY c-programa c-rotina c-periodo c-setor c-modulo 
      WITH FRAME f-cad IN WINDOW w-livre.
  ENABLE rt-button RECT-5 BUTTON-11 c-rotina c-periodo c-setor c-modulo 
      WITH FRAME f-cad IN WINDOW w-livre.
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute AFTER standard behavior.    */
  FIND FIRST ext_roteiro_fechamento WHERE ROWID(ext_roteiro_fechamento) = p-fechamento NO-ERROR.

  IF AVAIL ext_roteiro_fechamento THEN DO:
      
      ASSIGN c-programa:SCREEN-VALUE IN FRAME {&FRAME-NAME} = ext_roteiro_fechamento.programa
             c-rotina:SCREEN-VALUE IN FRAME {&FRAME-NAME} = ext_roteiro_fechamento.rotina
             c-periodo:SCREEN-VALUE IN FRAME {&FRAME-NAME} = ext_roteiro_fechamento.periodicidade
             c-setor:SCREEN-VALUE IN FRAME {&FRAME-NAME} = ext_roteiro_fechamento.setor
             c-modulo:SCREEN-VALUE IN FRAME {&FRAME-NAME} = ext_roteiro_fechamento.responsavel.
