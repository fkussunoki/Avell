...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-2 w-livre _FREEFORM
  QUERY BROWSE-2 NO-LOCK DISPLAY
      ...
      ext_roteiro_fechamento.rotina FORMAT "x(50)":U WIDTH 25  COLUMN-LABEL "ROTINA"
      ext_roteiro_fechamento.semana-1 COLUMN-LABEL "SMN-1" FORMAT "yes/no":U
            WIDTH 8 VIEW-AS TOGGLE-BOX
          ext_roteiro_fechamento.usuario-1 FORMAT "x(8)":U COLUMN-LABEL "USUAR" 
          ext_roteiro_fechamento.date1 FORMAT "99/99/9999":U COLUMN-LABEL "DT" 
      

      ext_roteiro_fechamento.semana-2 COLUMN-LABEL "SMN-2" FORMAT "yes/no":U
            WIDTH 8 VIEW-AS TOGGLE-BOX
          ext_roteiro_fechamento.usuario-2 FORMAT "x(8)":U  COLUMN-LABEL "USUAR" 
          ext_roteiro_fechamento.data2 FORMAT "99/99/9999":U  COLUMN-LABEL "DT" 
      
          
          
      ext_roteiro_fechamento.semana-3 COLUMN-LABEL "SMN-3" FORMAT "yes/no":U
            WIDTH 8 VIEW-AS TOGGLE-BOX
          ext_roteiro_fechamento.usuario-3 FORMAT "x(8)":U  COLUMN-LABEL "USUAR" 
          ext_roteiro_fechamento.data3 FORMAT "99/99/9999":U  COLUMN-LABEL "DT" 
      
          
          
      ext_roteiro_fechamento.semana-4 COLUMN-LABEL "SMN-4" FORMAT "yes/no":U
            WIDTH 8 VIEW-AS TOGGLE-BOX
      ext_roteiro_fechamento.usuario-4 FORMAT "x(8)":U  COLUMN-LABEL "USUAR" 
      ext_roteiro_fechamento.data4 FORMAT "99/99/9999":U   COLUMN-LABEL "DT" 
//  ENABLE
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
