...
&Scoped-define FIELDS-IN-QUERY-BROWSE-2 ext_roteiro_fechamento.responsavel ext_roteiro_fechamento.programa ext_roteiro_fechamento.rotina ext_roteiro_fechamento.semana-1 ext_roteiro_fechamento.usuario-1 ext_roteiro_fechamento.date1 ext_roteiro_fechamento.semana-2 ext_roteiro_fechamento.usuario-2 ext_roteiro_fechamento.data2 ext_roteiro_fechamento.semana-3 ext_roteiro_fechamento.usuario-3 ext_roteiro_fechamento.data3 ext_roteiro_fechamento.semana-4 ext_roteiro_fechamento.usuario-4 ext_roteiro_fechamento.data4 //   
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-2   
&Scoped-define SELF-NAME BROWSE-2
&Scoped-define QUERY-STRING-BROWSE-2 FOR EACH ext_roteiro_fechamento USE-INDEX sequencia     WHERE ext_roteiro_fechamento.periodo = INPUT FRAME {&FRAME-NAME} c-periodo     AND   ext_roteiro_fechamento.responsavel >= INPUT FRAME {&FRAME-NAME} c-modul-ini     AND   ext_roteiro_fechamento.responsavel <= INPUT FRAME {&FRAME-NAME} c-modul-fim
...
&Scoped-Define ENABLED-OBJECTS rt-button RECT-6 RECT-7 BUTTON-15 BUTTON-9 ~
BUTTON-10 BUTTON-12 BUTTON-13 c-periodo BUTTON-16 c-modul-fim c-modul-ini ~
BROWSE-2 
&Scoped-Define DISPLAYED-OBJECTS c-periodo c-modul-fim c-modul-ini 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-2 w-livre _FREEFORM
  QUERY BROWSE-2 NO-LOCK DISPLAY
      ext_roteiro_fechamento.responsavel FORMAT "X(20)":U LABEL "SETOR"
      ext_roteiro_fechamento.programa FORMAT "x(20)":U COLUMN-LABEL "PROGRAMA"
      ext_roteiro_fechamento.rotina FORMAT "x(50)":U WIDTH 39.43  COLUMN-LABEL "ROTINA"
      ext_roteiro_fechamento.semana-1 COLUMN-LABEL "SEMANA-1" FORMAT "yes/no":U
            WIDTH 8 VIEW-AS TOGGLE-BOX
          ext_roteiro_fechamento.usuario-1 FORMAT "x(8)":U COLUMN-LABEL "USUARIO" 
          ext_roteiro_fechamento.date1 FORMAT "99/99/9999":U COLUMN-LABEL "DATA" 
      

      ext_roteiro_fechamento.semana-2 COLUMN-LABEL "SEMANA-2" FORMAT "yes/no":U
            WIDTH 8 VIEW-AS TOGGLE-BOX
          ext_roteiro_fechamento.usuario-2 FORMAT "x(8)":U  COLUMN-LABEL "USUARIO" 
          ext_roteiro_fechamento.data2 FORMAT "99/99/9999":U  COLUMN-LABEL "DATA" 
      
          
          
      ext_roteiro_fechamento.semana-3 COLUMN-LABEL "SEMANA-3" FORMAT "yes/no":U
            WIDTH 8 VIEW-AS TOGGLE-BOX
          ext_roteiro_fechamento.usuario-3 FORMAT "x(8)":U  COLUMN-LABEL "USUARIO" 
          ext_roteiro_fechamento.data3 FORMAT "99/99/9999":U  COLUMN-LABEL "DATA" 
      
          
          
      ext_roteiro_fechamento.semana-4 COLUMN-LABEL "SEMANA-4" FORMAT "yes/no":U
            WIDTH 8 VIEW-AS TOGGLE-BOX
      ext_roteiro_fechamento.usuario-4 FORMAT "x(8)":U  COLUMN-LABEL "USUARIO" 
      ext_roteiro_fechamento.data4 FORMAT "99/99/9999":U   COLUMN-LABEL "DATA" 
//  ENABLE
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 154 BY 22.17
...
DEFINE FRAME f-cad
     BUTTON-15 AT ROW 1.17 COL 27.57 WIDGET-ID 10
     BUTTON-9 AT ROW 1.17 COL 78.72 WIDGET-ID 8
     BUTTON-10 AT ROW 1.17 COL 84 WIDGET-ID 16
     BUTTON-12 AT ROW 1.17 COL 90.29 WIDGET-ID 14
     BUTTON-13 AT ROW 1.21 COL 70.86 WIDGET-ID 18
     c-periodo AT ROW 1.25 COL 11 COLON-ALIGNED WIDGET-ID 6
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-exihel ).
       RUN set-position IN h_p-exihel ( 1.08 , 141.86 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  DISPLAY c-periodo c-modul-fim c-modul-ini 
      WITH FRAME f-cad IN WINDOW w-livre.
  ENABLE rt-button RECT-6 RECT-7 BUTTON-15 BUTTON-9 BUTTON-10 BUTTON-12 
         BUTTON-13 c-periodo BUTTON-16 c-modul-fim c-modul-ini BROWSE-2 
      WITH FRAME f-cad IN WINDOW w-livre.
...
DEFINE VAR l-semana-1 AS logical.
DEFINE VAR l-semana-2 AS logical.
DEFINE VAR l-semana-3 AS logical.
DEFINE VAR l-semana-4 AS logical.
DEFINE VAR v-usuar-1  AS CHAR.
DEFINE VAR v-usuar-2  AS CHAR.
DEFINE VAR v-usuar-3  AS CHAR.
DEFINE VAR v-usuar-4  AS CHAR.
DEFINE VAR d-alt-1    AS DATE.
DEFINE VAR d-alt-2    AS DATE.
DEFINE VAR d-alt-3    AS DATE.
DEFINE VAR d-alt-4    AS DATE.
...
IF l-data-1 = NO THEN
    ASSIGN v-usuar-1  = b-fech.usuario-1
           d-alt-1    = b-fech.date1
           l-semana-1 = b-fech.semana-1.
           
    ELSE
    ASSIGN v-usuar-1  = c-usuar-1
           d-alt-1    = d-alteracao-1
           l-semana-1 = l-data-1.

IF l-data-2 = NO THEN
    ASSIGN v-usuar-2  = b-fech.usuario-2
           d-alt-2    = b-fech.data2
           l-semana-2 = b-fech.semana-2.

    ELSE
    ASSIGN v-usuar-2  = c-usuar-2
           d-alt-2    = d-alteracao-2
           l-semana-2 = l-data-2.

IF l-data-3 = NO THEN
    ASSIGN v-usuar-3  = b-fech.usuario-3
           d-alt-3    = b-fech.data3
           l-semana-3 = b-fech.semana-3.

    ELSE
    ASSIGN v-usuar-3  = c-usuar-3
           d-alt-3    = d-alteracao-3
           l-semana-3 = l-data-3.

IF l-data-4 = NO THEN
    ASSIGN v-usuar-4  = b-fech.usuario-4
           d-alt-4    = b-fech.data4
           l-semana-4 = b-fech.semana-4.

    ELSE
    ASSIGN v-usuar-4  = c-usuar-4
           d-alt-4    = d-alteracao-4
           l-semana-4 = l-data-4.

ASSIGN b-fech.semana-1 =  l-semana-1
       b-fech.semana-2  = l-semana-2
       b-fech.semana-3  = l-semana-3
       b-fech.semana-4  = l-semana-4
       b-fech.usuario-1 = v-usuar-1
       b-fech.usuario-2 = v-usuar-2
       b-fech.usuario-3 = v-usuar-3
       b-fech.usuario-4 = v-usuar-4
       b-fech.date1     = d-alt-1
       b-fech.data2     = d-alt-2
       b-fech.data3     = d-alt-3
       b-fech.data4     = d-alt-4.
