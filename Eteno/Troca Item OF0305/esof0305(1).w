...
DO i = 1 TO NUM-ENTRIES(INPUT FRAME {&FRAME-NAME} c-natureza):
    ...
    FOR EACH nota-fiscal NO-LOCK WHERE nota-fiscal.cod-estabel >= INPUT FRAME {&FRAME-NAME} c-estab-ini
                              AND      nota-fiscal.cod-estabel <= INPUT FRAME {&FRAME-NAME} c-estab-fim
                              AND      nota-fiscal.dt-emis-nota >= INPUT FRAME {&FRAME-NAME} c-dt-ini
                              AND      nota-fiscal.dt-emis-nota <= INPUT FRAME {&FRAME-NAME} c-dt-fim
                              AND      nota-fiscal.nat-operacao = trim(ENTRY(i, INPUT FRAME {&FRAME-NAME} c-natureza)),
         EACH it-nota-fisc NO-LOCK OF nota-fiscal.
       RUN pi-acompanhar IN h-prog (INPUT "Nat.Op " + nota-fiscal.nat-operacao + " Dt.Emiss " + string(nota-fiscal.dt-emis-nota)).
