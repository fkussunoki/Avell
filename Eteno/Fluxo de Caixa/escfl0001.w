...
DEFINE VARIABLE c-estab AS CHARACTER FORMAT "X(3)":U INITIAL "MTZ" 
     LABEL "Estabelecimento" 
     VIEW-AS FILL-IN 
     SIZE 14 BY 1 NO-UNDO.

DEFINE VARIABLE c-num-fluxo AS INTEGER FORMAT "->,>>>,>>9":U INITIAL 0 
     LABEL "Num Fluxo" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME f-pg-sel
     c-num-fluxo AT ROW 2.58 COL 23.57 COLON-ALIGNED WIDGET-ID 34
     c-estab AT ROW 4.17 COL 23.57 COLON-ALIGNED WIDGET-ID 36
...
/* SETTINGS FOR FRAME f-pg-sel
                                                                        */
/* SETTINGS FOR FILL-IN c-dir-entrada IN FRAME f-pg-sel
   NO-ENABLE                                                            */
...
{utp/ut9000.i "ESCFL0001" "1.00.00.003"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-num-fluxo c-estab c-dir-entrada 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE RECT-10 c-num-fluxo c-estab bt-dir-entrada 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.ttv-estab         = input frame f-pg-sel c-estab
           tt-param.ttv-cod-fluxo     = input frame f-pg-sel c-num-fluxo.
    ...
    {include/i-rprun.i esp\escfl0001rp.p}
