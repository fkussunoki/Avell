...
*******************************************************************************/
{include/i-prgvrs.i esof0540RP 2.00.00.034 } /*** 010034 ***/

&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i esof0540rp MOF}
&ENDIF
...
def new shared var l-esof0540x          as logical                                                          NO-UNDO.
...
DEF new shared var h-esof0540e AS handle                                                                    NO-UNDO.
...
{ofp/esof0540.i99} /* atualizacao da versao do programa */
...
run ofp/esof0540e.p persistent set h-esof0540e. 
