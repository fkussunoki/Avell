...
def temp-table tt_alter_tit_acr_base_5 no-undo
    ...
    field ttv_ind_motiv_acerto_val         as character format "X(12)" initial "Altera¯Êo" label "Motivo Acerto Valor" column-label "Motivo Acerto Valor"
    ...
    field tta_dat_emis_docto               as date format "99/99/9999" initial today label "Data  EmissÊo" column-label "Dt EmissÊo"
    field tta_dat_vencto_tit_acr           as date format "99/99/9999" initial ? label "Vencimento" column-label "Vencimento"
    field tta_dat_prev_liquidac            as date format "99/99/9999" initial ? label "Prev Liquida¯Êo" column-label "Prev Liquida¯Êo"
    field tta_dat_fluxo_tit_acr            as date format "99/99/9999" initial ? label "Fluxo" column-label "Fluxo"
    field tta_ind_sit_tit_acr              as character format "X(13)" initial "Normal" label "Situa¯Êo Tðtulo" column-label "Situa¯Êo Tðtulo"
    field tta_cod_cond_cobr                as character format "x(8)" label "Condi¯Êo Cobran¯a" column-label "Cond Cobran¯a"
    field tta_log_tip_cr_perda_dedut_tit   as logical format "Sim/NÊo" initial no label "Credito com Garantia" column-label "Cred Garant"
    ...
    field tta_log_tit_acr_destndo          as logical format "Sim/NÊo" initial no label "Destinado" column-label "Destinado"
    field tta_cod_histor_padr              as character format "x(8)" label "Hist«rico PadrÊo" column-label "Hist«rico PadrÊo"
    ...
    field ttv_cod_cond_pagto_vendor        as character format "x(3)" initial "0" label "Condi¯Êo Pagto" column-label "Condi¯Êo Pagto"
    ...
    field ttv_log_assume_tax_bco           as logical format "Sim/NÊo" initial no label "Assume Taxa Banco" column-label "Assume Taxa Banco"
    field ttv_log_vendor                   as logical format "Sim/NÊo" initial no
    ...
    field tta_log_retenc_impto_impl        as logical format "Sim/NÊo" initial no label "Ret Imposto Impl" column-label "Ret Imposto Impl"
    field tta_cdn_repres                   as Integer format ">>>,>>9" initial 0 label "Representante" column-label "Representante"
    field tta_cod_proces_export            as character format "x(12)" label "Processo Exporta¯Êo" column-label "Processo Exporta¯Êo"
    field ttv_log_estorn_impto_retid       as logical format "Sim/NÊo" initial yes
...
def temp-table tt_alter_tit_acr_cheq no-undo
    ...
    field tta_dat_emis_cheq                as date format "99/99/9999" initial ? label "Data EmissÊo" column-label "Dt Emiss"
    field tta_dat_prev_apres_cheq_acr      as date format "99/99/9999" initial ? label "PrevisÊo Apresent" column-label "PrevisÊo Apresent"
    field tta_dat_prev_cr_cheq_acr         as date format "99/99/9999" initial ? label "PrevisÊo Crýdito" column-label "PrevisÊo Crýdito"
    ...
    field tta_log_cheq_terc                as logical format "Sim/NÊo" initial no label "Cheque Terceiro" column-label "Cheque Terceiro"
...
def temp-table tt_alter_tit_acr_comis_1 no-undo
    ...
    field tta_num_id_tit_acr               as integer format "999999999" initial 0 label "Token Cta Receber" column-label "Token Cta Receber"
    field ttv_num_tip_operac               as integer format ">9" column-label "Tipo  Opera¯Êo"
    field tta_cdn_repres                   as Integer format ">>>,>>9" initial 0 label "Representante" column-label "Representante"
    field tta_val_perc_comis_repres        as decimal format ">>9.9999" decimals 4 initial 0 label "% ComissÊo" column-label "% ComissÊo"
    field tta_val_perc_comis_repres_emis   as decimal format ">>9.99" decimals 2 initial 0 label "% Comis EmissÊo" column-label "% Comis EmissÊo"
    ...
    field tta_log_comis_repres_proporc     as logical format "Sim/NÊo" initial no label "Comis Proporcional" column-label "Comis Propor"
    field tta_ind_tip_comis                as character format "X(15)" initial "Valor Bruto" label "Tipo ComissÊo" column-label "Tipo ComissÊo"
    field ttv_ind_tip_comis_ext            as character format "X(15)" initial "Nenhum" label "Tipo de ComissÊo" column-label "Tipo de ComissÊo"
...
def temp-table tt_alter_tit_acr_rateio no-undo
    ...
    field tta_log_impto_val_agreg          as logical format "Sim/NÊo" initial no label "Impto Val Agreg" column-label "Imp Vl Agr"
    field tta_cod_pais                     as character format "x(3)" label "Paðs" column-label "Paðs"
    field tta_cod_unid_federac             as character format "x(3)" label "Unidade Federa¯Êo" column-label "UF"
    field tta_cod_imposto                  as character format "x(5)" label "Imposto" column-label "Imposto"
    field tta_cod_classif_impto            as character format "x(05)" initial "00000" label "Class Imposto" column-label "Class Imposto"
...
def temp-table tt_alter_tit_acr_rat_desp_rec no-undo
    ...
    field tta_ind_tip_aprop_recta_despes   as character format "x(20)" label "Tipo Apropria¯Êo" column-label "Tipo Apropria¯Êo"
    field tta_num_id_tit_acr               as integer format "999999999" initial 0 label "Token Cta Receber" column-label "Token Cta Receber"
    field tta_num_id_aprop_despes_recta    as integer format "9999999999" initial 0 label "Id Apropria¯Êo" column-label "Id Apropria¯Êo"
    field tta_cod_tip_fluxo_financ         as character format "x(12)" label "Tipo Fluxo Financ" column-label "Tipo Fluxo Financ"
...
def temp-table tt_integr_acr_liquidac_lote no-undo
    ...
    field tta_cod_cart_bcia                as character format "x(3)" label "Carteira" column-label "Carteira"
    field tta_dat_transacao                as date format "99/99/9999" initial today label "Data Transa¯Êo" column-label "Dat Transac"
    field tta_dat_gerac_lote_liquidac      as date format "99/99/9999" initial ? label "Data Gera¯Êo" column-label "Data Gera¯Êo"
    ...
    field tta_ind_sit_lote_liquidac_acr    as character format "X(15)" initial "Em Digita¯Êo" label "Situa¯Êo" column-label "Situa¯Êo"
    ...
    field tta_log_enctro_cta               as logical format "Sim/NÊo" initial no label "Encontro de Contas" column-label "Encontro de Contas"
    field tta_cod_livre_1                  as character format "x(100)" label "Livre 1" column-label "Livre 1"
    field tta_dat_livre_1                  as date format "99/99/9999" initial ? label "Livre 1" column-label "Livre 1"
    field tta_log_livre_1                  as logical format "Sim/NÊo" initial no label "Livre 1" column-label "Livre 1"
    ...
    field tta_log_livre_2                  as logical format "Sim/NÊo" initial no label "Livre 2" column-label "Livre 2"
    ...
    field ttv_log_atualiz_refer            as logical format "Sim/NÊo" initial no
    field ttv_log_gera_lote_parcial        as logical format "Sim/NÊo" initial no
    field ttv_log_verific_reg_perda_dedut  as logical format "Sim/NÊo" initial no
...
def temp-table tt_integr_acr_liq_item_lote_3 no-undo
    ...
    field tta_num_seq_refer                as integer format ">>>9" initial 0 label "Sequ¬ncia" column-label "Seq"
    field tta_cod_tit_acr                  as character format "x(10)" label "Tðtulo" column-label "Tðtulo"
    ...
    field tta_dat_cr_liquidac_tit_acr      as date format "99/99/9999" initial ? label "Data Crýdito" column-label "Data Crýdito"
    field tta_dat_cr_liquidac_calc         as date format "99/99/9999" initial ? label "Cred Calculada" column-label "Cred Calculada"
    field tta_dat_liquidac_tit_acr         as date format "99/99/9999" initial ? label "Liquida¯Êo" column-label "Liquida¯Êo"
    field tta_cod_autoriz_bco              as character format "x(8)" label "Autoriza¯Êo Bco" column-label "Autorizacao Bco"
    field tta_val_tit_acr                  as decimal format ">>>,>>>,>>9.99" decimals 2 initial 0 label "Valor" column-label "Valor"
    field tta_val_liquidac_tit_acr         as decimal format ">>>,>>>,>>9.99" decimals 2 initial 0 label "Vl Liquida¯Êo" column-label "Vl Liquida¯Êo"
    field tta_val_desc_tit_acr             as decimal format ">>>>,>>>,>>9.99" decimals 2 initial 0 label "Vl Desc" column-label "Vl Desc"
    field tta_val_abat_tit_acr             as decimal format ">>>>,>>>,>>9.99" decimals 2 initial 0 label "Vl Abatimento" column-label "Vl Abatimento"
    field tta_val_despes_bcia              as decimal format "->>>,>>>,>>9.99" decimals 2 initial 0 label "Vl Desp Banc" column-label "Vl Desp Banc"
    ...
    field tta_log_gera_antecip             as logical format "Sim/NÊo" initial no label "Gera Antecipacao" column-label "Gera Antecipacao"
    field tta_des_text_histor              as character format "x(2000)" label "Hist«rico" column-label "Hist«rico"
    field tta_ind_sit_item_lote_liquidac   as character format "X(09)" initial "Gerado" label "Situa¯Êo Item Lote" column-label "Situa¯Êo Item Lote"
    field tta_log_gera_avdeb               as logical format "Sim/NÊo" initial no label "Gera Aviso Dýbito" column-label "Gera Aviso Dýbito"
    field tta_cod_indic_econ_avdeb         as character format "x(8)" label "Moeda Aviso Dýbito" column-label "Moeda Aviso Dýbito"
    ...
    field tta_val_avdeb                    as decimal format "->>>,>>>,>>9.99" decimals 2 initial 0 label "Aviso Dýbito" column-label "Aviso Dýbito"
    field tta_log_movto_comis_estordo      as logical format "Sim/NÊo" initial no label "Estorna ComissÊo" column-label "Estorna ComissÊo"
    ...
    field tta_num_livre_1                  as integer format ">>>>>9" initial 0 label "Livre 1" column-label "Livre 1"
    field tta_num_livre_2                  as integer format ">>>>>9" initial 0 label "Livre 2" column-label "Livre 2"
    field tta_val_cotac_indic_econ         as decimal format ">>>>,>>9.9999999999" decimals 10 initial 0 label "Cota¯Êo" column-label "Cota¯Êo"
    ...
    field tta_log_retenc_impto_liq         as logical format "Sim/NÊo" initial no label "Retým na Liquida¯Êo" column-label "Ret na Liq"
    ...
    field ttv_log_gera_retenc_impto_ant    as logical format "Sim/NÊo" initial YES
    index tt_rec_index                    
...
def temp-table tt_integr_acr_abat_prev no-undo
    ...
    field tta_log_zero_sdo_prev            as logical format "Sim/NÊo" initial no label "Zera Saldo" column-label "Zera Saldo"
    index tt_id                            is primary unique
          ttv_rec_item_lote_impl_tit_acr   ascending
          tta_cod_estab                    ascending
          tta_cod_estab_ext                ascending
...
def temp-table tt_integr_acr_cheq no-undo
    ...
    field tta_dat_prev_depos_cheq_acr      as date format "99/99/9999" initial ? label "PrevisÊo Dep«sito" column-label "PrevisÊo Dep«sito"
    ...
    field tta_cod_estab_ext                as character format "x(8)" label "Estabelecimento Exte" column-label "Estabelecimento Ext"
    field tta_cod_id_feder                 as character format "x(20)" initial ? label "ID Federal" column-label "ID Federal"
    field tta_cod_motiv_devol_cheq         as character format "x(5)" label "Motivo Devolu¯Êo" column-label "Motivo Devolu¯Êo"
    field tta_cod_indic_econ               as character format "x(8)" label "Moeda" column-label "Moeda"
    field tta_cod_finalid_econ_ext         as character format "x(8)" label "Finalid Econ Externa" column-label "Finalidade Externa"
    field tta_cod_usuar_cheq_acr_terc      as character format "x(12)" label "Usu˜rio" column-label "Usu˜rio"
    field tta_log_pend_cheq_acr            as logical format "Sim/NÊo" initial no label "Cheque Pendente" column-label "Cheque Pendente"
    field tta_log_cheq_terc                as logical format "Sim/NÊo" initial no label "Cheque Terceiro" column-label "Cheque Terceiro"
    field tta_log_cheq_acr_renegoc         as logical format "Sim/NÊo" initial no label "Cheque Reneg" column-label "Cheque Reneg"
    field tta_log_cheq_acr_devolv          as logical format "Sim/NÊo" initial no label "Cheque Devolvido" column-label "Cheque Devolvido"
...
def temp-table tt_integr_acr_liquidac_impto_2 no-undo
    ...
    field tta_val_retid_indic_tit_acr      as decimal format ">>>,>>>,>>9.99" decimals 2 initial 0 label "Vl Retido IE Tðtulo" column-label "Vl Retido IE Tðtulo"
    ...
    field tta_dat_cotac_indic_econ         as date format "99/99/9999" initial ? label "Data Cota¯Êo" column-label "Data Cota¯Êo"
    field tta_val_cotac_indic_econ         as decimal format ">>>>,>>9.9999999999" decimals 10 initial 0 label "Cota¯Êo" column-label "Cota¯Êo"
...
def temp-table tt_integr_acr_aprop_liq_antec no-undo
    ...
    field tta_cod_unid_negoc               as character format "x(3)" label "Unid Neg«cio" column-label "Un Neg"
    field tta_cod_tip_fluxo_financ         as character format "x(12)" label "Tipo Fluxo Financ" column-label "Tipo Fluxo Financ"
    field tta_cod_unid_negoc_tit           as character format "x(3)" label "Unid Negoc Tðtulo" column-label "Unid Negoc Tðtulo"
...
def temp-table tt_log_erros_import_liquidac no-undo
    ...
    field ttv_num_erro_log                 as integer format ">>>>,>>9" label "Nßmero Erro" column-label "Nßmero Erro"
    field ttv_des_msg_erro                 as character format "x(60)" label "Mensagem Erro" column-label "Inconsist¬ncia"
    index tt_sequencia                    
          tta_num_seq                      ascending
    .
