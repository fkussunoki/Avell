...
DEFINE FRAME f-pg-sel
     cod-emitente-ini AT ROW 2.17 COL 18.43 COLON-ALIGNED
     cod-emitente-fim AT ROW 2.17 COL 51.57 COLON-ALIGNED NO-LABEL
...
ON END-ERROR OF w-relat /* Analise de Credito */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Analise de Credito */
DO:
...
{utp/ut9000.i "esutb0001" "1.00.00.003"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY cod-emitente-ini cod-emitente-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 cod-emitente-ini cod-emitente-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esp/esutb0001rp.p}
