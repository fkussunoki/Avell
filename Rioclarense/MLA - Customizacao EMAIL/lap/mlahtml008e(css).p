...
if not can-find(funcao where
    ...
    ASSIGN tt-html.html-doc = tt-html.html-doc +
        ...
        IF l-alt THEN
           ASSIGN tt-html.html-doc = tt-html.html-doc +
        '        <th align="center" class="linhaForm" nowrap><a href="#alt" class="aBrowser">Alteracoes</a></th>' .
        ...
        */
        ...
        for each  ordem-compra 
            ...
            '            </td> ' +
            '            <td class="linhaForm" align="right" nowrap> ' +
            '             <a href="#cotacao' + STRING(ordem-compra.numero-ordem) + '" class="aBrowser">Detalhes da Cota»cao</a>' +
            '            </td>' +  
            '          </tr> ' +
            '         <tr><td height="5"></td></tr> ' +
            '        </table> ' +
            ...
            '         </td> ' +
            '         <th align="right" class="linhaForm" nowrap>Situa»cao:</th> ' +
            '         <td class="linhaForm" align="right" nowrap> ' +
            ...
            '         </td> ' +
            '         <th align="right" class="linhaForm" nowrap>Data Cota»cao:</th> ' +
            '         <td class="linhaForm" align="right" nowrap> ' +
