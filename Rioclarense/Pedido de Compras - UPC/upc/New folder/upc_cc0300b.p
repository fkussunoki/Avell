...
DEF NEW GLOBAL SHARED VAR v_lotacao       AS char.
                ...
                IF h_frame:TYPE = "frame" THEN DO:
                    ...
                    do  while valid-handle(h-objeto3):
                         ...
                         IF  h-objeto3:TYPE <> "field-group" and
                             ...
                             ON 'LEAVE':U OF H_DT-VENCIM PERSISTENT RUN UPC\upcc300b4.p.
                             ...
                             IF h-objeto3:NAME = "cod-comprado" THEN DO:
                                ...
                                ASSIGN H_cod-comprado = H-OBJETO3.
...
if  (p-ind-event = "AFTER-INITIALIZE" 
    ...
    do  while valid-handle(h_frame):
                ...
                IF h_frame:TYPE = "frame" THEN DO:
                    ...
                    do  while valid-handle(h-objeto3):
                         ...
                         IF  h-objeto3:TYPE <> "field-group" and
                             ...
                             ON 'LEAVE':U OF H_DT-VENCIM PERSISTENT RUN UPC\upcc300b.p.
        ...
        if  h_frame:name = "it-codigo" then do:
                ...
                ON 'MOUSE-SELECT-DBLCLICK':U OF h_dt-vencim PERSISTENT RUN inzoom\z01in015.w.
