...
IF AVAIL ext-item-mat THEN DO:
    RUN upc\upcc0300b7.p.
    
    
    CASE ext-item-mat.l-rateio:
        WHEN YES THEN DO:
            IF v_cod_ccusto BEGINS "10" THEN do:

            ASSIGN h_ct-codigo:SCREEN-VALUE = ext-item-mat.ct-codigo-adm
                   h_sc-codigo1:SENSITIVE   = NO
                  
                   h_sc-codigo1:SCREEN-VALUE = v_cod_ccusto.
            end.
            
            IF v_cod_ccusto BEGINS "20" THEN do:
        ...
        END.
            ...
            IF v_cod_ccusto BEGINS "30" THEN do:
...
.            
            ...
            ASSIGN H_sc-codigo1:SCREEN-VALUE = v_cod_ccusto.
        END.
