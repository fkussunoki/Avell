...
IF SUBSTRING(mla-tipo-doc-aprov.char-1,1,1) = "Y" OR  
   SUBSTRING(mla-tipo-doc-aprov.char-1,2,1) = "Y" THEN DO: /* Se tipo de documento est† parametrizado para enviar notificaá∆o na 
                                                              aprovaá∆o(SUBSTRING(mla-tipo-doc-aprov.char-1,1,1) = "Y") OU
                                                              reprovaá∆o(SUBSTRING(mla-tipo-doc-aprov.char-1,2,1) = "Y") */ 
  

    IF SUBSTRING(mla-tipo-doc-aprov.char-1,i-sequencia-substring,1) = "Y" THEN /* Envia notificaá∆o para usu†rio da transaá∆o*/
    ...
    ASSIGN tt-html.html-doc = tt-html.html-doc +           
           ...
           '      <td align="center" class="linhaBrowseImpar">Transaá∆o</td>' +
           '      <td align="center" class="linhaBrowseImpar">' + mla-doc-pend-aprov.cod-usuar-trans + ' - ' + usuar_mestre.nom_usuario + '</td>' +
           '   </tr>'.
    

    IF SUBSTRING(mla-tipo-doc-aprov.char-1,i-sequencia-substring + 1,1) = "Y" THEN  /* Envia notificaá∆o para uru†rio do documento*/
        ASSIGN c-checked = "checked".
    ELSE 
        ASSIGN c-checked = "".
    ...
    IF SUBSTRING(mla-tipo-doc-aprov.char-1,i-sequencia-substring + 2,1) = "Y" THEN DO: /* Envia notificaá∆o para todos aprovadores envolvidos */
