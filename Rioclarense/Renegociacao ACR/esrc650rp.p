...
RUN utp/ut-perc.p PERSISTENT SET h-prog.
        ...
        IF AVAIL portad_edi THEN DO:
            ...
            CASE tt-titulos.ttv-estab:
                ...
                WHEN '101' THEN
                    ASSIGN v_cod_nosso_numero = entry(1, portad_edi.des_tip_var_portad_edi, CHR(10)) + '1' + tit_Acr.cod_tit_acr  + c-parcela + STRING(v_serie).
                WHEN '102' THEN
                    ASSIGN v_cod_nosso_numero = entry(1, portad_edi.des_tip_var_portad_edi, CHR(10)) + '2' + tit_Acr.cod_tit_acr  + c-parcela + STRING(v_serie).

                WHEN '103' THEN
                    ASSIGN v_cod_nosso_numero = entry(1, portad_edi.des_tip_var_portad_edi, CHR(10)) + '3' + tit_Acr.cod_tit_acr  + c-parcela + STRING(v_serie).
                WHEN '104' THEN
                    ASSIGN v_cod_nosso_numero = entry(1, portad_edi.des_tip_var_portad_edi, CHR(10)) + '4' + tit_Acr.cod_tit_acr  + c-parcela + STRING(v_serie).
                WHEN '301' THEN
                    ASSIGN v_cod_nosso_numero = entry(1, portad_edi.des_tip_var_portad_edi, CHR(10)) + '5' + tit_Acr.cod_tit_acr  + c-parcela + STRING(v_serie).
                WHEN '401' THEN
                    ASSIGN v_cod_nosso_numero = entry(1, portad_edi.des_tip_var_portad_edi, CHR(10)) + '6' + tit_Acr.cod_tit_acr  + c-parcela + STRING(v_serie).
                OTHERWISE
                    ASSIGN v_cod_nosso_numero = entry(1, portad_edi.des_tip_var_portad_edi, CHR(10)) + '7' + tit_Acr.cod_tit_acr  + c-parcela + STRING(v_serie).
...
.
    ...
    for each tt-comissoes no-lock:
                ...
                ASSIGN tt_integr_acr_repres_pend.ttv_rec_item_lote_impl_tit_acr     = tt_integr_acr_item_lote_impl_9.ttv_rec_item_lote_impl_tit_acr 
                       tt_integr_acr_repres_pend.tta_cdn_repres                     = tt-comissoes.ttv-cnd-repres
                       tt_integr_acr_repres_pend.tta_val_perc_comis_repres          = tt-comissoes.ttv-vlr-liq
...
OUTPUT TO value(SESSION:TEMP-DIRECTORY + "detail.txt") NO-CONVERT.
...
OUTPUT TO value(SESSION:TEMP-DIRECTORY + "FINAL.txt") NO-CONVERT.
...
define var i as logical initial false.
    ...
    FIND last  tit_Acr WHERE tit_acr.cod_estab              = tt-titulos.ttv-estab
                       ...
                       AND   tit_Acr.cod_tit_acr            = tt-titulos.ttv-titulo
                       and   tit_Acr.ind_orig_tit_acr       = "ACREMS50"            
                       NO-ERROR.
