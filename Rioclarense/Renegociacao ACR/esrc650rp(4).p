...
RUN utp/ut-perc.p PERSISTENT SET h-prog.
        ...
        IF AVAIL portad_edi THEN DO:
            ...
            ASSIGN v_cod_nosso_numero = entry(1, portad_edi.des_tip_var_portad_edi, CHR(10)) + SUBSTRING(tit_Acr.cod_estab, 1, 1) + SUBSTRING(tit_Acr.cod_estab, 3, 1) + tit_Acr.cod_tit_acr  + SUBSTRING(tt-titulos.ttv-parcela, 2, 1).
