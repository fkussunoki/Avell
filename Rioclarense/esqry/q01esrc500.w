...
&Scoped-define QUERY-STRING-Query-Main FOR EACH ext-conta-ft NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH ext-conta-ft NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main ext-conta-ft
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main ext-conta-ft
