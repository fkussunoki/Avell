...
ON END-ERROR OF w-relat /* ICMS Faturamento */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* ICMS Faturamento */
DO:
...
{utp/ut9000.i "OFRC0002" "1.00.00.001"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-cenario c-cenario-2 c-dt-corte-ini c-dt-corte-fim c-ct-icms 
...
.    
    ...
    {include/i-rprun.i ofp/ofrc0002rp.p}
