...
EMPTY TEMP-TABLE tt_cancelamento_estorno_apb_1.
 ...
 FIND FIRST tit_ap NO-LOCK WHERE tit_ap.cod_tit_ap = tt-titulos.ttv_cod_tit_ap
                          ...
                          AND   tit_ap.cod_ser_docto  = tt-titulos.ttv_serie NO-ERROR.

 RUN pi-acompanhar IN h-prog (INPUT "Titulos " + tt-titulos.ttv_cod_tit_ap).
FIND FIRST movto_tit_ap NO-LOCK WHERE movto_tit_ap.cod_empresa = tit_ap.cod_empresa
...
ASSIGN tt_cancelamento_estorno_apb_1.ttv_ind_niv_operac_apb             = "Título"
