...
DEFINE VARIABLE c-cpf AS CHARACTER FORMAT "9(11)":U 
     LABEL "CPF" 
     VIEW-AS FILL-IN 
...
------------------------------------------------------------------------------*/
  ...
  FIND FIRST fornec_financ NO-LOCK WHERE recid(fornec_financ) = v_rec_fornec_financ NO-ERROR.
    ...
    ASSIGN c-banco:SCREEN-VALUE IN FRAME {&FRAME-NAME} = cta_corren_fornec.cod_banco
           ...
           l-poupanca:CHECKED IN FRAME {&FRAME-NAME} = IF (SUBSTRING(cta_corren_fornec.cod_livre_2, 100,3) = '' OR SUBSTRING(cta_corren_fornec.cod_livre_2, 100,3) = ? OR SUBSTRING(cta_corren_fornec.cod_livre_2, 103,2) = 'no') THEN NO ELSE logical(substring(cta_corren_fornec.cod_livre_2, 100, 3))
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
FIND FIRST fornec_financ WHERE recid(fornec_financ)= v_rec_fornec_financ 
                                 AND   fornec_financ.cod_empresa = v_cod_empres_usuar NO-ERROR.
    ...
    IF avail cta_corren_fornec THEN DO:
        ...
        ASSIGN cta_corren_fornec.cod_empresa = v_cod_empres_usuar
               ...
               substring(cta_corren_fornec.cod_livre_2, 89, 11) = c-cpf:SCREEN-VALUE IN FRAME {&FRAME-NAME}.
        ...
        THEN
            ...
            ELSE
            SUBSTRING(cta_corren_fornec.cod_livre_2, 103, 3) = "yes".
...
FIND FIRST fornec_financ NO-LOCK WHERE recid(fornec_financ)= v_rec_fornec_financ 
                                 AND   fornec_financ.cod_empresa = v_cod_empres_usuar NO-ERROR.
    ...
    IF NOT avail cta_corren_fornec THEN DO:
        ...
        ASSIGN cta_corren_fornec.cod_empresa = v_cod_empres_usuar
               ...
               cta_corren_fornec.cod_digito_cta_corren = c-dig-cta:SCREEN-VALUE IN FRAME {&FRAME-NAME}
               cta_corren_fornec.des_cta_corren     = c-descricao:SCREEN-VALUE IN FRAME {&FRAME-NAME}
               substring(cta_corren_fornec.cod_livre_2, 89, 11) = INPUT FRAME {&FRAME-NAME} c-cpf
               SUBSTRING(cta_corren_fornec.cod_livre_2, 103, 3) = INPUT FRAME {&FRAME-NAME} l-pf
