...
DEFINE FRAME D-Dialog
     ...
     "Para modificar utilizar o botao no cadastro de Fornecedor Financeiro" VIEW-AS TEXT
          SIZE 64.86 BY .67 AT ROW 7.42 COL 3.29 WIDGET-ID 10
          BGCOLOR 14 
...
/* SETTINGS FOR BUTTON BUTTON-13 IN FRAME D-Dialog
   NO-ENABLE                                                            */
/* SETTINGS FOR BUTTON BUTTON-14 IN FRAME D-Dialog
   NO-ENABLE                                                            */
/* SETTINGS FOR BUTTON BUTTON-15 IN FRAME D-Dialog
   NO-ENABLE                                                            */
...
OPEN QUERY {&SELF-NAME} FOR EACH fornec_financ WHERE RECID(fornec_financ) = v_rec_fornec_financ,
                            EACH cta_corren_fornec  WHERE cta_corren_fornec.cdn_fornecedor = fornec_financ.cdn_fornecedor
...
DEF VAR I  AS INTEGER.
    ...
    IF browse-2:FETCH-SELECTED-ROW(i) THEN
        ...
        RUN esp/esrc713ab.w (INPUT  cta_corren_fornec.cod_banco,
...
DO:
  ...
  IF nb <> 0 THEN 
      ...
      IF browse-2:FETCH-SELECTED-ROW(i) THEN
          ...
          RUN esp/esrc713ad.w (INPUT  cta_corren_fornec.cod_banco,
                               input  cta_corren_fornec.cod_agenc_bcia,
                               input  cta_corren_fornec.cod_cta_corren_bco).
