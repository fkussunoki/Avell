...
c-dig-agencia c-cta c-dig-cta c-descricao bt-ok bt-cancela bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS c-banco c-agencia c-dig-agencia c-cta ~
c-dig-cta c-descricao 
...
------------------------------------------------------------------------------*/
  DISPLAY c-banco c-agencia c-dig-agencia c-cta c-dig-cta c-descricao 
      WITH FRAME D-Dialog.
  ENABLE rt-buttom RECT-2 c-banco c-agencia c-dig-agencia c-cta c-dig-cta 
         c-descricao bt-ok bt-cancela bt-ajuda 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
...
------------------------------------------------------------------------------*/
  ...
  IF p-cpf <> "" THEN 
      ASSIGN substring(fornec_financ.cod_livre_2, 86, 3) = "yes"
             SUBSTRING(fornec_financ.cod_livre_2, 89, 100) = p-cpf.
