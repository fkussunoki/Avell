...
DEFINE FRAME D-Dialog
     ...
     l-prefer AT ROW 6.92 COL 3 WIDGET-ID 18
...
OR c-agencia:SCREEN-VALUE IN FRAME {&FRAME-NAME} = ""
OR c-cta:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "") THEN DO:

    MESSAGE "Preencher os campos em branco (Banco, Agencia ou Conta)" VIEW-AS ALERT-BOX.
    RETURN.
...
IF replace(replace(p-cpf, ".", ""), "-", "") = "" THEN do:
    MESSAGE "Favor cadastrar o CPF do fornecedor" VIEW-AS ALERT-BOX.
        RETURN.
    END.
    ...
    IF NOT avail cta_corren_fornec THEN DO:
        ...
        ASSIGN cta_corren_fornec.cod_empresa = v_cod_empres_usuar
               ...
               substring(cta_corren_fornec.cod_livre_2, 101, 3) = INPUT FRAME {&FRAME-NAME} l-poupanca
        ...
        find first tab_livre_emsfin no-lock
             where tab_livre_emsfin.cod_modul_dtsul      = "APB" /*l_apb*/ 
               and tab_livre_emsfin.cod_tab_dic_dtsul    = "cta_corren_fornec" /*l_cta_corren_fornec*/ 
               and entry(1, tab_livre_emsfin.cod_compon_1_idx_tab, chr(10)) =  v_cod_empres_usuar
               and entry(2, tab_livre_emsfin.cod_compon_1_idx_tab, chr(10)) =  string(fornec_financ.cdn_fornecedor)
               and tab_livre_emsfin.log_livre_1 no-error.
        IF NOT avail tab_livre_emsfin then do:

            CREATE TAB_livre_emsfin.
            ASSIGN  tab_livre_emsfin.cod_compon_1_idx_tab =  v_cod_empres_usuar + CHR(10) + string(fornec_financ.cdn_fornecedor) + CHR(10) + c-banco:SCREEN-VALUE IN FRAME {&FRAME-NAME}
                    tab_livre_emsfin.cod_compon_2_idx_tab =  c-agencia:SCREEN-VALUE IN FRAME {&FRAME-NAME} + CHR(10) + c-dig-agencia:SCREEN-VALUE IN FRAME {&FRAME-NAME} + CHR(10) + c-cta:SCREEN-VALUE IN FRAME {&FRAME-NAME}
                                                                                    + CHR(10) + c-dig-cta:SCREEN-VALUE IN FRAME {&FRAME-NAME}.
