...
** alterado em 09/09. Nao estava considerando fretes, foi alterado nome do campo 
** de fretes para despesas[1]
*******************************************************************************/
      ...
      IF NOT AVAIL ct-clas-item then do:
          ...
          IF  DEC(SUBSTRING(item.char-2, 31, 5)) >= 3 OR
              ...
              ASSIGN item-doc-est.idi-tributac-cofins    = 1
                     ...
                     item-doc-est.val-base-calc-cofins  =  (b-tt.preco-total[1] + /*b-tt.valor-frete*/ b-tt.despesas[1]) - b-tt.valor-icm[1]
                     item-doc-est.base-pis              =  (b-tt.preco-total[1] + /*b-tt.valor-frete*/ b-tt.despesas[1]) - b-tt.valor-icm[1]
