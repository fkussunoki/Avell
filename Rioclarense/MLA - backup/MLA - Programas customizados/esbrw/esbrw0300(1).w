...
item.un item.ge-codigo item.fm-codigo 
...
&Scoped-define QUERY-STRING-br-table FOR EACH item WHERE ~{&KEY-PHRASE} ~
 ...
 and item.it-codigo <= c-final NO-LOCK ~
...
/* Query rebuild information for BROWSE br-table
 ...
 and mgcad.item.it-codigo <= c-final"
     ...
     _FldNameList[3]   = mgcad.item.un
     _FldNameList[4]   = mgcad.item.ge-codigo
     _FldNameList[5]   = mgcad.item.fm-codigo
