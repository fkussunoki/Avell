...
RUN pi-seleciona-doctos.
             ...
             MESSAGE "passei1" VIEW-AS ALERT-BOX.
             
             /* DOCUMENTOS DE SA™DA */
             run pi-normal-docto (input 3).
             
             MESSAGE "passei2" VIEW-AS ALERT-BOX.
...
find first b-natur-oper where b-natur-oper.nat-operacao = it-doc-fisc.nat-operacao no-error.
    ...
    or trim(substring(b-natur-oper.char-1, 86, 1 )) = "4" then do:
      ...
      IF b-natur-oper.tipo = 1 THEN DO:
          
          FIND FIRST sit-tribut-relacto NO-LOCK WHERE sit-tribut-relacto.idi-tip-docto = 1
                                                AND   sit-tribut-relacto.cod-ncm = ITEM.class-fiscal
                                                AND   sit-tribut-relacto.cod-natur-operac = it-doc-fisc.nat-operacao
                                                AND   sit-tribut-relacto.cdn-tribut = 2 NO-ERROR.

          IF AVAIL sit-tribut-relacto THEN DO:

              FIND FIRST sit-tribut NO-LOCK WHERE sit-tribut.cdn-sit-tribut = sit-tribut-relacto.cdn-sit-tribut
                                            AND   sit-tribut.cdn-tribut     = sit-tribut-relacto.cdn-tribut NO-ERROR.
              ...
              ASSIGN tt-dados.arquivo-num   = 1
                     ...
                     tt-dados.celula-coluna = 13
                     tt-dados.celula-linha  = i-linha
                     tt-dados.celula-valor  = string(sit-tribut.dsl-sit-tribut).
          ...
          FIND FIRST sit-tribut-relacto NO-LOCK WHERE sit-tribut-relacto.idi-tip-docto = 1
                                                AND   sit-tribut-relacto.cod-ncm = ITEM.class-fiscal
                                                AND   sit-tribut-relacto.cod-natur-operac = it-doc-fisc.nat-operacao
                                                AND   sit-tribut-relacto.cdn-tribut = 3 NO-ERROR.
      ...
      IF b-natur-oper.tipo = 2 THEN DO:
          
          FIND FIRST sit-tribut-relacto NO-LOCK WHERE sit-tribut-relacto.idi-tip-docto = 2
                                                AND   sit-tribut-relacto.cod-ncm = ITEM.class-fiscal
                                                AND   sit-tribut-relacto.cod-natur-operac = it-doc-fisc.nat-operacao
                                                AND   sit-tribut-relacto.cdn-tribut = 2 NO-ERROR.
