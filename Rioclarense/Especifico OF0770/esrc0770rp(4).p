...
/*                                                                                                           */
        ...
        tt-faturamento.ttv-vlr-PIS                        = it-nota-fisc.vl-tot-item * DECIMAL(substring(it-nota-fisc.char-2,76,5)) / 100 /* movto-estoq.val-cofins */
        tt-faturamento.ttv-vlr-COFINS                     = it-nota-fisc.vl-tot-item * DECIMAL(substring(it-nota-fisc.char-2,81,5)) / 100  /*movto-estoq.valor-pis*/
