...
FOR EACH it-nota-fisc NO-LOCK WHERE it-nota-fisc.dt-emis-nota >= TT-PARAM.DT-PERIODO-INI
                              AND   it-nota-fisc.dt-emis-nota <= TT-PARAM.DT-PERIODO-FIM
                              AND   it-nota-fisc.cod-estabel = TT-PARAM.COD-ESTABEL
