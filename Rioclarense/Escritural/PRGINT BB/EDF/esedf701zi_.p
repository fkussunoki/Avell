...
def stream s-arq.
    ...
    DEF VAR l-pessoa-fisica AS LOGICAL.
...
if p_cdn_segment_edi = 309 and
   ...
   return v_dsl_segto. 
    /* Vai retornar registro com dados de detalhe variÿvel */
end.
...
PROCEDURE pi_segto_tipo_A:
        ...
        FIND FIRST cta_corren_fornec NO-LOCK WHERE cta_corren_fornec.cod_cta_corren_bco = string(tt_param_program_formul.ttv_des_contdo) NO-ERROR.

        IF AVAIL cta_corren_fornec THEN DO:

            IF substring(cta_corren_fornec.cod_livre_2, 89, 11) <> "" THEN
                ASSIGN l-pessoa-fisica = YES
                       c-cpf          = substring(cta_corren_fornec.cod_livre_2, 89, 11).
        END.
        ...
        assign v_dsl_segto = v_dsl_segto + /* string(tt_param_program_formul.ttv_des_contdo,'99999999999999')*/ fill(' ',14) + /* posi‡Æo 204 a 217 (Nr. Inscri‡Æo) */
                             ...
                             fill(' ',10) + CHR(10). /* posi‡Æo 231 a 240 (Ocorrˆncias) */
...
/*         assign v_dsl_segto = v_dsl_segto + string(int(tt_param_program_formul.ttv_des_contdo),'999'). /* C¢digo do banco - 001 a 003 */ */
        ...
        IF l-pessoa-fisica THEN

        assign v_dsl_segto = v_dsl_segto + "1".
         
            ELSE


        assign v_dsl_segto = v_dsl_segto + string(int(tt_param_program_formul.ttv_des_contdo),'9').  /* Tipo de incri‡Æo - 018 a 018 */
         MESSAGE "3915 " +  tt_param_program_formul.ttv_des_contdo VIEW-AS ALERT-BOX.                   
        find first tt_param_program_formul where 
             tt_param_program_formul.tta_cdn_segment_edi = 289 and
             tt_param_program_formul.tta_cdn_element_edi = 3916 
             no-lock no-error.

 MESSAGE "3916 " +  tt_param_program_formul.ttv_des_contdo VIEW-AS ALERT-BOX.
        IF l-pessoa-fisica THEN

        ASSIGN v_dsl_segto = v_dsl_segto + string(c-cpf, '999999999999999').
        ...
        find first tt_param_program_formul where 
             ...
             no-lock no-error.
MESSAGE "3917 " +  tt_param_program_formul.ttv_des_contdo VIEW-AS ALERT-BOX.
        ...
        find first tt_param_program_formul where 
             ...
             no-lock no-error.
MESSAGE "3621 " +  tt_param_program_formul.ttv_des_contdo VIEW-AS ALERT-BOX.
        ...
        find first tt_param_program_formul where 
             ...
             no-lock no-error.
MESSAGE "3918 " +  tt_param_program_formul.ttv_des_contdo VIEW-AS ALERT-BOX.
        ...
        find first tt_param_program_formul where 
             ...
             no-lock no-error.
MESSAGE "3920 " +  tt_param_program_formul.ttv_des_contdo VIEW-AS ALERT-BOX.
        ...
        find first tt_param_program_formul where 
             ...
             no-lock no-error.
MESSAGE "3919 " +  tt_param_program_formul.ttv_des_contdo VIEW-AS ALERT-BOX.
        ...
        find first tt_param_program_formul where 
             ...
             no-lock no-error.
MESSAGE "3606 " +  tt_param_program_formul.ttv_des_contdo VIEW-AS ALERT-BOX.
        ...
        find first tt_param_program_formul where 
             ...
             tt_param_program_formul.tta_cdn_element_edi = 4421 
             no-lock no-error.
MESSAGE "4421 " +  tt_param_program_formul.ttv_des_contdo VIEW-AS ALERT-BOX.
        ...
        find first tt_param_program_formul where
             ...
             no-lock no-error.
MESSAGE "4425 " +  tt_param_program_formul.ttv_des_contdo VIEW-AS ALERT-BOX.
        ...
        find first tt_param_program_formul where
             ...
             no-lock no-error.
MESSAGE "4423 " +  tt_param_program_formul.ttv_des_contdo VIEW-AS ALERT-BOX.
        ...
        find first tt_param_program_formul where
             ...
             no-lock no-error.
MESSAGE "4422 " +  tt_param_program_formul.ttv_des_contdo VIEW-AS ALERT-BOX.
        ...
        find first tt_param_program_formul where 
             ...
             no-lock no-error.
MESSAGE "4426 " +  tt_param_program_formul.ttv_des_contdo VIEW-AS ALERT-BOX.
        ...
        assign v_dsl_segto = v_dsl_segto + string(' ','x(8)') + CHR(10). /* Uso exclusivo FEBRABAN - 233 a 240 */
...
PROCEDURE pi_segto_tipo_J:
                ...
                if  avail tt_param_program_formul then do:
                 ...
                 assign v_dsl_segto = v_dsl_segto + string(tt_param_program_formul.ttv_des_contdo,"x(20)" /*l_x20*/ ) + /* posi‡Æo 183 a 202 (Seu N£mero) */
                                      ...
                                      fill(' ',7) + /* posi‡Æo 216 a 223 (Brancos) */
                                      '09' + 
                                      fill(' ',16) + CHR(10). /* posi‡Æo 231 a 240 (Brancos) */
