...
IF p-ind-event = "INITIALIZE" THEN DO:
   ...
   IF VALID-HANDLE(whBrTable) THEN DO:
       ASSIGN whColUF_BrT            = whBrTable:ADD-CALC-COLUMN("CHAR", "x(2)", "", "UF", (whBrTable:NUM-COLUMNS + 1))
              ...
              whColVlTotPedido_Brt   = whBrTable:ADD-CALC-COLUMN("Dec", "->>>,>>>,>>>,>>>.>9", "", "Vl.Tot.Pedido", (whBrTable:Num-Columns + 11))
              whColVlTotPendente_Brt = whBrTable:ADD-CALC-COLUMN("Dec", "->>>,>>>,>>>,>>>.>9", "", "Vl.Tot.Pendente", (whBrTable:Num-Columns + 12))
   ...
   IF VALID-HANDLE(whBrTable_proc) THEN DO:
       ASSIGN whColUF_BrT_proc            = whBrTable_proc:ADD-CALC-COLUMN("CHAR", "x(2)", "", "UF", (whBrTable_proc:NUM-COLUMNS + 1))
              ...
              whColVlTotPedido_Brt_proc   = whBrTable_proc:ADD-CALC-COLUMN("Dec", "->>>,>>>,>>>,>>>.>9", "", "Vl.Tot.Pedido", (whBrtable_proc:Num-Columns + 11))
              whColVlTotPendente_Brt_proc = whBrTable_proc:ADD-CALC-COLUMN("Dec", "->>>,>>>,>>>,>>>.>9", "", "Vl.Tot.Pendente", (whBrtable_proc:Num-Columns + 12))
   ...
   IF VALID-HANDLE(whBrTable_506) THEN DO:
       ASSIGN whColUF_BrT_506            = whBrTable_506:ADD-CALC-COLUMN("CHAR", "x(2)", "", "UF", (whBrTable_506:NUM-COLUMNS + 1))
              ...
              whColVlTotPedido_Brt_506   = whBrTable_506:ADD-CALC-COLUMN("Dec", "->>>,>>>,>>>,>>>.>9", "", "Vl.Tot.Pedido", (whBrtable_506:Num-Columns + 11))
              whColVlTotPendente_Brt_506 = whBrTable_506:ADD-CALC-COLUMN("Dec", "->>>,>>>,>>>,>>>.>9", "", "Vl.Tot.Pendente", (whBrtable_506:Num-Columns + 12))
   ...
   IF VALID-HANDLE(whBrTable_un) THEN DO:
       ASSIGN whColUF_BrT_un            = whBrTable_un:ADD-CALC-COLUMN("CHAR", "x(2)", "", "UF", (whBrTable_un:NUM-COLUMNS + 1))
              ...
              whColVlTotPedido_Brt_un   = whBrTable_un:ADD-CALC-COLUMN("Dec", "->>>,>>>,>>>,>>>.>9", "", "Vl.Tot.Pedido", (whBrtable_un:Num-Columns + 11))
              whColVlTotPendente_Brt_un = whBrTable_un:ADD-CALC-COLUMN("Dec", "->>>,>>>,>>>,>>>.>9", "", "Vl.Tot.Pendente", (whBrtable_un:Num-Columns + 12))
   ...
   IF VALID-HANDLE(whBrTable_un_506) THEN DO:
       ASSIGN whColUF_BrT_un_506            = whBrTable_un_506:ADD-CALC-COLUMN("CHAR", "x(2)", "", "UF", (whBrTable_un_506:NUM-COLUMNS + 1))
              ...
              whColVlTotPedido_Brt_un_506   = whBrTable_un_506:ADD-CALC-COLUMN("Dec", "->>>,>>>,>>>,>>>.>9", "", "Vl.Tot.Pedido", (whBrtable_un_506:Num-Columns + 11))
              whColVlTotPendente_Brt_un_506 = whBrTable_un_506:ADD-CALC-COLUMN("Dec", "->>>,>>>,>>>,>>>.>9", "", "Vl.Tot.Pendente", (whBrtable_un_506:Num-Columns + 12))
