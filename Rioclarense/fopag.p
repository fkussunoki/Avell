...
FOR EACH movto_calcul_func NO-LOCK WHERE movto_calcul_func.num_ano_refer_fp = 2018
            ...
            FIND FIRST perc_rat_ccusto NO-LOCK WHERE perc_rat_ccusto.cdn_empresa = funcionario.cdn_empresa
                                               AND   perc_rat_ccusto.cdn_funcionario = funcionario.cdn_funcionario NO-ERROR.

            IF AVAIL perc_rat_ccusto THEN DO:
