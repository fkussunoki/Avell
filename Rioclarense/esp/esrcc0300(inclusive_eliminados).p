...
DEF VAR d-valor-total AS DEC FORMAT "->>>,>>>,>>>,>>>,>>>,>>>.99".
...
FOR EACH ordem-compra NO-LOCK WHERE ordem-compra.num-pedido = pedido-compr.num-pedido 
     ...
     FIND FIRST cotacao-item NO-LOCK WHERE cotacao-item.numero-ordem = ordem-compra.numero-ordem
                                     AND   cotacao-item.it-codigo    = ordem-compra.it-codigo
                                     AND   cotacao-item.cod-emitente = ordem-compra.cod-emitente NO-ERROR.

     ASSIGN d-valor-total = d-valor-total + cotacao-item.preco-fornec.
            ...
            if not mla-param-aprov.log-senha then do:
                ...
                **/
                ...
                assign tt-envio.versao-integracao = 1
                       ...
                       tt-envio.assunto     = c-fabricante + " "  + c-ass-e-mail + " R$ " + string(d-valor-total)
                ...
                **/
                ...
                assign tt-envio2.versao-integracao = 1
                       ...
                       tt-envio2.assunto     = c-fabricante + " "  + c-ass-e-mail + " R$ " + string(d-valor-total)
