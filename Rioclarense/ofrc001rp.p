...
FOR EACH doc-fiscal WHERE doc-fiscal.cod-estabel >= tt-param.c-estab-ini
                    AND   doc-fiscal.cod-estabel <= tt-param.c-estab-fim
                    AND   doc-fiscal.dt-emis-doc >= tt-param.c-dt-corte-ini
                    AND   doc-fiscal.dt-emis-doc <= tt-param.c-dt-corte-fim BREAK BY doc-fiscal.cod-estabel
...
IF tt-param.l-zerado = YES THEN DO:
