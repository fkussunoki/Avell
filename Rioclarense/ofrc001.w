...
*******************************************************************************/
{include/i-prgvrs.i ofrc001 1.00.00.003}
...
DEFINE FRAME f-pg-sel
     ...
     TOGGLE-1 AT ROW 9.75 COL 28.43 WIDGET-ID 50
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
ON END-ERROR OF w-relat /* Relatorio ICMS */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Relatorio ICMS */
DO:
...
{utp/ut9000.i "espfas002" "1.00.00.003"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-cenario c-cenario-2 c-dt-corte-ini c-dt-corte-fim TOGGLE-1 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE c-cenario c-cenario-2 c-dt-corte-ini c-dt-corte-fim TOGGLE-1 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.l-zerado          = INPUT frame f-pg-sel toggle-1.
    ...
    {include/i-rprun.i ofp/ofrc001rp.p}
