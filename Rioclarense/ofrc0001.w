...
DEFINE VARIABLE c-cenario AS CHARACTER FORMAT "X(10)":U 
     LABEL "Estab. Ini" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE c-cenario-2 AS CHARACTER FORMAT "X(10)":U INITIAL "zzzzzzzzzzzzz" 
     LABEL "Estab. Fim" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE c-ct-icms AS CHARACTER FORMAT "X(256)":U 
     LABEL "Ct.ICMS Recuperar" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE c-dt-corte-fim AS DATE FORMAT "99/99/9999":U INITIAL 12/31/9999 
     LABEL "Dt.Fim" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE c-dt-corte-ini AS DATE FORMAT "99/99/9999":U INITIAL 01/01/001 
     LABEL "Dt.Ini" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.
...
DEFINE VARIABLE l-aberto AS LOGICAL INITIAL no 
     LABEL "Contabilizacao Aberta?" 
     VIEW-AS TOGGLE-BOX
     SIZE 30.57 BY .83 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     c-cenario AT ROW 2.33 COL 18.14 COLON-ALIGNED WIDGET-ID 34
     c-cenario-2 AT ROW 2.33 COL 50.29 COLON-ALIGNED WIDGET-ID 44
     c-dt-corte-ini AT ROW 4.63 COL 18.43 COLON-ALIGNED WIDGET-ID 40
     c-dt-corte-fim AT ROW 4.63 COL 50.43 COLON-ALIGNED WIDGET-ID 42
     c-ct-icms AT ROW 6.5 COL 50.29 COLON-ALIGNED WIDGET-ID 56
     l-aberto AT ROW 9.25 COL 21.29 WIDGET-ID 60
     RECT-10 AT ROW 1.08 COL 1.57 WIDGET-ID 58
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
ON END-ERROR OF w-relat /* ICMS Recebimento */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* ICMS Recebimento */
DO:
...
{utp/ut9000.i "OFRC0001" "1.00.00.001"}
...
ASSIGN c-ct-icms:SCREEN-VALUE IN FRAME f-pg-sel = estabelec.ct-icm.
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-cenario c-cenario-2 c-dt-corte-ini c-dt-corte-fim c-ct-icms l-aberto 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE RECT-10 c-cenario c-cenario-2 c-dt-corte-ini c-dt-corte-fim c-ct-icms 
         l-aberto 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.c-estab-ini     = c-cenario:SCREEN-VALUE IN FRAME f-pg-sel
           tt-param.c-estab-fim     = c-cenario-2:SCREEN-VALUE IN FRAME f-pg-sel
           tt-param.c-dt-corte-ini    = DATE(c-dt-corte-ini:SCREEN-VALUE IN FRAME f-pg-sel)
           tt-param.c-dt-corte-fim    = DATE(c-dt-corte-fim:SCREEN-VALUE IN FRAME f-pg-sel)
           tt-param.c-cta-icms        = INPUT frame f-pg-sel c-ct-icms
           tt-param.l-aberto          = INPUT FRAME f-pg-sel l-aberto.
.    
    ...
    {include/i-rprun.i ofp/ofrc0001rp.p}
