...
/*     FOR EACH tt_tit_acr_selec_cobr WHERE tt_tit_acr_selec_cobr.tta_ind_tip_ocor_bcia = "Concessao Abatimento": */
        ...
        FIND FIRST tit_Acr WHERE recid(tit_acr) = tt_tit_acr_selec_cobr.ttv_rec_tit_acr NO-ERROR.

        IF CAN-FIND(movto_ocor_bcia NO-LOCK WHERE movto_ocor_bcia.num_id_tit_acr = tit_Acr.num_id_tit_acr
                                           AND   movto_ocor_bcia.ind_tip_ocor_bcia = "Concessao Abatimento"
                                           AND   movto_ocor_bcia.log_movto_envdo_bco = YES) THEN DO:
        ...
        FOR EACH movto_ocor_bcia NO-LOCK WHERE movto_ocor_bcia.num_id_tit_acr = tit_Acr.num_id_tit_acr
                                         AND   movto_ocor_bcia.ind_tip_ocor_bcia = "Concessao Abatimento"
