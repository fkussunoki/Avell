...
define temp-table tt_xpc like tt_epc.
...
/*     FOR EACH tt_tit_acr_selec_cobr WHERE tt_tit_acr_selec_cobr.tta_ind_tip_ocor_bcia = "Concessao Abatimento": */
        ...
        find first tit_Acr where recid(tit_Acr) = ttv_rec_tit_acr  no-error.
        
        
        for each movto_tit_acr NO-LOCK WHERE movto_tit_acr.num_id_tit_Acr = tit_Acr.num_id_tit_acr
                                         ...
                                         break by string(movto_tit_acr.dat_transacao) + movto_tit_acr.ind_trans_acr_abrev.
        ...
        IF CAN-FIND(movto_ocor_bcia NO-LOCK WHERE movto_ocor_bcia.num_id_tit_acr = movto_tit_acr.num_id_tit_acr
            ...
            ASSIGN tt_epc.cod_event     = 'VlAbatEspec'   
                   ...
                   tt_epc.val_parameter = STRING(0).
                                         ...
                                         find first tt_epc where tt_epc.cod_event = 'VlAbatEspec'
                                            and  tt_epc.cod_parameter = 'VlAbatEspec-Novo' no-error.
        ...
        IF NOT CAN-FIND(movto_ocor_bcia NO-LOCK WHERE movto_ocor_bcia.num_id_tit_acr = movto_tit_acr.num_id_tit_acr
                                           AND   movto_ocor_bcia.ind_tip_ocor_bcia = "Concessao Abatimento"
                                           AND   movto_ocor_bcia.log_movto_envdo_bco = YES
                                           AND   movto_ocor_bcia.cod_estab       = movto_tit_acr.cod_estab
                                           AND   movto_ocor_bcia.cod_portador    = movto_tit_acr.cod_portador
        ...
        if last-of(string(movto_tit_acr.dat_transacao) + movto_tit_acr.ind_trans_acr_abrev) then do:
        ...
        FOR EACH movto_ocor_bcia NO-LOCK WHERE movto_ocor_bcia.num_id_tit_acr = movto_tit_acr.num_id_tit_acr
                                         ...
                                         BREAK BY string(movto_ocor_bcia.dat_movto_ocor_bcia) + movto_ocor_bcia.ind_tip_ocor_bcia:
                                         
                                         

            IF movto_ocor_bcia.log_movto_envdo_bco = YES THEN RETURN.
/*    */
            ACCUMULATE movto_ocor_bcia.val_movto_ocor_bcia (SUB-TOTAL BY string(movto_ocor_bcia.dat_movto_ocor_bcia) + movto_ocor_bcia.ind_tip_ocor_bcia).


            IF LAST-OF(string(movto_ocor_bcia.dat_movto_ocor_bcia) + movto_ocor_bcia.ind_tip_ocor_bcia) THEN DO:
...
/*         ASSIGN v_valor = v_valor +  movto_ocor_bcia.val_movto_ocor_bcia.  */
                    ...
                    assign tt_epc.cod_event = 'VlAbatEspec'
                                        tt_epc.cod_parameter = 'VlAbatEspec-Novo'
                                        tt_epc.val_parameter = string(dec(tt_epc.val_parameter) + ACCUM SUB-TOTAL BY string(movto_ocor_bcia.dat_movto_ocor_bcia) + movto_ocor_bcia.ind_tip_ocor_bcia movto_ocor_bcia.val_movto_ocor_bcia).
          end.       
     ...
     END.
        ...
        for each b_movto_tit_acr where b_movto_tit_Acr.num_id_tit_acr = movto_tit_Acr.num_id_tit_Acr
                                 and   b_movto_tit_Acr.ind_trans_acr_abrev  = "AVMN"
                                 and   b_movto_tit_acr.cod_estab      = movto_tit_acr.cod_Estab
                                 and   b_movto_tit_acr.cod_espec_docto = movto_tit_Acr.cod_espec_docto
                                 and   b_movto_tit_Acr.log_movto_estordo = no
                                 and   b_movto_tit_acr.dat_transacao   = movto_tit_acr.dat_transacao break by string(b_movto_tit_acr.dat_transacao) + b_movto_tit_Acr.ind_trans_acr_abrev :
                                 
                                 accumulate b_movto_tit_Acr.val_movto_tit_Acr (sub-total by string(b_movto_tit_acr.dat_transacao) + b_movto_tit_Acr.ind_trans_acr_abrev  ).
                                 
                                 if last-of(string(b_movto_tit_acr.dat_transacao) + b_movto_tit_Acr.ind_trans_acr_abrev ) then do:
                                 
                                 
                                 assign tt_epc.cod_event = 'VlAbatEspec'
                                        tt_epc.cod_parameter = 'VlAbatEspec-Novo'
                                        tt_epc.val_parameter = string(dec(tt_epc.val_parameter) + accum sub-total by string(b_movto_tit_acr.dat_transacao) + b_movto_tit_Acr.ind_trans_acr_abrev  b_movto_tit_Acr.val_movto_tit_acr).
