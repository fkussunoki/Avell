...
*******************************************************************************/
{include/i-prgvrs.i CE0402 2.00.00.033 } /*** 010033 ***/



&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i ce0402 MCE}
&ENDIF
...
&Scoped-define QUERY-STRING-f-pg-sel FOR EACH mgind.grup-estoque SHARE-LOCK, ~
      EACH mgadm.estabelec WHERE TRUE /* Join to mgind.grup-estoque incomplete */ SHARE-LOCK, ~
      EACH mgind.item OF mgind.grup-estoque SHARE-LOCK, ~
      EACH mgind.param-estoq WHERE TRUE /* Join to mgind.grup-estoque incomplete */ SHARE-LOCK
&Scoped-define OPEN-QUERY-f-pg-sel OPEN QUERY f-pg-sel FOR EACH mgind.grup-estoque SHARE-LOCK, ~
      EACH mgadm.estabelec WHERE TRUE /* Join to mgind.grup-estoque incomplete */ SHARE-LOCK, ~
      EACH mgind.item OF mgind.grup-estoque SHARE-LOCK, ~
      EACH mgind.param-estoq WHERE TRUE /* Join to mgind.grup-estoque incomplete */ SHARE-LOCK.
...
DEFINE FRAME f-pg-sel
     ...
     dt-fim AT ROW 5.83 COL 17.29 COLON-ALIGNED WIDGET-ID 24
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
         SIZE 76.5 BY 10.5.
...
/* Query rebuild information for FRAME f-pg-sel
     _TblList          = "mgind.grup-estoque,mgadm.estabelec WHERE mgind.grup-estoque ...,mgind.item OF mgind.grup-estoque,mgind.param-estoq WHERE mgind.grup-estoque ..."
     _Query            is NOT OPENED
*/  /* FRAME f-pg-sel */
&ANALYZE-RESUME
...
{utp/ut9000.i "CE0402" "2.00.00.019"}
