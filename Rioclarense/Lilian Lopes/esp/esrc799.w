...
DEFINE FRAME f-pg-sel
     ...
     BUTTON-2 AT ROW 7.08 COL 34.72 WIDGET-ID 32
     c-representante AT ROW 7.17 COL 17.57 COLON-ALIGNED WIDGET-ID 30
     BUTTON-3 AT ROW 8.38 COL 34.57 WIDGET-ID 36
     c-un AT ROW 8.42 COL 17.57 COLON-ALIGNED WIDGET-ID 34
     rs-tipo AT ROW 10 COL 19.29 NO-LABEL WIDGET-ID 38
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
         SIZE 76.5 BY 10.5.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE dt-fim dt-ini BUTTON-1 BUTTON-2 BUTTON-3 rs-tipo 
      WITH FRAME f-pg-sel IN WINDOW c-win.
