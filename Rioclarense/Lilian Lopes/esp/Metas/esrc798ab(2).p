...
ASSIGN v_dat_liquidac_inicial      = 01/01/2007
       v_dat_liquidac_final        = TODAY
       v_dat_transacao_ini         = 01/01/2007
       v_dat_transacao_fim         = TODAY 
       v_dat_liquidac_inic         = 01/01/2007 
       v_dat_liquidac_fim          = TODAY 
       v_dat_inic_period_aux       = 01/01/2007 
                   ...
                   where movto_tit_acr.cod_estab     = entry(v_num_cont_aux, v_des_estab_select)
                    ...
                    IF v_log_modul_vendor                = YES AND
                     ...
                     /* End_Include: i_selecao_consulta_liquidacao_con */
                         ...
                         RUN pi-acompanhar IN h-acomp (INPUT "Estab " + tit_Acr.cod_estab + " Data " + string(tit_Acr.dat_transacao)).
