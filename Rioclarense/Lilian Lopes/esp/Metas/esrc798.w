...
*******************************************************************************/
{include/i-prgvrs.i ESRC798 1.00.00.000 } /*** 010033 ***/



&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i ESRC798 ACR}
&ENDIF
...
{utp/ut9000.i "ESRC798" "1.00.00.000"}
...
.
    ...
    if  session:set-wait-state("general") then.
     ...
     {include/i-rprun.i esp/esrc798rp.p}
