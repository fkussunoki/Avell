...
ASSIGN tinicio = NOW.
    ...
    FOR EACH tt-especie,
        EACH tit_acr NO-LOCK WHERE    tit_acr.log_tit_acr_estordo = NO
                                ...
                                /* USE-INDEX titacr_clien_datas */
                                BREAK BY tit_acr.cod_estab 
    ...
    FOR EACH tt_titulos_aberto_rioclarense:
        ...
        FIND FIRST tt-unid-negoc WHERE tt-unid-negoc.ttv-cod-unid-negoc = tt_titulos_aberto_rioclarense.ttv-unid-negoc NO-ERROR.

        IF NOT AVAIL tt-unid-negoc THEN
            DELETE tt_titulos_Aberto_rioclarense.

    end.
    
        FOR EACH tt_titulos_aberto_rioclarense:

        FIND FIRST tt-representante WHERE tt-representante.ttv-cdn-representante = int(tt_titulos_aberto_rioclarense.ttv-cod-cobrador) NO-ERROR.

        IF NOT AVAIL tt-representante THEN
            DELETE tt_titulos_aberto_rioclarense.
            
        end.
        IF tt-param.tp-vencidos THEN DO:
...
IF tt-param.cod-tipo = 1 THEN do:
    RUN pi-cabecalho.
...
PROCEDURE pi-cria-planilha:
   ...
   RUN pi-acompanhar IN h-acomp (INPUT tt_titulos_aberto_rioclarense.tta_cod_estab + " " + string(tt_titulos_aberto_rioclarense.ttv-cdn-cliente) + " " + tt_titulos_aberto_rioclarense.tta_cod_tit_Acr + " " + string(INTErval(tatual, tinicio, "minutes")) + " minutos").
    ...
    ASSIGN arquivo-num                     = 1                          
           ...
           celula-valor                    = tt_titulos_aberto_rioclarense.tta_cod_estab                  
           celula-fonte-cor                = 1.      
    ...
    ASSIGN arquivo-num                     = 1                          
           ...
           celula-linha                    = m-linha                          
           celula-cor-interior             = 58                          
           celula-valor                    = tt_titulos_aberto_rioclarense.tta_cod_espec_docto                  
           celula-fonte-cor                = 1.      
    ...
    ASSIGN arquivo-num                     = 1                          
           ...
           celula-linha                    = m-linha                          
           celula-cor-interior             = 58                          
           celula-valor                    = tt_titulos_aberto_rioclarense.tta_cod_ser_docto                 
           celula-fonte-cor                = 1.      
    ...
    ASSIGN arquivo-num                     = 1                          
           ...
           celula-linha                    = m-linha                          
           celula-cor-interior             = 58                          
           celula-valor                    = tt_titulos_aberto_rioclarense.tta_cod_tit_acr                 
           celula-fonte-cor                = 1.      
    ...
    ASSIGN arquivo-num                     = 1                          
           ...
           celula-linha                    = m-linha                          
           celula-cor-interior             = 58                          
           celula-valor                    = tt_titulos_aberto_rioclarense.tta_cod_parcela              
           celula-fonte-cor                = 1.      
    ...
    ASSIGN arquivo-num                     = 1                          
           ...
           celula-linha                    = m-linha                          
           celula-cor-interior             = 58                          
           celula-valor                    = string(tt_titulos_aberto_rioclarense.tta_dat_emis_docto)               
           celula-fonte-cor                = 1.      
    ...
    ASSIGN arquivo-num                     = 1                          
           ...
           celula-linha                    = m-linha                          
           celula-cor-interior             = 58                          
           celula-valor                    = string(tt_titulos_aberto_rioclarense.tta_dat_vencto_tit_acr)               
           celula-fonte-cor                = 1.      
    ...
    ASSIGN arquivo-num                     = 1                          
           ...
           celula-linha                    = m-linha                          
           celula-cor-interior             = 58                          
           celula-valor                    = string(tt_titulos_aberto_rioclarense.tta_val_origin_tit_acr * (tt_titulos_aberto_rioclarense.tta_val_aprop_ctbl / tt_titulos_aberto_rioclarense.tta_val_origin_tit_acr))                 
           celula-fonte-cor                = 1.      
    ...
    ASSIGN arquivo-num                     = 1                          
           ...
           celula-linha                    = m-linha                          
           celula-cor-interior             = 58                          
           celula-valor                    = string(tt_titulos_aberto_rioclarense.tta_val_sdo_tit_acr  * (tt_titulos_aberto_rioclarense.tta_val_aprop_ctbl / tt_titulos_aberto_rioclarense.tta_val_origin_tit_acr))               
           celula-fonte-cor                = 1.      
    ...
    ASSIGN arquivo-num                     = 1                          
           ...
           celula-linha                    = m-linha                          
           celula-cor-interior             = 58                          
           celula-valor                    = tt_titulos_aberto_rioclarense.tta_cod_indic_econ                
           celula-fonte-cor                = 1.      
    
    


        IF tt_titulos_aberto_rioclarense.tta_dat_vencto_tit_acr >= TODAY THEN DO:
            CREATE tt-dados.
            ASSIGN arquivo-num                     = 1                          
                   planilha-num                    = 1                          
                   celula-coluna                   = 11                         
         ...
         ASSIGN arquivo-num                     = 1                          
            ...
            ASSIGN arquivo-num                     = 1                          
                   ...
                   celula-linha                    = m-linha                          
                   celula-cor-interior             = 58                          
                   celula-valor                    = tt_titulos_aberto_rioclarense.ttv-nom-cobrador                
                   celula-fonte-cor                = 1.      
        ...
        ASSIGN arquivo-num                     = 1                          
               ...
               celula-linha                    = m-linha                          
               celula-cor-interior             = 58                          
               celula-valor                    = string(tt_titulos_aberto_rioclarense.ttv-cod-vendedor)                
               celula-fonte-cor                = 1.      
            ...
            ASSIGN arquivo-num                     = 1                          
                   ...
                   celula-linha                    = m-linha                          
                   celula-cor-interior             = 58                          
                   celula-valor                    = tt_titulos_aberto_rioclarense.ttv-nom-vendedor                
                   celula-fonte-cor                = 1.      
            ...
            ASSIGN arquivo-num                     = 1                          
                   ...
                   celula-linha                    = m-linha                          
                   celula-cor-interior             = 58                          
                   celula-valor                    = string(tt_titulos_aberto_rioclarense.ttv-cdn-cliente )                 
                   celula-fonte-cor                = 1.      
            ...
            ASSIGN arquivo-num                     = 1                          
                   ...
                   celula-linha                    = m-linha                          
                   celula-cor-interior             = 58                          
                   celula-valor                    = tt_titulos_aberto_rioclarense.ttv-nom-cliente                
                   celula-fonte-cor                = 1.      
            ...
            ASSIGN arquivo-num                     = 1                          
                   ...
                   celula-linha                    = m-linha                          
                   celula-cor-interior             = 58                          
                   celula-valor                    = tt_titulos_aberto_rioclarense.ttv-estado                
                   celula-fonte-cor                = 1.      
            ...
            ASSIGN arquivo-num                     = 1                          
                   ...
                   celula-linha                    = m-linha                          
                   celula-cor-interior             = 58                          
                   celula-valor                    = tt_titulos_aberto_rioclarense.ttv-cnpj                 
                   celula-fonte-cor                = 1.    
            ...
            ASSIGN arquivo-num                     = 1                          
                   ...
                   celula-linha                    = m-linha                          
                   celula-cor-interior             = 58                          
                   celula-valor                    = tt_titulos_aberto_rioclarense.ttv-ramo                
                   celula-fonte-cor                = 1.      
            ...
            ASSIGN arquivo-num                     = 1                          
                   ...
                   celula-linha                    = m-linha                          
                   celula-cor-interior             = 58                          
                   celula-valor                    = tt_titulos_Aberto_rioclarense.ttv-unid-negoc               
                   celula-fonte-cor                = 1.      
