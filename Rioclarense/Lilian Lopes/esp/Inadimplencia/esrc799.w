...
DEFINE VARIABLE rs-tipo AS INTEGER 
     ...
     RADIO-BUTTONS 
          "Completa", 1,
"Resumo", 2
     SIZE 26.86 BY .92 NO-UNDO.

DEFINE VARIABLE l-vencidos AS LOGICAL INITIAL no 
...
DEFINE FRAME f-pg-sel
     ...
     rs-tipo AT ROW 9.67 COL 21.29 NO-LABEL WIDGET-ID 38
     l-vencidos AT ROW 10.67 COL 23.57 WIDGET-ID 42
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
         SIZE 76.5 BY 10.5.
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY dt-fim dt-ini c-especie c-representante c-un rs-tipo l-vencidos 
      WITH FRAME f-pg-sel IN WINDOW c-win.
  ENABLE dt-fim dt-ini BUTTON-1 BUTTON-3 BUTTON-2 rs-tipo l-vencidos 
      WITH FRAME f-pg-sel IN WINDOW c-win.
...
/*                                                                                                                                */
    ...
    assign tt-param.usuario     = v_cod_usuar_corren
           ...
           tt-param.cod-empresa       = v_cod_empres_usuar
           tt-param.tp-vencidos       = INPUT FRAME f-pg-sel l-vencidos.
