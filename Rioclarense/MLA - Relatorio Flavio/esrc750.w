...
DEFINE VARIABLE c-cenario AS DATE FORMAT "99/99/9999":U INITIAL 01/01/001 
     LABEL "Dt. Emiss. Pedido" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE c-cenario-2 AS DATE FORMAT "99/99/9999":U INITIAL 12/31/9999 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     c-cenario AT ROW 2.33 COL 22 COLON-ALIGNED WIDGET-ID 34
     c-cenario-2 AT ROW 2.33 COL 47.29 COLON-ALIGNED NO-LABEL WIDGET-ID 44
     RECT-10 AT ROW 1.08 COL 1.57 WIDGET-ID 58
     IMAGE-5 AT ROW 2.33 COL 39.14 WIDGET-ID 6
     IMAGE-6 AT ROW 2.33 COL 45.72 WIDGET-ID 8
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
ON END-ERROR OF w-relat /* Pedidos Compras MLA */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Pedidos Compras MLA */
DO:
...
{utp/ut9000.i "ESRC750" "1.00.00.001"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-cenario c-cenario-2 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE RECT-10 IMAGE-5 IMAGE-6 c-cenario c-cenario-2 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.c-cenario       = input frame f-pg-sel c-cenario
           tt-param.c-cenario-2     = input FRAME f-pg-sel c-cenario-2.
.    
    ...
    {include/i-rprun.i esp/esrc750rp.p}
