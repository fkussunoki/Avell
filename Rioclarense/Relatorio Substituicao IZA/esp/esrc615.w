...
*******************************************************************************/
{include/i-prgvrs.i esrc615 1.00.00.001}
...
DEFINE VARIABLE cod-emitente-fim AS INTEGER FORMAT "->,>>>,>>9":U INITIAL 99999999 
     VIEW-AS FILL-IN 
...
DEFINE VARIABLE cod-estab-fim AS CHARACTER FORMAT "X(4)":U INITIAL "zzzzz" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE cod-estab-ini AS CHARACTER FORMAT "X(4)":U 
     LABEL "Estab" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.
...
DEFINE VARIABLE it-codigo-fim AS CHARACTER FORMAT "X(256)":U INITIAL "zzzzzzzzzzzzzz" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE it-codigo-ini AS CHARACTER FORMAT "X(256)":U 
     LABEL "Item" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE natur-oper-fim AS CHARACTER FORMAT "X(256)":U INITIAL "zzzzzzzzzzzzzz" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE natur-oper-ini AS CHARACTER FORMAT "X(256)":U 
     LABEL "Nat-Oper. Fat." 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     cod-estab-ini AT ROW 2.17 COL 18.43 COLON-ALIGNED
     cod-estab-fim AT ROW 2.17 COL 51.57 COLON-ALIGNED NO-LABEL
     cod-emitente-ini AT ROW 3.42 COL 18.57 COLON-ALIGNED WIDGET-ID 4
     cod-emitente-fim AT ROW 3.42 COL 51.72 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     it-codigo-ini AT ROW 4.58 COL 18.57 COLON-ALIGNED WIDGET-ID 20
     it-codigo-fim AT ROW 4.58 COL 51.72 COLON-ALIGNED NO-LABEL WIDGET-ID 18
     natur-oper-ini AT ROW 5.75 COL 18.72 COLON-ALIGNED WIDGET-ID 28
     natur-oper-fim AT ROW 5.75 COL 51.72 COLON-ALIGNED NO-LABEL WIDGET-ID 26
     dt-emiss-ini AT ROW 6.88 COL 18.57 COLON-ALIGNED WIDGET-ID 40
     dt-emiss-fim AT ROW 6.88 COL 51.72 COLON-ALIGNED NO-LABEL WIDGET-ID 38
     IMAGE-1 AT ROW 2.17 COL 35.29
     IMAGE-2 AT ROW 2.17 COL 50.72
     IMAGE-3 AT ROW 3.33 COL 50.29 WIDGET-ID 6
     IMAGE-5 AT ROW 3.38 COL 35.72 WIDGET-ID 16
     IMAGE-6 AT ROW 4.5 COL 50.29 WIDGET-ID 22
     IMAGE-7 AT ROW 4.54 COL 35.72 WIDGET-ID 24
     IMAGE-8 AT ROW 5.67 COL 50.29 WIDGET-ID 30
     IMAGE-9 AT ROW 5.71 COL 35.72 WIDGET-ID 32
     IMAGE-10 AT ROW 6.79 COL 50.29 WIDGET-ID 34
     IMAGE-11 AT ROW 6.83 COL 35.72 WIDGET-ID 36
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
ON END-ERROR OF w-relat /* Conciliacao ST - RE x FT */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Conciliacao ST - RE x FT */
DO:
...
{utp/ut9000.i "esrc615" "1.00.00.003"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY cod-estab-ini cod-estab-fim cod-emitente-ini cod-emitente-fim 
          it-codigo-ini it-codigo-fim natur-oper-ini natur-oper-fim dt-emiss-ini 
          dt-emiss-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-5 IMAGE-6 IMAGE-7 IMAGE-8 IMAGE-9 
         IMAGE-10 IMAGE-11 cod-estab-ini cod-estab-fim cod-emitente-ini 
         cod-emitente-fim it-codigo-ini it-codigo-fim natur-oper-ini 
         natur-oper-fim dt-emiss-ini dt-emiss-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.natur-oper-ini       = INPUT FRAME f-pg-sel natur-oper-ini
           tt-param.natur-oper-fim       = INPUT FRAME f-pg-sel natur-oper-fim
           tt-param.dt-emiss-ini         = INPUT FRAME f-pg-sel dt-emiss-ini
           tt-param.dt-emiss-fim         = INPUT FRAME f-pg-sel dt-emiss-fim
    ...
    {include/i-rprun.i esp/esrc615rp.p}
