...
PROCEDURE pi-excel:
        ...
        FOR EACH tt-saidas:
            ...
            ASSIGN tt-dados.arquivo-num   = 1
                   ...
                   tt-dados.celula-valor  = TT-SAIDAS.TTV-CFOP.
            ...
            ASSIGN tt-dados.arquivo-num   = 1
                   ...
                   tt-dados.celula-coluna = 2
                   tt-dados.celula-linha  = m-linha
                   tt-dados.celula-valor  = TT-SAIDAS.TTV-UF-ORIGEM.
            ...
            ASSIGN tt-dados.arquivo-num   = 1
                   ...
                   tt-dados.celula-coluna = 3
                   tt-dados.celula-linha  = m-linha
                   tt-dados.celula-valor  = TT-SAIDAS.TTV-COD-ESTAB.
            ...
            ASSIGN tt-dados.arquivo-num   = 1
                   ...
                   tt-dados.celula-coluna = 4
                   tt-dados.celula-linha  = m-linha
                   tt-dados.celula-valor  = TT-SAIDAS.TTV-NOME-ESTAB.
            ...
            ASSIGN tt-dados.arquivo-num   = 1
                   ...
                   tt-dados.celula-coluna = 5
                   tt-dados.celula-linha  = m-linha
                   tt-dados.celula-valor  = TT-SAIDAS.TTV-CDN-CLIENTE.
            ...
            ASSIGN tt-dados.arquivo-num   = 1
                   ...
                   tt-dados.celula-coluna = 6
                   tt-dados.celula-linha  = m-linha
                   tt-dados.celula-valor  = TT-SAIDAS.TTV-NOME-CLIENTE.
            ...
            ASSIGN tt-dados.arquivo-num   = 1
                   ...
                   tt-dados.celula-coluna = 7
                   tt-dados.celula-linha  = m-linha
                   tt-dados.celula-valor  = TT-SAIDAS.TTV-UF-DESTINO.
            ...
            ASSIGN tt-dados.arquivo-num   = 1
                   ...
                   tt-dados.celula-coluna = 8
                   tt-dados.celula-linha  = m-linha
                   tt-dados.celula-valor  = TT-SAIDAS.TTV-CONTRIBUINTE.
            ...
            ASSIGN tt-dados.arquivo-num   = 1
                   ...
                   tt-dados.celula-coluna = 9
                   tt-dados.celula-linha  = m-linha
                   tt-dados.celula-valor  = TT-SAIDAS.TTV-IT-CODIGO.
            ...
            ASSIGN tt-dados.arquivo-num   = 1
                   ...
                   tt-dados.celula-coluna = 10
                   tt-dados.celula-linha  = m-linha
                   tt-dados.celula-valor  = TT-SAIDAS.TTV-DESCRICAO.
            ...
            ASSIGN tt-dados.arquivo-num   = 1
                   ...
                   tt-dados.celula-coluna = 11
                   tt-dados.celula-linha  = m-linha
                   tt-dados.celula-valor  = TT-SAIDAS.TTV-VLR-ORIGINAL.
            ...
            ASSIGN tt-dados.arquivo-num   = 1
                   ...
                   tt-dados.celula-coluna = 12
                   tt-dados.celula-linha  = m-linha
                   tt-dados.celula-valor  = TT-SAIDAS.TTV-BASE-ICMS.
            ...
            ASSIGN tt-dados.arquivo-num   = 1
                   ...
                   tt-dados.celula-coluna = 13
                   tt-dados.celula-linha  = m-linha
                   tt-dados.celula-valor  = TT-SAIDAS.TTV-VLR-ICMS.
            ...
            ASSIGN tt-dados.arquivo-num   = 1
                   ...
                   tt-dados.celula-coluna = 14
                   tt-dados.celula-linha  = m-linha
                   tt-dados.celula-valor  = TT-SAIDAS.TTV-ALIQUOTA.
            ...
            ASSIGN tt-dados.arquivo-num   = 1
                   ...
                   tt-dados.celula-coluna = 15
                   tt-dados.celula-linha  = m-linha
                   tt-dados.celula-valor  = TT-SAIDAS.TTV-BASE-ICMS-ST.
            ...
            ASSIGN tt-dados.arquivo-num   = 1
                   ...
                   tt-dados.celula-coluna = 17
                   tt-dados.celula-linha  = m-linha
                   tt-dados.celula-valor  = TT-SAIDAS.TTV-VLR-ICMS-ST.
            ...
            ASSIGN tt-dados.arquivo-num   = 1
                   ...
                   tt-dados.celula-coluna = 18
                   tt-dados.celula-linha  = m-linha
                   tt-dados.celula-valor  = TT-SAIDAS.TTV-QTDE.
            ...
            ASSIGN tt-dados.arquivo-num   = 1
                   ...
                   tt-dados.celula-coluna = 19
                   tt-dados.celula-linha  = m-linha
                   tt-dados.celula-valor  = TT-SAIDAS.TTV-NR-NF.
            ...
            ASSIGN tt-dados.arquivo-num   = 1
                   ...
                   tt-dados.celula-coluna = 20
                   tt-dados.celula-linha  = m-linha
                   tt-dados.celula-valor  = TT-SAIDAS.TTV-DT-EMISSAO.
            ...
            ASSIGN tt-dados.arquivo-num   = 1
                   ...
                   tt-dados.celula-coluna = 21
                   tt-dados.celula-linha  = m-linha
                   tt-dados.celula-valor  = TT-SAIDAS.TTV-ORIGEM.
            ...
            ASSIGN tt-dados.arquivo-num   = 1
                   ...
                   tt-dados.celula-coluna = 22
                   tt-dados.celula-linha  = m-linha
                   tt-dados.celula-valor  = TT-SAIDAS.TTV-NATUR-OPER.
        ...
        FOR EACH tt-entradas:
            ...
            ASSIGN tt-dados.arquivo-num   = 1
                   ...
                   tt-dados.celula-coluna = 1                                                                          
                   tt-dados.celula-linha  = m-linha                                                                    
                   tt-dados.celula-valor  = tt-entradas.TTV-CFOP.                                                      
            ...
            ASSIGN tt-dados.arquivo-num   = 1                                                                       
                   ...
                   tt-dados.celula-coluna = 2                                                                       
                   tt-dados.celula-linha  = m-linha                                                                 
                   tt-dados.celula-valor  = tt-entradas.TTV-UF-ORIGEM.                                            
            ...
            ASSIGN tt-dados.arquivo-num   = 1                                                                     
                   ...
                   tt-dados.celula-coluna = 3                                                                     
                   tt-dados.celula-linha  = m-linha                                                               
                   tt-dados.celula-valor  = tt-entradas.TTV-COD-ESTAB.                                            
            ...
            ASSIGN tt-dados.arquivo-num   = 1                                                                     
                   ...
                   tt-dados.celula-coluna = 4                                                                     
                   tt-dados.celula-linha  = m-linha                                                               
                   tt-dados.celula-valor  = tt-entradas.TTV-NOME-ESTAB.                                           
            ...
            ASSIGN tt-dados.arquivo-num   = 1
                   ...
                   tt-dados.celula-coluna = 5
                   tt-dados.celula-linha  = m-linha
                   tt-dados.celula-valor  = tt-entradas.TTV-CDN-fornec.
            ...
            ASSIGN tt-dados.arquivo-num   = 1
                   ...
                   tt-dados.celula-coluna = 6
                   tt-dados.celula-linha  = m-linha
                   tt-dados.celula-valor  = tt-entradas.TTV-NOME-FOREC.
            ...
            ASSIGN tt-dados.arquivo-num   = 1
                   ...
                   tt-dados.celula-coluna = 7
                   tt-dados.celula-linha  = m-linha
                   tt-dados.celula-valor  = tt-entradas.TTV-UF-DESTINO.
            ...
            ASSIGN tt-dados.arquivo-num   = 1
                   ...
                   tt-dados.celula-coluna = 8
                   tt-dados.celula-linha  = m-linha
                   tt-dados.celula-valor  = tt-entradas.TTV-CONTRIBUINTE.
            ...
            ASSIGN tt-dados.arquivo-num   = 1
                   ...
                   tt-dados.celula-coluna = 9
                   tt-dados.celula-linha  = m-linha
                   tt-dados.celula-valor  = tt-entradas.TTV-IT-CODIGO.
            ...
            ASSIGN tt-dados.arquivo-num   = 1
                   ...
                   tt-dados.celula-coluna = 10                                                                               
                   tt-dados.celula-linha  = m-linha                                                                          
                   tt-dados.celula-valor  = tt-entradas.TTV-DESCRICAO.                                                       
            ...
            ASSIGN tt-dados.arquivo-num   = 1                                                                           
                   ...
                   tt-dados.celula-coluna = 11                                                                          
                   tt-dados.celula-linha  = m-linha                                                                     
                   tt-dados.celula-valor  = tt-entradas.TTV-VLR-ORIGINAL.                                                
            ...
            ASSIGN tt-dados.arquivo-num   = 1                                                                           
                   ...
                   tt-dados.celula-coluna = 12                                                                          
                   tt-dados.celula-linha  = m-linha
                   tt-dados.celula-valor  = tt-entradas.TTV-BASE-ICMS.
            ...
            ASSIGN tt-dados.arquivo-num   = 1
                   ...
                   tt-dados.celula-coluna = 13
                   tt-dados.celula-linha  = m-linha
                   tt-dados.celula-valor  = tt-entradas.TTV-VLR-ICMS.
            ...
            ASSIGN tt-dados.arquivo-num   = 1
                   ...
                   tt-dados.celula-coluna = 14
                   tt-dados.celula-linha  = m-linha
                   tt-dados.celula-valor  = tt-entradas.TTV-ALIQUOTA.
            ...
            ASSIGN tt-dados.arquivo-num   = 1
                   ...
                   tt-dados.celula-coluna = 15
                   tt-dados.celula-linha  = m-linha
                   tt-dados.celula-valor  = tt-entradas.TTV-BASE-ICMS-ST.
            ...
            ASSIGN tt-dados.arquivo-num   = 1
                   ...
                   tt-dados.celula-coluna = 17
                   tt-dados.celula-linha  = m-linha
                   tt-dados.celula-valor  = tt-entradas.TTV-VLR-ICMS-ST.
            ...
            ASSIGN tt-dados.arquivo-num   = 1
                   ...
                   tt-dados.celula-coluna = 18
                   tt-dados.celula-linha  = m-linha                                                                  
                   tt-dados.celula-valor  = tt-entradas.TTV-QTDE.                                                      
            ...
            ASSIGN tt-dados.arquivo-num   = 1                                                                        
                   ...
                   tt-dados.celula-coluna = 19                                                               
                   tt-dados.celula-linha  = m-linha                                                          
                   tt-dados.celula-valor  = tt-entradaS.TTV-NR-NF.                                           
            ...
            ASSIGN tt-dados.arquivo-num   = 1
                   ...
                   tt-dados.celula-coluna = 20
                   tt-dados.celula-linha  = m-linha
                   tt-dados.celula-valor  = tt-entradas.TTV-DT-EMISSAO.
            ...
            ASSIGN tt-dados.arquivo-num   = 1
                   ...
                   tt-dados.celula-coluna = 21
                   tt-dados.celula-linha  = m-linha
                   tt-dados.celula-valor  = tt-entradas.TTV-ORIGEM.
            ...
            ASSIGN tt-dados.arquivo-num   = 1
                   ...
                   tt-dados.celula-coluna = 22
                   tt-dados.celula-linha  = m-linha
                   tt-dados.celula-valor  = tt-entradas.ttv-lote.
            ...
            ASSIGN tt-dados.arquivo-num   = 1
                   ...
                   tt-dados.celula-coluna = 23
                   tt-dados.celula-linha  = m-linha
                   tt-dados.celula-valor  = tt-entradas.TTV-CDN-CLIENTE.
            ...
            ASSIGN tt-dados.arquivo-num   = 1
                   ...
                   tt-dados.celula-coluna = 24
                   tt-dados.celula-linha  = m-linha
                   tt-dados.celula-valor  = tt-entradas.TTV-NF-SAIDA.
            ...
            ASSIGN tt-dados.arquivo-num   = 1
                   ...
                   tt-dados.celula-linha  = m-linha
                   tt-dados.celula-valor  = tt-entradas.TTV-SERIE.
            ...
            ASSIGN tt-dados.arquivo-num   = 1
                   ...
                   tt-dados.celula-linha  = m-linha
                   tt-dados.celula-valor  = tt-entradas.TTV-VLR-ICMS-ST-SAI.
            ...
            ASSIGN tt-dados.arquivo-num   = 1
                   ...
                   tt-dados.celula-linha  = m-linha
                   tt-dados.celula-valor  = tt-entradas.TTV-QTDE-SAI.
