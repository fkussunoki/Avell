...
PROCEDURE pi-saidas:
          ...
          FOR EACH natur-oper WHERE natur-oper.especie-doc = "NFS"
...
PROCEDURE pi-excel:
  ...
  /* Cria os titulos para as colunas do relat÷rio */
        ...
        chworksheet:range("s" + STRING(m-linha)):SetValue("Dt. Emissao").
        chworksheet:range("t" + STRING(m-linha)):SetValue("Origem").
        chworksheet:range("u" + STRING(m-linha)):SetValue("Natur.Oper").
        ASSIGN m-linha = m-linha + 1.
        ...
        FOR EACH tt-saidas:
            ...
            chworksheet:range("A" + STRING(m-linha)):SetValue(TT-SAIDAS.TTV-CFOP).           
            chworksheet:range("b" + STRING(m-linha)):SetValue(TT-SAIDAS.TTV-UF-ORIGEM).      
            chworksheet:range("c" + STRING(m-linha)):SetValue(TT-SAIDAS.TTV-COD-ESTAB).      
            chworksheet:range("d" + STRING(m-linha)):SetValue(TT-SAIDAS.TTV-NOME-ESTAB).     
            chworksheet:range("e" + STRING(m-linha)):SetValue(TT-SAIDAS.TTV-CDN-CLIENTE).    
            chworksheet:range("f" + STRING(m-linha)):SetValue(TT-SAIDAS.TTV-NOME-CLIENTE).   
            chworksheet:range("g" + STRING(m-linha)):SetValue(TT-SAIDAS.TTV-UF-DESTINO).     
            chworksheet:range("h" + STRING(m-linha)):SetValue(TT-SAIDAS.TTV-CONTRIBUINTE).   
            chworksheet:range("i" + STRING(m-linha)):SetValue(TT-SAIDAS.TTV-IT-CODIGO).      
            chworksheet:range("j" + STRING(m-linha)):SetValue(TT-SAIDAS.TTV-DESCRICAO).      
            chworksheet:range("k" + STRING(m-linha)):SetValue(TT-SAIDAS.TTV-VLR-ORIGINAL).   
            chworksheet:range("l" + STRING(m-linha)):SetValue(TT-SAIDAS.TTV-BASE-ICMS).      
            chworksheet:range("m" + STRING(m-linha)):SetValue(TT-SAIDAS.TTV-VLR-ICMS).       
            chworksheet:range("n" + STRING(m-linha)):SetValue(TT-SAIDAS.TTV-ALIQUOTA).       
            chworksheet:range("o" + STRING(m-linha)):SetValue(TT-SAIDAS.TTV-BASE-ICMS-ST).   
            chworksheet:range("p" + STRING(m-linha)):SetValue(TT-SAIDAS.TTV-VLR-ICMS-ST).    
            chworksheet:range("q" + STRING(m-linha)):SetValue(TT-SAIDAS.TTV-QTDE).           
            chworksheet:range("r" + STRING(m-linha)):SetValue(TT-SAIDAS.TTV-NR-NF).          
            chworksheet:range("s" + STRING(m-linha)):SetValue(TT-SAIDAS.TTV-DT-EMISSAO).     
            chworksheet:range("t" + STRING(m-linha)):SetValue(TT-SAIDAS.TTV-ORIGEM).         
            chworksheet:range("u" + STRING(m-linha)):SetValue(TT-SAIDAS.TTV-NATUR-OPER).     
      ...
      /* Cria os titulos para as colunas do relat÷rio */
            ...
            chworksheet:range("t" + STRING(m-linha)):SetValue("Origem").
            chworksheet:range("u" + STRING(m-linha)):SetValue("Natur.Oper").
            chworksheet:range("v" + STRING(m-linha)):SetValue("Lote").
            chworksheet:range("w" + STRING(m-linha)):SetValue("Cliente").
            chworksheet:range("x" + STRING(m-linha)):SetValue("NF").
            chworksheet:range("y" + STRING(m-linha)):SetValue("Vlr ST").
            chworksheet:range("z" + STRING(m-linha)):SetValue("Qtde").
            ...
            chworksheet:range("A" + STRING(m-linha)):SetValue(tt-entradas.TTV-CFOP).               
            chworksheet:range("b" + STRING(m-linha)):SetValue(tt-entradas.TTV-UF-ORIGEM).           
            chworksheet:range("c" + STRING(m-linha)):SetValue(tt-entradas.TTV-COD-ESTAB).           
            chworksheet:range("d" + STRING(m-linha)):SetValue(tt-entradas.TTV-NOME-ESTAB).          
            chworksheet:range("e" + STRING(m-linha)):SetValue(tt-entradas.TTV-CDN-FORNEC).          
            chworksheet:range("f" + STRING(m-linha)):SetValue(tt-entradas.TTV-NOME-FOREC).          
            chworksheet:range("g" + STRING(m-linha)):SetValue(tt-entradas.TTV-UF-DESTINO).          
            chworksheet:range("h" + STRING(m-linha)):SetValue(tt-entradas.TTV-CONTRIBUINTE).        
            chworksheet:range("i" + STRING(m-linha)):SetValue(tt-entradas.TTV-IT-CODIGO).           
            chworksheet:range("j" + STRING(m-linha)):SetValue(tt-entradas.TTV-DESCRICAO).           
            chworksheet:range("k" + STRING(m-linha)):SetValue(tt-entradas.TTV-VLR-ORIGINAL).        
            chworksheet:range("l" + STRING(m-linha)):SetValue(tt-entradas.TTV-BASE-ICMS).           
            chworksheet:range("m" + STRING(m-linha)):SetValue(tt-entradas.TTV-VLR-ICMS).            
            chworksheet:range("n" + STRING(m-linha)):SetValue(tt-entradas.TTV-ALIQUOTA).            
            chworksheet:range("o" + STRING(m-linha)):SetValue(tt-entradas.TTV-BASE-ICMS-ST).        
            chworksheet:range("p" + STRING(m-linha)):SetValue(tt-entradas.TTV-VLR-ICMS-ST).         
            chworksheet:range("q" + STRING(m-linha)):SetValue(tt-entradas.TTV-QTDE).                
            chworksheet:range("r" + STRING(m-linha)):SetValue(tt-entradas.TTV-NR-NF).               
            chworksheet:range("s" + STRING(m-linha)):SetValue(tt-entradas.TTV-DT-EMISSAO).          
            chworksheet:range("t" + STRING(m-linha)):SetValue(tt-entradas.TTV-ORIGEM).              
            chworksheet:range("u" + STRING(m-linha)):SetValue(tt-entradas.TTV-LOTE).                
            chworksheet:range("v" + STRING(m-linha)):SetValue(tt-entradas.TTV-CDN-CLIENTE).         
            chworksheet:range("w" + STRING(m-linha)):SetValue(tt-entradas.TTV-NF-SAIDA).            
            chworksheet:range("x" + STRING(m-linha)):SetValue(tt-entradas.TTV-SERIE).               
            chworksheet:range("y" + STRING(m-linha)):SetValue(tt-entradas.TTV-VLR-ICMS-ST-SAI).     
            chworksheet:range("z" + STRING(m-linha)):SetValue(tt-entradas.TTV-QTDE-SAI).            
            ASSIGN m-linha = m-linha + 1.
