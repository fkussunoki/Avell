...
FOR EACH tt-entradas BREAK BY tt-entradas.ttv_lote
    ...
    chworksheet:range("a" + STRING(m-linha)):font:bold = TRUE.
    ...
    chworksheet:range("g" + string(m-linha)):SetValue(tt-entradas.ttv_vlr_ctbl).         
    chworksheet:range("h" + string(m-linha)):SetValue(tt-entradas.ttv_aliquota).         
    chworksheet:range("i" + string(m-linha)):SetValue(tt-entradas.ttv_base_icms).        
    chworksheet:range("j" + string(m-linha)):SetValue(tt-entradas.ttv_vlr_icms).         
    chworksheet:range("k" + string(m-linha)):SetValue(tt-entradas.ttv_base_icms_st).     
    chworksheet:range("l" + string(m-linha)):SetValue(tt-entradas.ttv_vlr_icms_st).      
    chworksheet:range("m" + string(m-linha)):SetValue(tt-entradas.ttv_vlr_ipi).          
    chworksheet:range("n" + string(m-linha)):SetValue(tt-entradas.ttv_dt_trans).         
    chworksheet:range("o" + string(m-linha)):SetValue(tt-entradas.ttv_estab).            
    chworksheet:range("p" + string(m-linha)):SetValue(tt-entradas.ttv_documento).        
    chworksheet:range("q" + string(m-linha)):SetValue(tt-entradas.ttv_quantidade).
...
PROCEDURE pi-devolucao:
    ...
    FIND FIRST item-doc-est NO-LOCK WHERE item-doc-est.cod-emitente = movto-estoq.cod-emitente
                                    ...
                                    AND   item-doc-est.it-codigo    = movto-estoq.it-codigo NO-ERROR.
