...
*******************************************************************************/
{include/i-prgvrs.i Z01ESRC500 9.99.99.999}
...
DEFINE VARIABLE h_b01esrc500 AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b01esrc500 ).
       RUN set-position IN h_b01esrc500 ( 3.17 , 6.43 ) NO-ERROR.
       /* Size in UIB:  ( 10.17 , 80.14 ) */

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b01esrc500 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "Z01ESRC500" "1.00.00.001"}
