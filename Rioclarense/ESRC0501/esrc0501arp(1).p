...
PUT STREAM str-rp UNFORMATTED 'EMITENTE | NOME | UF | SERIE | DOCUMENTO | NAT.OPER | TRANSACAO | ESP.DOC | COD OBSRV | ESTABEL | VLR TOT NF | REINF | ITEM | DESCR ITEM |  C.CONTABIL | TIT CONTA | C.CUSTO | TIT C.CUSTO | UNID NEG | NOM UN | ESP FIN' 
    SKIP.
                   ...
                   for each item-doc-est fields (aliquota-icm
                       ...
                       run pi_busca_dados_ccusto in h_api_ccusto (input  i-empresa,          /* EMPRESA EMS2 */
                               ...
                               IF AVAIL dupli-apagar THEN
                                   PUT STREAM str-rp UNFORMATTED dupli-apagar.cod-esp SKIP.

                               ELSE 
                                   PUT STREAM str-rp UNFORMATTED "Sem duplicatas" SKIP.
